...
define("_MI_CK2LINK_ADMENU1", "連結管理");
define("_MI_CK2LINK_ADMENU2", "分類管理");

define("_MA_CK2LINK_CATE_SN","分類");
define("_MA_CK2LINK_OF_CATE_SN","父分類");
define("_MA_CK2LINK_CATE_TITLE","分類標題");
define("_MA_CK2LINK_CATE_SORT","分類排序");

define("_MA_CK2LINK_LINK_SN","連結編號");
define("_MA_CK2LINK_LINK_TITLE","網站名稱");
define("_MA_CK2LINK_LINK_URL","網站網址");
define("_MA_CK2LINK_LINK_DESC","網站說明");
define("_MA_CK2LINK_LINK_SORT","排序");
define("_MA_CK2LINK_LINK_COUNTER","點閱數");
define("_MA_CK2LINK_UNABLE_DATE","下架日");
define("_MA_CK2LINK_UID","發佈者");
define("_MA_CK2LINK_POST_DATE","發佈時間");
define("_MA_CK2LINK_ENABLE","是否顯示");
define("_MA_CK2LINK_ENABLE_1","顯示");
define("_MA_CK2LINK_ENABLE_0","關閉");

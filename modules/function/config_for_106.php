<?php
	...
	function modPrintLink($file_path, $file_name, $mod)
	{
		switch($mod)
		{
			case 1:
				...
				{
					echo '<font color=blue>[已上傳]</font> <a href="'.$file_path.$file_name.'" target="_new"><b>' . $file_name . '</b></a>';
	...
	// 補助三
	$a3_title = "充實學校基本教學設備";
	$a3_table_name = "alc_teaching_equipment";
	$a3_table_name_item = $a3_table_name."_item";
	$a3_table_name_effect = $a3_table_name."_effect";

	// 補助四
	$a4_title = "發展原住民教育文化特色及充實設備器材";
	$a4_table_name = "alc_aboriginal_education";
	$a4_table_name_item = $a4_table_name."_item";
	$a4_table_name_effect = $a4_table_name."_effect";

	// 補助五
	$a5_title = "補助交通不便地區學校交通車";
	$a5_table_name = "alc_transport_car";
	$a5_table_name_effect = $a5_table_name."_effect";

	// 補助六
	$a6_title = "整修學校社區化活動場所";
	$a6_table_name = "alc_school_activity";
	$a6_table_name_item = $a6_table_name."_item";
	$a6_table_name_effect = $a6_table_name."_effect";

	// 成功專案學校，不可申請教優區
	$success_project_ary = array("044523",
								 "044524",
								 "044666",
								 "044667",
								 "044668",
	...
	084716		南投縣	 			信義國小			18
	084719		南投縣	 			愛國國小			19
	084725		南投縣	 			信義國小忠信分校	20
	084726		南投縣	 			愛國國小自強分校	21
	084729		南投縣	 			新鄉國小			22
	084732		南投縣	 			豐丘國小			23
	*/
?>
...
<ul>
<li>管理所有模組的評論。</li>
<li>利用清除功能可輕易的刪除評論。</li>
</ul>");

// Form
define("_AM_SYSTEM_COMMENTS_FORM_LIST_COMMENTS","評論列表");
...
define("_AM_SYSTEM_COMMENTS_FORM_PURGE_DATE_AFTER","此日期之後（空白表示不分日期）");
define("_AM_SYSTEM_COMMENTS_FORM_PURGE_DATE_BEFORE","此日期之前（空白表示不分日期）");
define("_AM_SYSTEM_COMMENTS_FORM_PURGE_GROUPS", "群組");
define("_AM_SYSTEM_COMMENTS_FORM_PURGE_USER", "用戶暱稱");
...
define("_AM_SYSTEM_COMMENTS_POSTED","發表");
define("_AM_SYSTEM_COMMENTS_IP","IP");
define("_AM_SYSTEM_COMMENTS_MODULE","模組");
define("_AM_SYSTEM_COMMENTS_STATUS","狀態");
define("_AM_SYSTEM_COMMENTS_ACTION","功能");
define("_AM_SYSTEM_COMMENTS_VIEW","觀看評論");

define("_AM_SYSTEM_COMMENTS_NO_COMMENTS","尚無評論");
define("_AM_SYSTEM_COMMENTS_COMMENTS_FOUND","找到 %s 則評論");
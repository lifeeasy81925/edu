...
// Tips
define("_AM_SYSTEM_GROUPS_NAV_TIPS_1","<ul><li>可更改或建立現有群組的權限，任何的修改動作將影響該群組的所有使用者。</li></ul>");
define("_AM_SYSTEM_GROUPS_NAV_TIPS_2","<ul><li>可建立新群組並設定新群組的各種權限</li></ul>");

//Infos
define("_AM_SYSTEM_GROUPS_ACCESSRIGHTS", "模組使用權限");
define("_AM_SYSTEM_GROUPS_ACTION","功能");
define("_AM_SYSTEM_GROUPS_ACTIVERIGHTS", "模組管理權限");
define("_AM_SYSTEM_GROUPS_ADD","新增群組");
define("_AM_SYSTEM_GROUPS_BLOCKRIGHTS", "區塊使用權限");
define("_AM_SYSTEM_GROUPS_CUSTOMBLOCK", "自訂區塊");
define("_AM_SYSTEM_GROUPS_DELETE","刪除群組");
define("_AM_SYSTEM_GROUPS_DESCRIPTION","群組說明");
define("_AM_SYSTEM_GROUPS_EDIT","編輯群組");
define("_AM_SYSTEM_GROUPS_ERROR_DELETE", "您無法刪除此群組");
define("_AM_SYSTEM_GROUPS_ID","ID");
define("_AM_SYSTEM_GROUPS_NAME","群組名稱");
define("_AM_SYSTEM_GROUPS_NB_USERS_BY_GROUPS", "群組的使用者人數");
define("_AM_SYSTEM_GROUPS_NB_USERS_BY_GROUPS_USERS", "%s 個使用者");

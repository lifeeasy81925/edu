...
define("_MD_TADNEW_TOOLBAR","共 %s 頁，目前在第 %s 頁：");
...
define("_MB_TADNEW_BATCH_TOOLS","批次管理");
...
define("_MA_NEED_TADTOOLS","需要 modules/tadtools，可至<a href='http://www.tad0616.net/modules/tad_uploader/index.php?of_cat_sn=508' target='_blank'>Tad教材網</a>下載。");
...
define("_MA_TADNEW_CHANGE_TO_NEWS","轉為新聞分類");
define("_MA_TADNEW_CHANGE_TO_PAGE","轉為自訂頁面分類");
define("_MA_TADNEW_SHOW_CATE_NEWS","僅秀出指定分類文章：");
define("_MA_TADNEW_SHOW_AUTHOR_NEWS","僅秀出指定作者文章：");
...
define("_MD_TADNEW_SEND_NOW","立即寄出");
define("_MD_TADNEW_SEND_OK","發送成功！");
define("_MD_TADNEW_SEND_ERROR","發送失敗！");
define("_MD_TADNEW_MAIL_LIST","郵寄清單（共 %s 筆）：");
...
define("_MA_TADNEW_NP_EMAIL","Email管理");
define("_MA_TADNEW_NP_EMAIL_NUM","共有 %s 人訂閱 ");
define("_MA_TADNEW_NP_EMAIL_IMPORT","匯入Email，請用 , 隔開");
define("_MD_TADNEW_NEVER_SEND","尚未寄過");
define("_MD_TADNEW_SEND_LOG","觀看寄送紀錄");
define("_MD_TADNEW_EMPTY_LOG","查無寄送紀錄");
...
//tag.php
define('_MA_TADNEW_TAG_TITLE' , '標籤');
define('_MA_TADNEW_TAG_COLOR' , '顏色');
define('_MA_TADNEW_TAG_SN' , '標籤編號');
define('_MA_TADNEW_TAG_ENABLE' , '是否使用');
define('_MA_TADNEW_TAG_DEMO' , '範例');
define('_MA_TADNEW_TAG_FUNC' , '功能');
define('_MA_TADNEW_TAG_NEW' , '新標籤');
define('_MA_TADNEW_TAG_ABLE' , '啟用');
define('_MA_TADNEW_TAG_UNABLE' , '關閉');

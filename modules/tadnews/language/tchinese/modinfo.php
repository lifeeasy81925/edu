...
define("_MI_TADNEW_ADMENU8", "標籤管理");
...
define("_MI_TADNEW_PREFIX_TAG","<b>設定標題的標籤</b>");
define("_MI_TADNEW_PREFIX_TAG_DESC","可用來替標題加上標籤，以凸顯該文性質。（選項請用「;」隔開）");
...
//tadnew 1.4
define("_MI_TADNEW_BNAME9","自選文章");
define("_MI_TADNEW_BDESC9","可以自己選定文章");
define("_MI_TADNEW_USE_NEWSPAPER","前台選單秀出「電子報」項目");
define("_MI_TADNEW_USE_NEWSPAPER_DESC","若否，「電子報」項目不會出現在前台主選單及頁面選單上");
define("_MI_TADNEW_USE_USE_ARCHIVE","前台選單秀出「分月文章」項目");
define("_MI_TADNEW_USE_USE_ARCHIVE_DESC","若否，「分月文章」項目不會出現在前台主選單及頁面選單上");
define("_MI_TADNEW_SHOW_SUBMENU","是否顯示子選單");
define("_MI_TADNEW_SHOW_SUBMENU_DESC","是否顯示子選單以及功能表");

//tadnews 2.0
define("_MI_TADNEW_DOWNLOAD_AFTER_READ","簽收後始能下載檔案");
define("_MI_TADNEW_DOWNLOAD_AFTER_READ_DESC","若該新聞是需要簽收的，必須簽收後才能下載附檔。");
define("_MI_TADNEW_CREAT_CATE_GROUP","可直接開設分類的群組");
define("_MI_TADNEW_CREAT_CATE_GROUP_DESC","設定可以發文直接開設分類的群組");
//define("_MI_TADNEW_USE_KCFINDER","是否使用KCFinder檔案管理員？");
//define("_MI_TADNEW_USE_KCFINDER_DESC","進階的FCK編輯器外掛，需要PHP5以上才支援。");
define("_MI_TADNEW_BNAME10","條列式新聞");
define("_MI_TADNEW_BDESC10","文章標題條列式");
define("_MI_TADNEW_BNAME11","表格式新聞");
define("_MI_TADNEW_BDESC11","表格佈告欄式");
define("_MI_TADNEW_SUMMARY_LENGTHS","摘要長度");
define("_MI_TADNEW_SUMMARY_LENGTHS_DESC","選用條列式呈現新聞時，要秀出的摘要字數");

define("_MI_TADNEW_BNAME12","QR Code");
define("_MI_TADNEW_BDESC12","產生連到手持裝置頁面的QR Code條碼");

define("_MI_TADNEW_BNAME13","滑動新聞");
define("_MI_TADNEW_BDESC13","以文章封面圖為底的滑動新聞");
define("_MI_TADNEW_BNAME14","自動縮放的滑動新聞");
define("_MI_TADNEW_BDESC14","以文章封面圖為底的滑動新聞（可視裝置自動縮放）");
...
define("_MI_TADNEW_USE_EMBED","是否開啟嵌入語法");
define("_MI_TADNEW_USE_EMBED_DESC","若選是，將會出現嵌入語法的設定按鈕及頁面");

...
define("_MB_TADNEW_TADNEWS_CONTENT_BLOCK_EDIT_BITEM6_DESC","（設0，代表完整出現標題。設60代表：只秀出60個英文字元或20個UTF8中文字或30個Big5中文字）");
define("_MB_TADNEW_TADNEWS_CONTENT_BLOCK_EDIT_BITEM3","摘要字數");
define("_MB_TADNEW_TADNEWS_CONTENT_BLOCK_EDIT_BITEM3_DESC","（設0，代表不秀出摘要。設60代表：只秀出60個英文字元或20個UTF8中文字或30個Big5中文字）");

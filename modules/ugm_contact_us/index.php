...
";
  $ugm_contact_us_jquery=$xoopsModuleConfig['ugm_contact_us_jquery']=='0'?"":"<script src='".XOOPS_URL."/modules/ugm_contact_us/class/formValidator/jquery_last.js' type='text/javascript'></script>";

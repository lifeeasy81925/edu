...
<font color=blue>審核金額：<input type="text" size="5" name="a132" value= "<? if($a132 =='') echo $a013+$a016; else echo $a132;?>" style="border:0px; text-align: right;" readonly >元。</font></b>
<p>
...
function numsum() { 
	...
	f.a132.value = (f.a135.value==""?0:parseFloat(f.a135.value)) + (f.a138.value==""?0:parseFloat(f.a138.value)); 
}
function numsum1() { 
	var f = document.forms[0]; 

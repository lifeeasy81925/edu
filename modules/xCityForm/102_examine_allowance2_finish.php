...
where account='$id'";
mysql_query($sql);
//↑a190 ='$email' 刪除，補助項目的a190是複審狀態專用(email資料先移除)
...
$sql = "update 102allowance2_2 set 
a030='$b030', 
a031='$b031', 
a040='$b040', 
a041='$b041', 
...
//寫入審查委員代號
  $sql = "update school_checkdate set  money_ex2 = '$username' where account='$id'";

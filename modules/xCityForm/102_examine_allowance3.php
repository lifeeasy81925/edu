...
<? if ($a4key == 1) { echo "<!--"; } ?>
<b>※教師宿舍</b><br />
學校申請：經費共計<font face="Arial, Helvetica, sans-serif" color=red size="+1"><? echo $a013;?></font>元，其中包含經常門經費<font face="Arial, Helvetica, sans-serif" color=red size="+1"><? echo $a019;?></font>項<font face="Arial, Helvetica, sans-serif" color=red size="+1"><? echo $a014;?></font>元，資本門經費<font face="Arial, Helvetica, sans-serif" color=red size="+1"><? echo $a020;?></font>式<font face="Arial, Helvetica, sans-serif" color=red size="+1"><? echo $a015;?></font>元。<br />
<b>初審金額：<font color=blue>經費共計<input type="text" size="6" name="a135" value="<? if($a135=='') echo $a013; else echo $a135;?>" style="border:0px; text-align: right;" readonly>元</font>，其中包含經常門經費<input type="text" size="2" name="a141" value="<? if($a141=='') echo $a019; else echo $a141;?>">項<font color=blue><input type="text" size="6" name="a136" onChange="change3()" value="<? if($a136=='') echo $a014; else echo $a136;?>" style="border:0px; text-align: right;" readonly >元</font>，資本門經費<input type="text" size="2" name="a142" value="<? if($a142=='') echo $a020; else echo $a142;?>">項<font color=blue><input type="text" size="6" name="a137" onChange="change4()" value="<? if($a137=='') echo $a015; else echo $a137;?>" style="border:0px; text-align: right;" readonly >元</font>。</b>
<? //經費表 教師宿舍 ?>
...
<? if ($a4key == 2) { echo "<!--"; } ?>
<b>※學生宿舍</b><br />
學校申請：經費共計<font face="Arial, Helvetica, sans-serif" color=red size="+1"><? echo $a016;?></font>元，其中包含經常門經費<font face="Arial, Helvetica, sans-serif" color=red size="+1"><? echo $a021;?></font>項<font face="Arial, Helvetica, sans-serif" color=red size="+1"><? echo $a017;?></font>元，資本門經費<font face="Arial, Helvetica, sans-serif" color=red size="+1"><? echo $a022;?></font>式<font face="Arial, Helvetica, sans-serif" color=red size="+1"><? echo $a018;?></font>元。<br />
<b>初審金額：<font color=blue>經費共計<input type="text" size="6" name="a138" value="<? if($a138=='') echo $a016; else echo $a138;?>" style="border:0px; text-align: right;" readonly>元</font>，其中包含經常門經費<input type="text" size="2" name="a143" value="<? if($a143=='') echo $a021; else echo $a143;?>">項<font color=blue><input type="text" size="6" name="a139" onChange="change5()" value="<? if($a139=='') echo $a017; else echo $a139;?>" style="border:0px; text-align: right;" readonly >元</font>，資本門經費<input type="text" size="2" name="a144" value="<? if($a144=='') echo $a022; else echo $a144;?>">
項<font color=blue><input type="text" size="6" name="a140" onChange="change6()" value="<? if($a140=='') echo $a018; else echo $a140;?>" style="border:0px; text-align: right;" readonly >元</font>。</b>
<? //經費表 學生宿舍 ?>
<table width="100%" border="0" cellspacing="0" cellpadding="0" bgcolor="#FFFFCC" style="font-size:12px;">
  <tr>
  ...
  <tr>
    ...
    <td align="left"><input type="text" size="10" name="b122" value="<? if($b122 =='') echo ''; else echo $b122;?>" style="border:0px; text-align: left;" readonly ></td>
...
function numsum1() { 
	...
	f.a135.value = (f.a136.value==""?0:parseFloat(f.a136.value)) + (f.a137.value==""?0:parseFloat(f.a137.value)); 
}
function numsum2() { 
	var f = document.forms[0]; 
	f.a138.value = (f.a139.value==""?0:parseFloat(f.a139.value)) + (f.a140.value==""?0:parseFloat(f.a140.value)); 
}
function change3() { 
	var f = document.forms[0]; 
	numsum1();
...
<script language="JavaScript">
	...
	function count_all(group_ab)
	{
		...
		if(group_ab == "a")
		{
			...
			document.getElementsByName("a141")[0].value = money_1_c;	
			document.getElementsByName("a136")[0].value = money_1;	
			document.getElementsByName("a142")[0].value = money_2_c;	
		...
		else
		{
			...
			document.getElementsByName("a143")[0].value = money_1_c;	
			document.getElementsByName("a139")[0].value = money_1;	
			document.getElementsByName("a144")[0].value = money_2_c;	

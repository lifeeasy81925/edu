...
<b>※申請資料與審核：</b><br>
<? if($a014 < 1) echo "<!---"; ?>
●搭車人數<font face="Arial, Helvetica, sans-serif" color="#FF0000" size="+1"><? echo number_format($a013);?></font>人，申請租車經費<font face="Arial, Helvetica, sans-serif" color="#FF0000" size="+1"><? echo number_format($a014);?></font>元。
<? if($examine == '2') echo '縣市審核'.'<font face="Arial, Helvetica, sans-serif" color="#FF0000" size="+1">'.number_format($city1).'</font>元。'?>
審核金額<input type="text" size="6" name="a136" value="<? if($a136=='') echo ''; else echo $a136;?>" >元。<br>
...
<? if($a014 < 1) echo "-->"; ?>
<? if($a016 < 1) echo "<!---"; ?>
●補助交通費<font face="Arial, Helvetica, sans-serif" color="#FF0000" size="+1"><? echo number_format($a015);?></font>人，申請經費<font face="Arial, Helvetica, sans-serif" color="#FF0000" size="+1"><? echo number_format($a016);?></font>元。
<? if($examine == '2') echo '縣市審核'.'<font face="Arial, Helvetica, sans-serif" color="#FF0000" size="+1">'.number_format($city2).'</font>元。'?>
審核金額<input type="text" size="6" name="a138" value="<? if($a138=='') echo ''; else echo $a138;?>" >元。<br>
　　　•每生每年補助 12000 元，最高依租車費標準為限。
<p>
<? if($a016 < 1) echo "-->"; ?>
<? if($a018 < 1) echo "<!---"; ?>
●補助交通車<font face="Arial, Helvetica, sans-serif" color="#FF0000" size="+1"><? echo number_format($a017);?></font>人座，申請經費<font face="Arial, Helvetica, sans-serif" color="#FF0000" size="+1"><? echo number_format($a018);?></font>元。
<? if($examine == '2') echo '縣市審核'.'<font face="Arial, Helvetica, sans-serif" color="#FF0000" size="+1">'.number_format($city3).'</font>元。'?>
審核金額<input type="text" size="6" name="a140" value="<? if($a140=='') echo ''; else echo $a140;?>" >元。<br>

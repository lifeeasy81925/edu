...
//寫入是否審核通過
	$sql = "update 102schooldata set a198 = '$a130' where account='$id'";
	mysql_query($sql);
	
//寫入審查委員代號
  $sql = "update school_checkdate set  money_ex7 = '$username' where account='$id'";

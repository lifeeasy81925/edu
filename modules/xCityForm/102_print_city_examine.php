...
<br /><?echo "【".$city."政府申請教育部102年度推動教育優先區計畫指標界定及補助項目經費彙整表 (表Ⅱ-2) 】";?>
...
while($row = mysql_fetch_row($result)){
	...
	$total = $a1_132+$a2_132+$a3_132+$a4_132+$a5_132+$a6_132+$a7_132;
	...
	echo "<tr>";
		...
		echo "<td div align='center'>";
			echo number_format($k1);
		echo "</td>";
		echo "<td div align='center'>";
			echo number_format($k2);
		echo "</td>";
		echo "<td div align='center'>";
			echo number_format($k3);
		echo "</td>";
		echo "<td div align='center'>";
			echo number_format($k4);
		echo "</td>";
		echo "<td div align='center'>";
			echo number_format($k5);
		echo "</td>";
		echo "<td div align='center'>";
			echo number_format($k6);
		echo "</td>";
		echo "<td div align='center' bgcolor='#99FFFF'>";
			echo number_format($k_total);
		echo "</td>";
		echo "<td div align='right'>";
			echo number_format($a1_136);
		echo "</td>";
		echo "<td div align='right'>";
			echo number_format($a1_135);
		echo "</td>";
		echo "<td div align='right'>";
			echo number_format($a1_139);
		echo "</td>";
		echo "<td div align='right'>";
			echo number_format($a1_138);
		echo "</td>";
		echo "<td div align='right' bgcolor='#FFFFCC'>";
			echo number_format($a1_132);
		echo "</td>";
		echo "<td div align='right'>";
			echo number_format($a2_133);
		echo "</td>";
		echo "<td div align='right'>";
			echo number_format($a2_134);
		echo "</td>";
		echo "<td div align='right' bgcolor='#CCFFCC'>";
			echo number_format($a2_132);
		echo "</td>";
		echo "<td div align='right'>";
			echo number_format($a3_141);
		echo "</td>";
		echo "<td div align='right'>";
			echo number_format($a3_136);
		echo "</td>";
		echo "<td div align='right'>";
			echo number_format($a3_142);
		echo "</td>";
		echo "<td div align='right'>";
			echo number_format($a3_137);
		echo "</td>";
		echo "<td div align='right'>";
			echo number_format($a3_135);
		echo "</td>";
		echo "<td div align='right'>";
			echo number_format($a3_143);
		echo "</td>";
		echo "<td div align='right'>";
			echo number_format($a3_139);
		echo "</td>";
		echo "<td div align='right'>";
			echo number_format($a3_144);
		echo "</td>";
		echo "<td div align='right'>";
			echo number_format($a3_140);
		echo "</td>";
		echo "<td div align='right'>";
			echo number_format($a3_138);
		echo "</td>";
		echo "<td div align='right' bgcolor='#FFFFCC'>";
			echo number_format($a3_132);
		echo "</td>";
		echo "<td div align='right'>";
			echo number_format($a4_133);
		echo "</td>";
		echo "<td div align='right'>";
			echo number_format($a4_134);
		echo "</td>";
		echo "<td div align='right' bgcolor='#CCFFCC'>";
			echo number_format($a4_132);
		echo "</td>";
		echo "<td div align='right'>";
			echo number_format($a5_133);
		echo "</td>";
		echo "<td div align='right'>";
			echo number_format($a5_134);
		echo "</td>";
		echo "<td div align='right' bgcolor='#FFFFCC'>";
			echo number_format($a5_132);
		echo "</td>";
		echo "<td div align='right'>";
			echo number_format($a6_136);
		echo "</td>";
		echo "<td div align='right'>";
			echo number_format($a6_138);
		echo "</td>";
		echo "<td div align='right'>";
			echo number_format($a6_140);
		echo "</td>";
		echo "<td div align='right' bgcolor='#CCFFCC'>";
			echo number_format($a6_132);
		echo "</td>";
		echo "<td div align='right'>";
			echo number_format($a7_133);
		echo "</td>";
		echo "<td div align='right'>";
			echo number_format($a7_134);
		echo "</td>";
		echo "<td div align='right' bgcolor='#FFFFCC'>";
			echo number_format($a7_132);
		echo "</td>";
...
?>
  <tr>
    ...
    <td align="center">&nbsp;</td>
    <td align="center">&nbsp;</td>
    <td align="center"><? echo number_format($pk1);?></td>
    <td align="center"><? echo number_format($pk2);?></td>
    <td align="center"><? echo number_format($pk3);?></td>
    <td align="center"><? echo number_format($pk4);?></td>
    <td align="center"><? echo number_format($pk5);?></td>
    <td align="center"><? echo number_format($pk6);?></td>
    <td align="center" bgcolor="#99FFFF"><? echo number_format($pk_total);?></td>
    <td align="right"><div align="right"><? echo number_format($p1_1);?></td>
    <td align="right"><div align="right"><? echo number_format($p1_2);?></td>
    <td align="right"><div align="right"><? echo number_format($p1_3);?></td>
    <td align="right"><div align="right"><? echo number_format($p1_4);?></td>
    <td align="right" bgcolor="#FFFFCC"><div align="right"><? echo number_format($p1_5);?></td>
    <td align="right"><div align="right"><? echo number_format($p2_1);?></td>
    <td align="right"><div align="right"><? echo number_format($p2_2);?></td>
    <td align="right" bgcolor="#CCFFCC"><div align="right"><? echo number_format($p2_3);?></td>
    ...
    <td align="right"><div align="right"><? echo number_format($p3_5);?></td>
    <td align="right"><div align="right"><? echo number_format($p3_6);?></td>
    <td align="right"><div align="right"><? echo number_format($p3_7);?></td>
    <td align="right"><div align="right"><? echo number_format($p3_8);?></td>
    <td align="right"><div align="right"><? echo number_format($p3_9);?></td>
    <td align="right"><div align="right"><? echo number_format($p3_10);?></td>
    <td align="right" bgcolor="#FFFFCC"><div align="right"><? echo number_format($p3_11);?></td>
    <td align="right"><div align="right"><? echo number_format($p4_1);?></td>
    <td align="right"><div align="right"><? echo number_format($p4_2);?></td>
    <td align="right" bgcolor="#CCFFCC"><div align="right"><? echo number_format($p4_3);?></td>
    <td align="right"><div align="right"><? echo number_format($p5_1);?></td>
    <td align="right"><div align="right"><? echo number_format($p5_2);?></td>
    <td align="right" bgcolor="#FFFFCC"><div align="right"><? echo number_format($p5_3);?></td>
    ...
    <td align="right" bgcolor="#CCFFCC"><div align="right"><? echo number_format($p6_4);?></td>
    <td align="right"><div align="right"><? echo number_format($p7_1);?></td>
    <td align="right"><div align="right"><? echo number_format($p7_2);?></td>
    <td align="right" bgcolor="#FFFFCC"><div align="right"><? echo number_format($p7_3);?></td>
    <td align="right" bgcolor="#FFCCCC"><div align="right"><? echo number_format($ptotal);?></td>
  </tr>
</table>
</div>
<br>

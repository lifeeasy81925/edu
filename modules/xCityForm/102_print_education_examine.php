...
<?echo "【".$city."政府申請教育部102年度推動教育優先區計畫各校補助項目複審結果列表】";?>
...
while($row = mysql_fetch_row($result)){
	...
	echo "<tr>";
		...
		echo "<td div align='right'>";
			echo number_format($a1_196);
		echo "</td>";
		echo "<td div align='right'>";
			echo number_format($a1_195);
		echo "</td>";
		echo "<td div align='right'>";
			echo number_format($a1_199);
		echo "</td>";
		echo "<td div align='right'>";
			echo number_format($a1_198);
		echo "</td>";
		echo "<td div align='right' bgcolor='#FFFFCC'>";
			echo number_format($a1_192);
		echo "</td>";
		echo "<td div align='right'>";
			echo number_format($a2_193);
		echo "</td>";
		echo "<td div align='right'>";
			echo number_format($a2_194);
		echo "</td>";
		echo "<td div align='right' bgcolor='#CCFFCC'>";
			echo number_format($a2_192);
		echo "</td>";
		echo "<td div align='right'>";
			echo number_format($a3_201);
		echo "</td>";
		echo "<td div align='right'>";
			echo number_format($a3_196);
		echo "</td>";
		echo "<td div align='right'>";
			echo number_format($a3_202);
		echo "</td>";
		echo "<td div align='right'>";
			echo number_format($a3_197);
		echo "</td>";
		echo "<td div align='right'>";
			echo number_format($a3_195);
		echo "</td>";
		echo "<td div align='right'>";
			echo number_format($a3_203);
		echo "</td>";
		echo "<td div align='right'>";
			echo number_format($a3_199);
		echo "</td>";
		echo "<td div align='right'>";
			echo number_format($a3_204);
		echo "</td>";
		echo "<td div align='right'>";
			echo number_format($a3_200);
		echo "</td>";
		echo "<td div align='right'>";
			echo number_format($a3_198);
		echo "</td>";
		echo "<td div align='right' bgcolor='#FFFFCC'>";
			echo number_format($a3_192);
		echo "</td>";
		echo "<td div align='right'>";
			echo number_format($a4_193);
		echo "</td>";
		echo "<td div align='right'>";
			echo number_format($a4_194);
		echo "</td>";
		echo "<td div align='right' bgcolor='#CCFFCC'>";
			echo number_format($a4_192);
		echo "</td>";
		echo "<td div align='right'>";
			echo number_format($a5_193);
		echo "</td>";
		echo "<td div align='right'>";
			echo number_format($a5_194);
		echo "</td>";
		echo "<td div align='right' bgcolor='#FFFFCC'>";
			echo number_format($a5_192);
		echo "</td>";
		echo "<td div align='right'>";
			echo number_format($a6_196);
		echo "</td>";
		echo "<td div align='right'>";
			echo number_format($a6_198);
		echo "</td>";
		echo "<td div align='right'>";
			echo number_format($a6_200);
		echo "</td>";
		echo "<td div align='right' bgcolor='#CCFFCC'>";
			echo number_format($a6_192);
		echo "</td>";
		echo "<td div align='right'>";
			echo number_format($a7_193);
		echo "</td>";
		echo "<td div align='right'>";
			echo number_format($a7_194);
		echo "</td>";
		echo "<td div align='right' bgcolor='#FFFFCC'>";
			echo number_format($a7_192);
		echo "</td>";

...
//補一
if($p158==1){
$sql_allowance = "select * from 102allowance1 where account like '$schoolid'";
...
//補二
if($p159==1){
$sql_allowance = "select * from 102allowance2 where account like '$schoolid'";
$result_allowance = mysql_query($sql_allowance);
while($row = mysql_fetch_row($result_allowance)){
...
//補三
if($p160==1 || $p161==1){
$sql_allowance = "select * from 102allowance3 where account like '$schoolid'";
$result_allowance = mysql_query($sql_allowance);
while($row = mysql_fetch_row($result_allowance)){
...
//補四
if($p162==1){
$sql_allowance = "select * from 102allowance4 where account like '$schoolid'";
$result_allowance = mysql_query($sql_allowance);
while($row = mysql_fetch_row($result_allowance)){
...
//補五
if($p163==1){
$sql_allowance = "select * from 102allowance5 where account like '$schoolid'";
$result_allowance = mysql_query($sql_allowance);
while($row = mysql_fetch_row($result_allowance)){
...
//補六
if($p164==1){
$sql_allowance = "select * from 102allowance6 where account like '$schoolid'";
$result_allowance = mysql_query($sql_allowance);
while($row = mysql_fetch_row($result_allowance)){
...
//補七
if($p165==1){
$sql_allowance = "select * from 102allowance7 where account like '$schoolid'";
$result_allowance = mysql_query($sql_allowance);
while($row = mysql_fetch_row($result_allowance)){

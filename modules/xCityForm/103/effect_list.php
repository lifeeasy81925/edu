...
<table width="100%" border="1" cellspacing="0" cellpadding="0">
	<tr>
		<td rowspan="4" width="150" height="60" align="center" bgcolor="#99CCCC">補助項目</td>
		...
		<td width="90" height="30"align="center" bgcolor="#99CCCC"><font color=red>執行情形<br />(必填)</font></td>
	</tr>
	<tr>
		<td colspan="5" align="center" bgcolor="#99CCCC">原計畫<br /></td>
	</tr>
	<tr>
		<td colspan="5" align="center" bgcolor="#99CCCC">修正後計畫(必填)<br /></td>
	</tr>
	<tr>
		<td colspan="5" align="center" bgcolor="#99CCCC">複審意見<br /></td>
	</tr>
...
<?
	...
	$sql = " select sd.account, sd.schooltype, sd.cityname, sd.district, sd.schoolname, sd.area, sd.getmoney_85to91, sd.traffic_status ".
		   ...
		   //上傳的檔案
		   "      , sun.a1_1, sun.a1_2, sun.a2_1, sun.a3_1, sun.a4_1, sun.a5_1, sun.a6_1, sun.a7_1 ".
					...
					<tr>
						...
						<td align="center">
							<form action='effect_school_01.php' method='post' style='margin:0px; display:inline;'>
								...
								<input type='submit' name='button' id='button' value='進入'>
							</form>
						</td>
					</tr>
					<tr>
					...
					<tr>
						<td colspan="5" align="left">
							...
							<?    
								if($a1_p1_money > 0) //有錢才顯示
								{
									echo get_url($effect_a1_1, $file_path, "親職教育講座核定後執行計畫")."<br />";
								} 
								
								if($a1_p2_money > 0) //有錢才顯示
								{ 
									echo get_url($effect_a1_2, $file_path, "家庭訪視核定後執行計畫")."<br />";
								}
								
								echo get_url($effect_a1_3, $file_path, "核定後執行經費概算表")."<br />";
								echo get_url($effect_a1_4, $file_path, "執行成果照片")."<br />";
				...
				?>
					...
					<tr>
						<td colspan="5" align="left">
							<font color="#8000FA">原計畫：</font><br />
							<?    
								echo get_url($a2_1, $file_path, "實施計畫")."<br />";
					...
					<tr>
						<td colspan="5" align="left">
							<font color="#8000FA">修正後計畫：</font><br />
							<?   
								echo get_url($effect_a2_1, $file_path, "核定後執行計畫")."<br />";
								echo get_url($effect_a2_2, $file_path, "核定後執行經費概算表")."<br />";
								echo get_url($effect_a2_3, $file_path, "執行成果照片")."<br />";
				...
				?>
					...
					<tr>
						<td colspan="5" align="left">
							<font color="#8000FA">修正後計畫：</font><br />
							<?  
								echo get_url($effect_a3_1, $file_path, "核定後執行計畫")."<br />";
								echo get_url($effect_a3_2, $file_path, "核定後執行經費概算表")."<br />";
								echo get_url($effect_a3_3, $file_path, "執行成果照片")."<br />";
				...
				?>
					...
					<tr>
						<td colspan="5" align="left">
							<font color="#8000FA">修正後計畫：</font><br />
							<?  
								echo get_url($effect_a4_1, $file_path, "核定後執行計畫")."<br />";
								echo get_url($effect_a4_2, $file_path, "核定後執行經費概算表")."<br />";
								echo get_url($effect_a4_3, $file_path, "執行成果照片")."<br />";
				...
				?>
					...
					<tr>
						<td colspan="5" align="left">
							<font color="#8000FA">原計畫：</font><br />
							<?   
								echo get_url($a5_1, $file_path, "實施計畫")."<br />";
					...
					<tr>
						<td colspan="5" align="left">
							<font color="#8000FA">修正後計畫：</font><br />
							<?  
								echo get_url($effect_a5_1, $file_path, "核定後執行計畫")."<br />";
								echo get_url($effect_a5_2, $file_path, "核定後執行經費概算表")."<br />";
								echo get_url($effect_a5_3, $file_path, "執行成果照片")."<br />";
				...
				?>
					...
					<tr>
						<td colspan="5" align="left">
							<font color="#8000FA">修正後計畫：</font><br />
							<?  
								echo get_url($effect_a6_1, $file_path, "核定後執行計畫")."<br />";
								echo get_url($effect_a6_2, $file_path, "核定後執行經費概算表")."<br />";
								echo get_url($effect_a6_3, $file_path, "執行成果照片")."<br />";
				...
				?>
					...
					<tr>
						<td colspan="5" align="left">
							<font color="#8000FA">修正後計畫：</font><br />
							<?  
								echo get_url($effect_a7_1, $file_path, "核定後執行計畫")."<br />";
								echo get_url($effect_a7_2, $file_path, "核定後執行經費概算表")."<br />";
								echo get_url($effect_a7_3, $file_path, "執行成果照片")."<br />";

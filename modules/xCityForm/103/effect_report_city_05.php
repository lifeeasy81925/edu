...
<table width="100%" border="1" cellspacing="0" cellpadding="0">
	...
	<tr>
		<td  align="center" bgcolor="#FFFFCC">項</td>
 ...
 <?
	...
	$sql = " select sd.account as sd_account, sd.schooltype, sd.cityname, sd.district, sd.schoolname, sd.area, sd.getmoney_85to91, sd.traffic_status ".
		   ...
		   "                       left join $table_name as a5 on sy.seq_no = a5.sy_seq ".
		   "                       left join $table_name_effect as a5_e on a5.sy_seq = a5_e.sy_seq ".
	...
	{
	   // $i=0;$j=0;$k=0;$l=0; //教育部 $i=特色1經常門數量 $j=特色1資本門數量  $k=特色2經常門數量 $l=特色2資本門數量

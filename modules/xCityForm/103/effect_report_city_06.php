...
<?
	...
	$sql = " select sd.account as sd_account, sd.schooltype, sd.cityname, sd.district, sd.schoolname, sd.area, sd.getmoney_85to91, sd.traffic_status ".
		   ...
		   "                       left join $table_name as a6 on sy.seq_no = a6.sy_seq ".
		   "                       left join $table_name_effect as a6_e on a6.sy_seq = a6_e.sy_seq ".
		...
		if($edu_total_money > 0)
		{
			...
			?>
				<tr>
					...
					<td align="right">-</td>
					<td align="right"><?=number_format($money_1);?></td>  <!--  租車費 -->
					<td align="right">-</td>
					<td align="right"><?=number_format($money_2);?></td>  <!--  交通費 -->
					<td align="right">-</td>
					<td align="right"><?=number_format($money_3);?></td>  <!--  購置交通車 -->

...
<?
		$sql = " select sd.account as sd_account, sd.schooltype, sd.cityname, sd.district, sd.schoolname, sd.area, sd.getmoney_85to91, sd.traffic_status ".
		   ...
		   //細項
			...
			//"      , a7.edu_total_money as a7_edu_total_money ".          //與112行重複
			"      , a7.edu_p1_money as a7_edu_p1_money ".                  //特色1總金額
			"      , a7.edu_p1_current_money as a7_edu_p1_current_money ".  //教育部核定經常門
			"      , a7.edu_p1_capital_money as a7_edu_p1_capital_money ".  //教育部核定資本門
			//"      , a7_e.execute_money as a7_execute_money ".            //與113行重複
			"      , a7_e.execute_current_money as a7_execute_current_money ".   //1040617新增 a7_execute_current_money  
			"      , a7_e.execute_capital_money as a7_execute_capital_money ".   //1040617新增 a7_execute_capital_money
		   ...
		   "      , a7.edu_total_money as a7_edu_total_money ". //與87行重複
		   "      , a7_e.execute_money as a7_execute_money ".   //與91行重複
	...
	{	
		...
		//補助七
		$a7_edu_p1_current_money = ($row['a7_edu_p1_current_money'] == '')?0:$row['a7_edu_p1_current_money']; //補助7特色1經常門 /元edu_p1_current_money
		$a7_edu_p1_capital_money = ($row['a7_edu_p1_capital_money'] == '')?0:$row['a7_edu_p1_capital_money']; //補助7特色1資本門 /元
		...
		$sum_a7_edu_current += $a7_edu_p1_current_money;  //補助7特色1經常門總合 sum_a7_current
		$sum_a7_edu_capital += $a7_edu_p1_capital_money;  //補助7特色1資本門總合

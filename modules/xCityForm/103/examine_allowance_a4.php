...
<table border="0">
	...
	<tr>
		<td nowrap="nowrap" >
			102年度 <a href="../effect_102_view_up_04.php?school=<?=$account;?>" target="_blank">執行計畫與經費</a>
		</td>
	</tr>
	<tr>
		<td nowrap="nowrap" >
			101年度 <a href="../effect_101_view_04.php?school=<?=$account;?>" target="_blank">執行成果</a>
		</td>
	</tr>
</table>
<p>
...
<font color=blue>※補助充實學校基本設備-初審金額：<input type="text" size="6" name="city_total_money" value="<?=$city_total_money;?>" style="border:0px; text-align: right;" readonly >
元 (本列自動計算)</font><p>
<table border="0">
	<tr>
...
<script language="JavaScript">
	...
	{
		//數值檢核
		if (<?=$class_total;?> < 7 && document.form.city_total_money.value > 100000) 
		{
			alert('6班以下經費不得大於10萬元！\n'+'該校班數：'+<?=$class_total;?>);
			return false;
		} 
		else if (<?=$class_total;?> < 13 && document.form.city_total_money.value > 150000) 
		{
			alert('7-12班經費不得大於15萬元！\n'+'該校班數：'+<?=$class_total;?>);
			
		} 
		else if ( document.form.city_total_money.value > 200000) 
		{

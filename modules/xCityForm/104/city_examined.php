...
<?
	...
	$sql = " select sd.account, sd.schooltype, sd.cityname, sd.district, sd.schoolname, sd.area, sd.getmoney_85to91, sd.traffic_status ".
		   ...
		   "                       left join alc_parenting_education as a1 on sd.account = a1.account ".
		   "                       left join alc_education_features as a2 on sd.account = a2.account ".
		   "                       left join alc_repair_dormitory as a3 on sd.account = a3.account ".
		   "                       left join alc_teaching_equipment as a4 on sd.account = a4.account ".
		   "                       left join alc_aboriginal_education as a5 on sd.account = a5.account ".
		   "                       left join alc_transport_car as a6 on sd.account = a6.account ".
		   "                       left join alc_school_activity as a7 on sd.account = a7.account ".
		   " where sy.school_year = '$school_year' ". 
		   "   and (a1.school_year = '$school_year' or a1.school_year is null) ".
		   "   and (a2.school_year = '$school_year' or a2.school_year is null) ".
		   "   and (a3.school_year = '$school_year' or a3.school_year is null) ".
		   "   and (a4.school_year = '$school_year' or a4.school_year is null) ".
		   "   and (a5.school_year = '$school_year' or a5.school_year is null) ".
		   "   and (a6.school_year = '$school_year' or a6.school_year is null) ".
		   "   and (a7.school_year = '$school_year' or a7.school_year is null) ".

...
<table width="100%" border="1" cellspacing="0" cellpadding="0">
	<tr>
		...
		縣市別：<?=$cityname;?>　　　　　　　　補助項目：二、補助學校發展教育特色</font></strong></td>
	</tr>
	<tr>
...
<?
	...
	$sql = " select sd.account as sd_account, sd.schooltype, sd.cityname, sd.district, sd.schoolname, sd.area, sd.getmoney_85to91, sd.traffic_status ".
		   "      , a2.edu_total_money, a2.edu_p1_current_money, a2.edu_p1_capital_money, a2.edu_p2_current_money, a2.edu_p2_capital_money ".
		   "      , a2_e.* ".

		   " from schooldata as sd left join schooldata_year as sy on sd.account = sy.account ".
		   "                       left join $a2_table_name as a2 on sy.seq_no = a2.sy_seq ".
		   "                       left join $a2_table_name_effect as a2_e on a2.sy_seq = a2_e.sy_seq ".

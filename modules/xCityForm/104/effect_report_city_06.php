...
<table width="100%" border="1" cellspacing="0" cellpadding="0">
	<tr>
		...
		縣市別：<?=$cityname;?>　　　　　　　　補助項目：六、補助原補助交通不便地區學校交通車</font></strong></td>
	</tr>
	<tr>
...
<?
	...
	$sql = " select sd.account as sd_account, sd.schooltype, sd.cityname, sd.district, sd.schoolname, sd.area, sd.getmoney_85to91, sd.traffic_status ".
		   "      , a6.edu_total_money, a6.item as a6_item ".
		   "      , a6_e.* ".
	...
	while($row = mysql_fetch_array($result))
	{
		...
		$sum_used_money_1    += $used_money_1;
		$sum_used_money_2    += $used_money_2;
		$sum_used_money_3    += $used_money_3;
		$sum_used_money      += $used_money;
...
?>
	<tr bgcolor="#FFFFCC">
		...
		<td align="right">-</td>
		<td align="right"><?=number_format($sum_money_1);?></td>
		<td align="right">-</td>
		<td align="right"><?=number_format($sum_money_2);?></td>
		<td align="right">-</td>
		<td align="right"><?=number_format($sum_money_3);?></td>
		<td align="right"><?=number_format($sum_edu_total_money);?></td>
		<td align="right">-</td>
		<td align="right"><?=number_format($sum_used_money_1);?></td>
		<td align="right">-</td>
		<td align="right"><?=number_format($sum_used_money_2);?></td>
		<td align="right">-</td>
		<td align="right"><?=number_format($sum_used_money_3);?></td>
		<td align="right"><?=number_format($sum_used_money);?></td>
		<td align="right"><?=number_format($sum_used_money / $sum_edu_total_money * 100,2);?>%</td>
	</tr>
	<tr>

...
<?
		$sql = " select sd.account as sd_account, sd.schooltype, sd.cityname, sd.district, sd.schoolname, sd.area, sd.getmoney_85to91, sd.traffic_status ".
		   ...
		   //細項
			...
			"      , a7_e.execute_current_money as a7_execute_current_money ".
			"      , a7_e.execute_capital_money as a7_execute_capital_money ".
...
<table align="center" border="1" cellspacing="0" cellpadding="0">
	...
	<tr height="30px">
		<td align="center" bgcolor="#FCE4D6">數量</td>
		<td align="center" bgcolor="#FCE4D6">金額(元)</td>
		<td align="center" bgcolor="#E2EFDA">數量</td>
	...
	<tr height="30px">
		...
		<td align="center" bgcolor="#FCE4D6"><? echo number_format($cnt_a3_edu_p1_current); ?></td>
		<td align="right"  bgcolor="#FCE4D6"><? echo number_format($sum_a3_edu_p1_current); ?></td>
		<td align="center" bgcolor="#E2EFDA"><? echo number_format($cnt_a3_p1_current); ?></td>
		<td align="right"  bgcolor="#E2EFDA"><? echo number_format($sum_a3_p1_current); ?></td>
		<td align="right"  bgcolor="#FFF2CC"><? echo number_format($sum_a3_p1_current / $sum_a3_edu_p1_current * 100,2).'%'; ?></td>
	</tr>
	<tr height="30px">
		<td width="100">資本門(式)</td>
		<td align="center" bgcolor="#FCE4D6"><? echo number_format($cnt_a3_edu_p1_capital); ?></td>
		<td align="right"  bgcolor="#FCE4D6"><? echo number_format($sum_a3_edu_p1_capital); ?></td>
		<td align="center" bgcolor="#E2EFDA"><? echo number_format($cnt_a3_p1_capital); ?></td>
		<td align="right"  bgcolor="#E2EFDA"><? echo number_format($sum_a3_p1_capital); ?></td>
		<td align="right"  bgcolor="#FFF2CC"><? echo number_format($sum_a3_p1_capital / $sum_a3_edu_p1_capital * 100,2).'%'; ?></td>
	</tr>
	<tr height="30px">
		<td width="80" rowspan="2">學生宿舍</td>
		<td width="100">經常門(棟)</td>
		<td align="center" bgcolor="#FCE4D6"><? echo number_format($cnt_a3_edu_p2_current); ?></td>
		<td align="right"  bgcolor="#FCE4D6"><? echo number_format($sum_a3_edu_p2_current); ?></td>
		<td align="center" bgcolor="#E2EFDA"><? echo number_format($cnt_a3_p2_current); ?></td>
		<td align="right"  bgcolor="#E2EFDA"><? echo number_format($sum_a3_p2_current); ?></td>
		<td align="right"  bgcolor="#FFF2CC"><? echo number_format($sum_a3_p2_current / $sum_a3_edu_p2_current * 100,2).'%'; ?></td>
	</tr>
	<tr height="30px">
		<td width="100">資本門(式)</td>
		<td align="center" bgcolor="#FCE4D6"><? echo number_format($cnt_a3_edu_p2_capital); ?></td>
		<td align="right"  bgcolor="#FCE4D6"><? echo number_format($sum_a3_edu_p2_capital); ?></td>
		<td align="center" bgcolor="#E2EFDA"><? echo number_format($cnt_a3_p2_capital); ?></td>
		<td align="right"  bgcolor="#E2EFDA"><? echo number_format($sum_a3_p2_capital); ?></td>
		<td align="right"  bgcolor="#FFF2CC"><? echo number_format($sum_a3_p2_capital / $sum_a3_edu_p2_capital * 100,2).'%'; ?></td>
	</tr>
	<tr height="30px">
	...
	<tr height="30px">
		...
		<td>經常門(項)</td>
		<td align="center" bgcolor="#FCE4D6"><? echo number_format($cnt_a5_edu_current); ?></td>
		<td align="right"  bgcolor="#FCE4D6"><? echo number_format($sum_a5_edu_current); ?></td>
		<td align="center" bgcolor="#E2EFDA"><? echo number_format($cnt_a5_current); ?></td>
		<td align="right"  bgcolor="#E2EFDA"><? echo number_format($sum_a5_current); ?></td>
		<td align="right"  bgcolor="#FFF2CC"><? echo number_format($sum_a5_current / $sum_a5_edu_current * 100,2).'%'; ?></td>
	</tr>
	<tr height="30px">
		<td>資本門(式)</td>
		<td align="center" bgcolor="#FCE4D6"><? echo number_format($cnt_a5_edu_capital); ?></td>
		<td align="right"  bgcolor="#FCE4D6"><? echo number_format($sum_a5_edu_capital); ?></td>
		<td align="center" bgcolor="#E2EFDA"><? echo number_format($cnt_a5_capital); ?></td>
		<td align="right"  bgcolor="#E2EFDA"><? echo number_format($sum_a5_capital); ?></td>
		<td align="right"  bgcolor="#FFF2CC"><? echo number_format($sum_a5_capital / $sum_a5_edu_capital * 100,2).'%'; ?></td>
	</tr>
	<tr height="30px">
		<td rowspan="3" align="center">六</td>
		<td rowspan="3">補助交通不便地區學校交通車</td>
		<td colspan="2">補助租車費(輛)</td>
		<td align="center" bgcolor="#FCE4D6"><? echo number_format($cnt_a6_edu_1); ?></td>
		<td align="right"  bgcolor="#FCE4D6"><? echo number_format($sum_a6_edu_1); ?></td>
		<td align="center" bgcolor="#E2EFDA"><? echo number_format($cnt_a6_1); ?></td>
		<td align="right"  bgcolor="#E2EFDA"><? echo number_format($sum_a6_1); ?></td>
		<td align="right"  bgcolor="#FFF2CC"><? echo number_format($sum_a6_1 / $sum_a6_edu_1 * 100,2).'%'; ?></td>
	</tr>
	<tr height="30px">
		<td colspan="2">補助交通費(人)</td>
		<td align="center" bgcolor="#FCE4D6"><? echo number_format($cnt_a6_edu_2); ?></td>
		<td align="right"  bgcolor="#FCE4D6"><? echo number_format($sum_a6_edu_2); ?></td>
		<td align="center" bgcolor="#E2EFDA"><? echo number_format($cnt_a6_2); ?></td>
		<td align="right"  bgcolor="#E2EFDA"><? echo number_format($sum_a6_2); ?></td>
		<td align="right"  bgcolor="#FFF2CC"><? echo number_format($sum_a6_2 / $sum_a6_edu_2 * 100,2).'%'; ?></td>
	</tr>
	<tr height="30px">
		<td colspan="2">補助購買交通車(輛)</td>
		<td align="center" bgcolor="#FCE4D6"><? echo number_format($cnt_a6_edu_3); ?></td>
		<td align="right"  bgcolor="#FCE4D6"><? echo number_format($sum_a6_edu_3); ?></td>
		<td align="center" bgcolor="#E2EFDA"><? echo number_format($cnt_a6_3); ?></td>
		<td align="right"  bgcolor="#E2EFDA"><? echo number_format($sum_a6_3); ?></td>
		<td align="right"  bgcolor="#FFF2CC"><? echo number_format($sum_a6_3 / $sum_a6_edu_3 * 100,2).'%'; ?></td>
	</tr>
	<tr height="30px">
		...
		<td>修建</td>
		<td align="center" bgcolor="#FCE4D6"><? echo number_format($cnt_a7_edu_current); ?></td>
		<td align="right"  bgcolor="#FCE4D6"><? echo number_format($sum_a7_edu_current); ?></td>
		<td align="center" bgcolor="#E2EFDA"><? echo number_format($cnt_a7_current); ?></td>
		<td align="right"  bgcolor="#E2EFDA"><? echo number_format($sum_a7_current); ?></td>
		<td align="right"  bgcolor="#FFF2CC"><? echo number_format($sum_a7_current / $sum_a7_edu_current * 100,2).'%'; ?></td>
	</tr>
	<tr height="30px">
		<td>設備</td>
		<td align="center" bgcolor="#FCE4D6"><? echo number_format($cnt_a7_edu_capital); ?></td>
		<td align="right"  bgcolor="#FCE4D6"><? echo number_format($sum_a7_edu_capital); ?></td>
		<td align="center" bgcolor="#E2EFDA"><? echo number_format($cnt_a7_capital); ?></td>
		<td align="right"  bgcolor="#E2EFDA"><? echo number_format($sum_a7_capital); ?></td>
		<td align="right"  bgcolor="#FFF2CC"><? echo number_format($sum_a7_capital / $sum_a7_edu_capital * 100,2).'%'; ?></td>
	</tr>
	<tr height="30px">

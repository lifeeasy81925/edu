...
<table width="100%" border="1" cellspacing="0" cellpadding="0">
	<tr>
		<td height="60" colspan="16" align="center"><strong><font color=blue>教育部 <?=$school_year;?> 年度推動教育優先區計畫直轄市、縣(市)政府各補助項目執行成果一覽表<br />
	...
	<tr>
		...
		<td colspan="4" align="center" bgcolor="#FFFFCC">推展親職教育活動</td>
		<td colspan="2" align="center" bgcolor="#FFFFCC">學習適應困難或特殊行為之目標學生個案家庭輔導</td>
	...
	<tr>
		...
		<td width="100" align="center" bgcolor="#FFFFCC">金額</td>
		<td width="40" align="center" bgcolor="#FFFFCC">場次</td>
		<td width="40" align="center" bgcolor="#FFFFCC">家長參與人次</td>
		<td width="40" align="center" bgcolor="#FFFFCC">目標學生家長參與人次</td>
		<td width="100" align="center" bgcolor="#FFFFCC">金額</td>
		<td width="40" align="center" bgcolor="#FFFFCC">人</td>
		<td width="100" align="center" bgcolor="#FFFFCC">金額</td>
		<td width="100" align="center" bgcolor="#FFFFCC">百分比</td>
		<td width="100" align="center" bgcolor="#FFFFCC">百分比</td>
	</tr>
<?
	//教育部核定金額
	...
	while($row = mysql_fetch_array($result))
	{
		...
		// 總計
		$sum_edu_p1_times      += $edu_p1_times;
		$sum_edu_p1_money      += $edu_p1_money;		
		$sum_edu_p2_people     += $edu_p2_people;
		$sum_edu_p2_money      += $edu_p2_money;
		$sum_p1_times          += $p1_times;
		$sum_p1_parents        += $p1_parents;
		$sum_p1_target_parents += $p1_target_parents;
		$sum_p1_used_money     += $p1_used_money;
		$sum_p2_people         += $p2_people;
		$sum_p2_used_money     += $p2_used_money;
		...
		if($edu_total_money > 0)
		{
			...
			?>
				<tr>
					...
					<td align="right"><?=number_format($p1_parents);?></td>
					<td align="right"><?=number_format($p1_target_parents);?></td>
...
?>
	<tr bgcolor="#FFFFCC">
		...
		<td align="right"><?=number_format($sum_edu_p1_times);?></td>
		<td align="right"><?=number_format($sum_edu_p1_money);?></td>
		<td align="right"><?=number_format($sum_edu_p2_people);?></td>
		<td align="right"><?=number_format($sum_edu_p2_money);?></td>
		<td align="right"><?=number_format($sum_p1_times);?></td>
		<td align="right"><?=number_format($sum_p1_parents);?></td>
		<td align="right"><?=number_format($sum_p1_target_parents);?></td>
		<td align="right"><?=number_format($sum_p1_used_money);?></td>
		<td align="right"><?=number_format($sum_p2_people);?></td>
		<td align="right"><?=number_format($sum_p2_used_money);?></td>
		<td align="right"><?=number_format($sum_p1_used_money / $sum_edu_p1_money * 100,2);?>%</td>
		<td align="right"><?=number_format($sum_p2_used_money / $sum_edu_p2_money * 100,2);?>%</td>
	</tr>
	<tr>
		<td height="40" colspan="16">承辦人：　　　　　　　　　　　　　　　　　　　　主管科長：　　　　　　　　　　　　　　　　　　　　局 (處) 長：</td>
	</tr>
</table>
</div>
<?php

...
<table width="100%" border="1" cellspacing="0" cellpadding="0" style="font-size:13px">
	<tr>
		...
		<td colspan="3" align="center" bgcolor="#FFFFCC">三、充實學校基本教學設備</td>
		<td colspan="3" align="center" bgcolor="#CCFFFF">四、發展原住民教育文化特色及充實設備器材</td>
		<td colspan="3" align="center" bgcolor="#FFFFCC">五、補助交通不便地區學校交通車</td>
		<td colspan="3" align="center" bgcolor="#CCFFFF">六、整修學校社區化活動場所</td>

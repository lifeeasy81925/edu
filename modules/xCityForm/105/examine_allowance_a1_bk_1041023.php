...
<table border="0">
	...
	<tr>
		<td nowrap="nowrap" >
			<?=($school_year-1);?>年度 <a href="../104/effect_view_school_up_01.php?school=<?=$account;?>" target="_blank">執行計畫與經費</a>
		</td>
	</tr>
	<tr>
		<td nowrap="nowrap" >
			<?=($school_year-2);?>年度 <a href="../103/effect_school_01.php?school=<?=$account;?>" target="_blank">執行成果</a>
		</td>
	</tr>
</table>
<p>
...
<table border="0">
	...
	<tr>
		...
		<td>
			...
			每人訪視2-4次，共<input type="text" size="2" name="city_p2_people" value="<?=$city_p2_people;?>" onChange="js:Count_family(this);">人次，
			<font color=blue>補助經費<input type="text" size="6" name="city_p2_money" value="<?=$city_p2_money;?>" style="border:0px; text-align: right;" readonly>元</font>。</b>
		</td>
	</tr>
</table>
<p>

...
<table border="0">
	...
	<tr>
		<td nowrap="nowrap" >
			<?=($school_year-1);?>年度 <a href="../104/effect_view_school_up_03.php?id=<?=$account;?>" target="_blank">執行計畫與經費</a>			
		</td>
	</tr>
	<tr>
		<td nowrap="nowrap" >
			<?=($school_year-2);?>年度 <a href="../103/effect_school_03.php?id=<?=$account;?>" target="_blank">執行成果</a>
		</td>
	</tr>
</table>
<p>

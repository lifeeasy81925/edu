...
<form name="form" method="post" action="examine_allowance_a5_finish.php" onSubmit="return toCheck();" onKeyDown="if(event.keyCode == 13) return false;">
...
<table border="0">
	...
	<tr>
		<td nowrap="nowrap" >
			<?=($school_year-1);?>年度 <a href="../104/effect_view_school_up_05.php?id=<?=$account;?>" target="_blank">執行計畫與經費</a>			
		</td>
	</tr>
	<tr>
		<td nowrap="nowrap" >
			<?=($school_year-2);?>年度 <a href="../103/effect_school_05.php?id=<?=$account;?>" target="_blank">執行成果</a> 
		</td>
	</tr>
</table>
<p>
...
<table border="0">
	...
	<tr>
		<td nowrap="nowrap" >
			<font color=blue>※補助發展原住民文化特色及設備器材-初審金額：<?=$school_year;?>年度：<input type="text" size="6" name="city_total_money" value="<?=$city_total_money;?>" style="border:0px; text-align: right;" readonly >元 (本列自動計算)</font>
		</td>
	</tr>
	<tr style="display:<?=($s_total_money_ny1 == 0 || $s_total_money_ny1 == '')?"none":"";?>;">
		<td nowrap="nowrap" >
			<font color=blue>※補助發展原住民文化特色及設備器材-初審金額：<?=($school_year+1);?>年度：<input type="text" size="6" name="city_total_money_ny1" value="<?=$city_total_money_ny1;?>" style="border:0px; text-align: right;" readonly >元 (本列自動計算)</font>
		</td>
	</tr>
	<tr style="display:<?=($s_total_money_ny2 == 0 || $s_total_money_ny2 == '')?"none":"";?>;">
		<td nowrap="nowrap" >
			<font color=blue>※補助發展原住民文化特色及設備器材-初審金額：<?=($school_year+2);?>年度：<input type="text" size="6" name="city_total_money_ny2" value="<?=$city_total_money_ny2;?>" style="border:0px; text-align: right;" readonly >元 (本列自動計算)</font>
		</td>
	</tr>
</table>
<p>
...
<table border="0" cellspacing="0" cellpadding="0" bgcolor="#FFFFCC" style="font-size:12px;">
	<tr>
...
<p>
<table border="0" style="width:700px;table-layout:fixed;word-break:break-all">
	<tr>
		<td nowrap="nowrap" style="width:150px; text-align:right; vertical-align:top;"><b>※<?=$school_year;?>年度特色一<br />初審意見：</b>
		</td>
		<td nowrap="nowrap"><textarea name="city_desc" cols="55" rows="4" style="border:0px;" readonly><?=$city_desc;?></textarea><p>
		</td>
	</tr>
</table>
<p>
...
<table width="60%" border="0" cellspacing="0" cellpadding="0" bgcolor="#FFFFCC" style="font-size:12px;">
	<tr>
		<td colspan="9" align="center" nowrap="nowrap" bgcolor="#99CC66"  style="font-size:14px;">特色一經費概算：學校申請</td>
		<td colspan="2" align="center" nowrap="nowrap" bgcolor="#FFCC66"  style="font-size:14px;">縣市初審</td>
		<td colspan="2" align="center" nowrap="nowrap" bgcolor="#FF9966"  style="font-size:14px;">教育部複審</td>			
...
<?
	//顯示	細項
	print_item($table_name_item, 'p1_'.($school_year+1), $main_seq);   //j10407
...
<table border="0" style="width:750px;table-layout:fixed;word-break:break-all">
	<tr>
		...
		<td nowrap="nowrap"><textarea name="city_desc_ny1" cols="55" rows="4" style="border:0px;" readonly><?=$city_desc_ny1;?></textarea><p>
		</td>
	</tr>
</table>
<p>
...
<?
	//顯示	細項
	print_item($table_name_item, 'p1_'.($school_year+2), $main_seq);   //j10407
...
<table border="0" style="width:750px;table-layout:fixed;word-break:break-all">
	<tr>
		...
		<td nowrap="nowrap"><textarea name="city_desc_ny2" cols="55" rows="4" style="border:0px;" readonly><?=$city_desc_ny2;?></textarea><p>
		</td>
	</tr>
</table>
<p>
...
<table border="0" style="width:750px;table-layout:fixed;word-break:break-all">
	<tr>
		...
		<td nowrap="nowrap"><textarea name="city_desc_p2" cols="55" rows="4" style="border:0px;" readonly><?=$city_desc_p2;?></textarea><p>
		</td>
	</tr>
</table>
<p>
...
<?
	//顯示	細項
	print_item($table_name_item, 'p2_'.($school_year+1), $main_seq);   //j10407
...
<table border="0" style="width:750px;table-layout:fixed;word-break:break-all">
	<tr>
		...
		<td nowrap="nowrap"><textarea name="city_desc_ny1_p2" cols="55" rows="4" style="border:0px;" readonly><?=$city_desc_ny1_p2;?></textarea><p>
		</td>
	</tr>
</table>
<p>
...
<?
	//顯示	細項
	print_item($table_name_item, 'p2_'.($school_year+2), $main_seq);   //j10407
...
<table border="0" style="width:750px;table-layout:fixed;word-break:break-all">
	<tr>
		...
		<td nowrap="nowrap"><textarea name="city_desc_ny2_p2" cols="55" rows="4" style="border:0px;" readonly><?=$city_desc_ny2_p2;?></textarea><p>
		</td>
	</tr>
</table>
<p>

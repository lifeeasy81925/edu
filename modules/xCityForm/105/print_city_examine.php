...
【<?=$cityname?> 政府申請教育部<?=($school_year);?>年度推動教育優先區計畫指標界定及補助項目經費彙整表 (表Ⅱ-2)】
...
<?
	...
	while($row = mysql_fetch_array($result))
	{
		...
		if($apply_money > 0) //有申請才顯示
		{
			...
			$a5_current_money = $a5_city_p1_current_money+$a5_city_p2_current_money;
			$a5_capital_money = $a5_city_p1_capital_money+$a5_city_p2_capital_money;
			...
			?>
				<tr>
					...
					<td align="right"><?=number_format($a3_city_p1_current_cnt); //補三-教師宿舍-經常-項?></td>
					<td align="right"><?=number_format($a3_city_p1_current_money); //補三-教師宿舍-經常-元?></td>
					<td align="right"><?=number_format($a3_city_p1_capital_cnt); //補三-教師宿舍-資本-項?></td>
					<td align="right"><?=number_format($a3_city_p1_capital_money); //補三-教師宿舍-資本-元?></td>
					<td align="right"><?=number_format($a3_city_p1_current_money+$a3_city_p1_capital_money); //補三-教師宿舍-總和?></td>
					<td align="right"><?=number_format($a3_city_p2_current_cnt); //補三-學生宿舍-經常-項?></td>
					<td align="right"><?=number_format($a3_city_p2_current_money); //補三-學生宿舍-經常-元?></td>
					<td align="right"><?=number_format($a3_city_p2_capital_cnt); //補三-學生宿舍-資本-項?></td>
					<td align="right"><?=number_format($a3_city_p2_capital_money); //補三-學生宿舍-資本-元?></td>
					<td align="right"><?=number_format($a3_city_p2_current_money+$a3_city_p2_capital_money); //補三-學生宿舍-總和?></td>
					<td align="right" bgcolor="#FFFFCC"><?=number_format($a3_city_p1_current_money+$a3_city_p1_capital_money+$a3_city_p2_current_money+$a3_city_p2_capital_money); //補三-總和?></td>
					<td align="right"><?=number_format($a4_city_p1_current_money); //補四經常?></td>
					<td align="right"><?=number_format($a4_city_p1_capital_money); //補四資本?></td>
					<td align="right" bgcolor="#CCFFCC"><?=number_format($a4_city_p1_current_money+$a4_city_p1_capital_money);?></td>
					...
					<td align="right"><?=($a6_item == '租車費')?number_format($a6_city_money):0; //補六租車費?></td>
					<td align="right"><?=($a6_item == '交通費')?number_format($a6_city_money):0; //補六交通費?></td>
					<td align="right"><?=($a6_item == '購置交通車')?number_format($a6_city_money):0; //補六購置交通車?></td>
					<td align="right" bgcolor="#CCFFCC"><?=number_format($a6_city_money);?></td>
					<td align="right"><?=number_format($a7_city_p1_current_money); //補七修建?></td>
					<td align="right"><?=number_format($a7_city_p1_capital_money); //補七設備?></td>
					<td align="right" bgcolor="#FFFFCC"><?=number_format($a7_city_p1_current_money+$a7_city_p1_capital_money); ?></td>
					<td align="right" bgcolor="#FFCCCC"><?=number_format($city_total); //各校加總?></td>
				</tr>
			<?
			...
			$sum_a3_p1_current_cnt += $a3_city_p1_current_cnt;
			$sum_a3_p1_current_money += $a3_city_p1_current_money;
			$sum_a3_p1_capital_cnt += $a3_city_p1_capital_cnt;
			$sum_a3_p1_capital_money += $a3_city_p1_capital_money;
			$sum_a3_p1 += $a3_city_p1_current_money+$a3_city_p1_capital_money;
			$sum_a3_p2_current_cnt += $a3_city_p2_current_cnt;
			$sum_a3_p2_current_money += $a3_city_p2_current_money;
			$sum_a3_p2_capital_cnt += $a3_city_p2_capital_cnt;
			$sum_a3_p2_capital_money += $a3_city_p2_capital_money;
			$sum_a3_p2 += $a3_city_p2_current_money+$a3_city_p2_capital_money;
			$sum_a3 = $sum_a3_p1 + $sum_a3_p2;
			
			$sum_a4_current += $a4_city_p1_current_money;
			$sum_a4_capital += $a4_city_p1_capital_money;
			$sum_a4 += $a4_city_p1_current_money + $a4_city_p1_capital_money;
			
			$sum_a5_current += $a5_current_money;
			$sum_a5_capital += $a5_capital_money;
			$sum_a5 += $a5_current_money + $a5_capital_money;
			
			$sum_a6_1 += ($a6_item == '租車費')?$a6_city_money:0;
			$sum_a6_2 += ($a6_item == '交通費')?$a6_city_money:0;
			$sum_a6_3 += ($a6_item == '購置交通車')?$a6_city_money:0;
			$sum_a6 += $a6_city_money;
			
			$sum_a7_current += $a7_city_p1_current_money;
			$sum_a7_capital += $a7_city_p1_capital_money;
			$sum_a7 += $a7_city_p1_current_money + $a7_city_p1_capital_money;
			
			$sum_a1_to_a7 += $city_total;

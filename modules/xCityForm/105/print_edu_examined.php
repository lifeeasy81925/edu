...
<?
	...
	$sql = " select sd.account, sd.schooltype, sd.cityname, sd.district, sd.schoolname, sd.area, sd.getmoney_85to91, sd.traffic_status ".
		   ...
		   "      , a5.city_total_money_ny1 as a5_city_money_ny1 ".
		   ...
		   "      , a5.edu_total_money_ny1 as a5_edu_money_ny1 ".
		   "      , a5.edu_p1_money_ny1 as a5_edu_p1_money_ny1, a5.edu_p2_money_ny1 as a5_edu_p2_money_ny1 ".
		   "      , a5.edu_p1_current_money_ny1 as a5_edu_p1_current_money_ny1 ".
		   "      , a5.edu_p1_capital_money_ny1 as a5_edu_p1_capital_money_ny1 ".
		   "      , a5.edu_p2_current_money_ny1 as a5_edu_p2_current_money_ny1 ".
		   "      , a5.edu_p2_capital_money_ny1 as a5_edu_p2_capital_money_ny1 ".
		   "      , a5.edu_desc_ny1 as a5_edu_desc_ny1, a5.edu_desc_ny1_p2 as a5_edu_desc_ny1_p2 ".
		   		   
		   "      , a5.edu_total_money_ny2 as a5_edu_money_ny2 ".
		   "      , a5.edu_p1_money_ny2 as a5_edu_p1_money_ny2, a5.edu_p2_money_ny2 as a5_edu_p2_money_ny2 ".
		   "      , a5.edu_p1_current_money_ny2 as a5_edu_p1_current_money_ny2 ".
		   "      , a5.edu_p1_capital_money_ny2 as a5_edu_p1_capital_money_ny2 ".
		   "      , a5.edu_p2_current_money_ny2 as a5_edu_p2_current_money_ny2 ".
		   "      , a5.edu_p2_capital_money_ny2 as a5_edu_p2_capital_money_ny2 ".
		   "      , a5.edu_desc_ny2 as a5_edu_desc_ny2, a5.edu_desc_ny2_p2 as a5_edu_desc_ny2_p2 ".
	...
	while($row = mysql_fetch_array($result))
	{
		...
		$a5_edu_money_ny1 = ($row['a5_edu_money_ny1'] == '')?0:$row['a5_edu_money_ny1'];
		$a5_edu_money_ny2 = ($row['a5_edu_money_ny2'] == '')?0:$row['a5_edu_money_ny2'];
		...
		$a5_city_desc_p2 = $row['a5_city_desc_p2'];
		...
		$a5_edu_desc_p2 = $row['a5_edu_desc_p2'];
		$a5_edu_desc_ny1 = $row['a5_edu_desc_ny1'];
		$a5_edu_desc_ny1_p2 = $row['a5_edu_desc_ny1_p2'];
		$a5_edu_desc_ny2 = $row['a5_edu_desc_ny2'];
		$a5_edu_desc_ny2_p2 = $row['a5_edu_desc_ny2_p2'];
		...
		$a5_edu_p1_money_ny1 = ($row['a5_edu_p1_money_ny1'] == '')?0:$row['a5_edu_p1_money_ny1']; //NULL則填入0
		$a5_edu_p1_current_money_ny1 = ($row['a5_edu_p1_current_money_ny1'] == '')?0:$row['a5_edu_p1_current_money_ny1'];
		$a5_edu_p1_capital_money_ny1 = ($row['a5_edu_p1_capital_money_ny1'] == '')?0:$row['a5_edu_p1_capital_money_ny1'];
		$a5_edu_p2_money_ny1 = ($row['a5_edu_p2_money_ny1'] == '')?0:$row['a5_edu_p2_money_ny1'];
		$a5_edu_p2_current_money_ny1 = ($row['a5_edu_p2_current_money_ny1'] == '')?0:$row['a5_edu_p2_current_money_ny1'];
		$a5_edu_p2_capital_money_ny1 = ($row['a5_edu_p2_capital_money_ny1'] == '')?0:$row['a5_edu_p2_capital_money_ny1'];
		
		$a5_edu_p1_money_ny2 = ($row['a5_edu_p1_money_ny2'] == '')?0:$row['a5_edu_p1_money_ny2']; //NULL則填入0
		$a5_edu_p1_current_money_ny2 = ($row['a5_edu_p1_current_money_ny2'] == '')?0:$row['a5_edu_p1_current_money_ny2'];
		$a5_edu_p1_capital_money_ny2 = ($row['a5_edu_p1_capital_money_ny2'] == '')?0:$row['a5_edu_p1_capital_money_ny2'];
		$a5_edu_p2_money_ny2 = ($row['a5_edu_p2_money_ny2'] == '')?0:$row['a5_edu_p2_money_ny2'];
		$a5_edu_p2_current_money_ny2 = ($row['a5_edu_p2_current_money_ny2'] == '')?0:$row['a5_edu_p2_current_money_ny2'];
		$a5_edu_p2_capital_money_ny2 = ($row['a5_edu_p2_capital_money_ny2'] == '')?0:$row['a5_edu_p2_capital_money_ny2'];
	...
	$city_total_money_ny = $a2_city_money_ny1 + $a2_city_money_ny2 + $a5_city_money_ny1 + $a5_city_money_ny2;
	...
	$edu_total_money_ny = $a2_edu_money_ny1 + $a2_edu_money_ny2 + $a5_edu_money_ny1 + $a5_edu_money_ny2;
...
<table width="900px" align="center" border="1" cellpadding="0" cellspacing="0">
	<tr>
		...
		<td colspan="5" class="style3"><div align="center"><?=$account.'　'.$cityname.$district.$schoolname;?></div></td>
	</tr>
	<tr>
	...
	<tr>
		...
		<td height="30" rowspan="2" class="style3">推展親職教育活動<br /><?=($a1_money > 0)?"<a href='edu_funds.php?op=1&acc=$account' target='_blank'>(開啟審核經費表)</a>":"";?></td>
	...
	<tr>
		...
		<td height="30" rowspan="4" class="style3">補助學校發展教育特色<br /><?=($a2_money > 0)?"<a href='edu_funds.php?op=2&acc=$account' target='_blank'>(開啟審核經費表)</a>":"";?></td>
		...
		<td height="30" bgcolor="#FFCC99" class="style3"><div align="right"><?=number_format($a2_edu_p1_current_money);?></div></td>
		<td height="30" rowspan="2" bgcolor="#FFCC99" class="style3"><?=$a2_edu_desc;?></td>
	</tr>
	<tr>
	...
	<tr>
		...
		<td height="30" rowspan="2" bgcolor="#FFCC99" class="style3"><?=$a2_edu_desc_p2;?></td>
	</tr>
	<tr>
		<td height="30" nowrap="nowrap" class="style3">資本門</td>
	...
	<tr>
		...
		<td height="30" rowspan="4" class="style3">修繕離島或偏遠地區師生宿舍<br /><?=($a3_money > 0)?"<a href='edu_funds.php?op=3&acc=$account' target='_blank'>(開啟審核經費表)</a>":"";?></td>
	...
	<tr>
		...
		<td height="30" rowspan="2" class="style3">充實學校基本教學設備<br /><?=($a4_money > 0)?"<a href='edu_funds.php?op=4&acc=$account' target='_blank'>(開啟審核經費表)</a>":"";?></td>
	...
	<tr>
		...
		<td height="30" rowspan="4" class="style3">發展原住民教育文化特色及充實設備器材<br /><?=($a5_money > 0)?"<a href='edu_funds.php?op=5&acc=$account' target='_blank'>(開啟審核經費表)</a>":"";?></td>
		...
		<td height="30" rowspan="2" bgcolor="#CCFFCC" class="style3"><?=$a5_city_desc;?></td>
		<td height="30" bgcolor="#FFCC99" class="style3"><div align="right"><?=number_format($a5_edu_p1_current_money);?></div></td>
		<td height="30" rowspan="2" bgcolor="#FFCC99" class="style3"><?=$a5_edu_desc;?></td>
	</tr>
	<tr>
		<td height="30" nowrap="nowrap" class="style3">資本門</td>
	...
	<tr>
		...
		<td height="30" rowspan="2" bgcolor="#CCFFCC" class="style3"><?=$a5_city_desc_p2;?></td>
		<td height="30" bgcolor="#FFCC99" class="style3"><div align="right"><?=number_format($a5_edu_p2_current_money);?></div></td>
		<td height="30" rowspan="2" bgcolor="#FFCC99" class="style3"><?=$a5_edu_desc_p2;?></td>
	</tr>
	<tr>
		<td height="30" nowrap="nowrap" class="style3">資本門</td>
	...
	<tr>
		...
		<td height="30" rowspan="3" class="style3">補助交通不便學校交通車<br /><?=($a6_money > 0)?"<a href='edu_funds.php?op=6&acc=$account' target='_blank'>(開啟審核經費表)</a>":"";?></td>
	...
	<tr>
		...
		<td height="30" rowspan="2" class="style3">整修學校社區化活動場所<br /><?=($a7_money > 0)?"<a href='edu_funds.php?op=7&acc=$account' target='_blank'>(開啟審核經費表)</a>":"";?></td>
	...
	<tr>
		...
		<td bgcolor="#FFCC99" class="style3"><div align="right"><?=number_format($edu_total_money);?></div></td>
...
<table width="900px" border="1" align="center" cellpadding="0" cellspacing="0" style="font-family:標楷體">
	<tr>
		...
		<td bgcolor="#FFCC99" class="style3"><div align="center">教育部複審金額</div></td>
		<td bgcolor="#FFCC99" class="style3">教育部複審說明</td>
	</tr>
<? if($total_money_ny <= 0) { echo "-->"; } ?>
<? if($a2_money_ny1 <= 0) { echo "<!--"; } ?>
	<tr>
		...
		<td height="30" bgcolor="#FFCC99" class="style3"><div align="right"><?=number_format($a2_edu_p1_current_money_ny1);?></div></td>
		<td height="30" rowspan="2" bgcolor="#FFCC99" class="style3"><?=$a2_edu_desc_ny1;?></td>
	</tr>
	<tr>
		<td height="30" nowrap="nowrap" class="style3">資本門</td>
		...
		<td height="30" bgcolor="#FFCC99" class="style3"><div align="right"><?=number_format($a2_edu_p1_capital_money_ny1);?></div></td>
	</tr>
	<tr>
		<td height="30" rowspan="2" class="style3">發展特色二：<br /><?=$a2_p2_name;?></td>
		<td height="30" nowrap="nowrap" class="style3">經常門</td>
		...
		<td height="30" bgcolor="#FFCC99" class="style3"><div align="right"><?=number_format($a2_edu_p2_current_money_ny1);?></div></td>
		<td height="30" rowspan="2" bgcolor="#FFCC99" class="style3"><?=$a2_edu_desc_ny1_p2;?></td>
	</tr>
	<tr>
		<td height="30" nowrap="nowrap" class="style3">資本門</td>
		...
		<td height="30" bgcolor="#FFCC99" class="style3"><div align="right"><?=number_format($a2_edu_p2_capital_money_ny1);?></div></td>
	</tr>
<? if($a2_money_ny1 <= 0) { echo "-->"; } ?>
<? if($a2_money_ny2 <= 0) { echo "<!--"; } ?>
	<tr>
		...
		<td height="30" bgcolor="#FFCC99" class="style3"><div align="right"><?=number_format($a2_edu_p1_current_money_ny2);?></div></td>
		<td height="30" rowspan="2" bgcolor="#FFCC99" class="style3"><?=$a2_edu_desc_ny2;?></td>
	</tr>
	<tr>
		<td height="30" nowrap="nowrap" class="style3">資本門</td>
		...
		<td height="30" bgcolor="#FFCC99" class="style3"><div align="right"><?=number_format($a2_edu_p1_capital_money_ny2);?></div></td>
	</tr>
	<tr>
		<td height="30" rowspan="2" class="style3">發展特色二：<br /><?=$a2_p2_name;?></td>
		<td height="30" nowrap="nowrap" class="style3">經常門</td>
		...
		<td height="30" bgcolor="#FFCC99" class="style3"><div align="right"><?=number_format($a2_edu_p2_current_money_ny2);?></div></td>
		<td height="30" rowspan="2" bgcolor="#FFCC99" class="style3"><?=$a2_edu_desc_ny2_p2;?></td>
	</tr>
	<tr>
		<td height="30" nowrap="nowrap" class="style3">資本門</td>
		...
		<td height="30" bgcolor="#FFCC99" class="style3"><div align="right"><?=number_format($a2_edu_p2_capital_money_ny2);?></div></td>
	</tr>
<? if($a2_money_ny2 <= 0) { echo "-->"; } ?>
<? if($a5_money_ny1 <= 0) { echo "<!--"; } ?>
	<tr>
		...
		<td height="30" bgcolor="#FFCC99" class="style3"><div align="right"><?=number_format($a5_edu_p1_current_money_ny1);?></div></td>
		<td height="30" rowspan="2" bgcolor="#FFCC99" class="style3"><?=$a5_edu_desc_ny1;?></td>
	</tr>
	<tr>
		<td height="30" nowrap="nowrap" class="style3">資本門</td>
		...
		<td height="30" bgcolor="#FFCC99" class="style3"><div align="right"><?=number_format($a5_edu_p1_capital_money_ny1);?></div></td>
	</tr>
	<tr>
		<td height="30" rowspan="2" class="style3">發展特色二：<br /><?=$a5_p2_name;?></td>
		<td height="30" nowrap="nowrap" class="style3">經常門</td>
		...
		<td height="30" bgcolor="#FFCC99" class="style3"><div align="right"><?=number_format($a5_edu_p2_current_money_ny1);?></div></td>
		<td height="30" rowspan="2" bgcolor="#FFCC99" class="style3"><?=$a5_edu_desc_ny1_p2;?></td>
	</tr>
	<tr>
		<td height="30" nowrap="nowrap" class="style3">資本門</td>
		...
		<td height="30" bgcolor="#FFCC99" class="style3"><div align="right"><?=number_format($a5_edu_p2_capital_money_ny1);?></div></td>
	</tr>
<? if($a5_money_ny1 <= 0) { echo "-->"; } ?>
<? if($a5_money_ny2 <= 0) { echo "<!--"; } ?>
	<tr>
		...
		<td height="30" bgcolor="#FFCC99" class="style3"><div align="right"><?=number_format($a5_edu_p1_current_money_ny2);?></div></td>
		<td height="30" rowspan="2" bgcolor="#FFCC99" class="style3"><?=$a5_edu_desc_ny2;?></td>
	</tr>
	<tr>
		<td height="30" nowrap="nowrap" class="style3">資本門</td>
		...
		<td height="30" bgcolor="#FFCC99" class="style3"><div align="right"><?=number_format($a5_edu_p1_capital_money_ny2);?></div></td>
	</tr>
	<tr>
		<td height="30" rowspan="2" class="style3">發展特色二：<br /><?=$a5_p2_name;?></td>
		<td height="30" nowrap="nowrap" class="style3">經常門</td>
		...
		<td height="30" bgcolor="#FFCC99" class="style3"><div align="right"><?=number_format($a5_edu_p2_current_money_ny2);?></div></td>
		<td height="30" rowspan="2" bgcolor="#FFCC99" class="style3"><?=$a5_edu_desc_ny2_p2;?></td>
	</tr>
	<tr>
		<td height="30" nowrap="nowrap" class="style3">資本門</td>
		...
		<td height="30" bgcolor="#FFCC99" class="style3"><div align="right"><?=number_format($a5_edu_p2_capital_money_ny2);?></div></td>
	</tr>
<? if($a5_money_ny2 <= 0) { echo "-->"; } ?>
<? if($total_money_ny <= 0) { echo "<!--"; } ?>
	<tr>
		...
		<td bgcolor="#CCFFCC" class="style3">&nbsp;</td>
		<td bgcolor="#FFCC99" class="style3"><div align="right"><?=number_format($edu_total_money_ny);?></div></td>
		<td bgcolor="#FFCC99" class="style3">&nbsp;</td>
	</tr>
</table>
<? if($total_money_ny <= 0) { echo "-->"; } ?>

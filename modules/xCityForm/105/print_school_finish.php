...
<table border="0">
	<tr>
		<td><font color="blue"><?=$cityname;?></font> <?=$strTitle;?>完成國小學校列表</td>
	</tr>
</table> 
...
<table border="0">
	<tr>
		<td><font color="blue"><?=$cityname;?></font> <?=$strTitle;?>完成國中學校列表</td>
	</tr>
</table> 
<table border="1" cellpadding="0" cellspacing="0">
	<tr align="center">
...
合計校數：<font color=blue><?=$serial_e+$serial_j;?></font>校 / <?=$serial_e_all+$serial_j_all;?>校
<?=$strTitle;?>率：<?=number_format(($serial_e+$serial_j) / ($serial_e_all+$serial_j_all) * 100,2);?>%
<p>

...
<table border="0">
	<tr>
		<td><font color="blue"><?=$cityname;?></font> 已填報完成國小學校列表</td>
	</tr>
</table>
	   ...
	   if($keep ==1) 
	       {
	  	      if($final_2 != '')
	  	    	{
					    $file_path = '/epa_uploads/'.$school_year.'/pub/'.$account.'/';
	  	 	  			...
	  	 	  			echo "</td>";
	  	 	  			echo "<td>";
	  	 	  			echo "<a href='".$file_path.$final_2."' target='_new'>下載檔案</a>";//檔案二  $final_2
	  	 	  			echo "</td>";			
	  	 	  			echo "</tr>";
	  	 	  	}
		   }else{
			  if($final_1 != '' && $final_2 != '')
			     {
				 	  	 //1040428修改，區分公開路徑$file_path及可能含個資$file_path2
	  	 	  	        $file_path = '/epa_uploads/'.$school_year.'/pub/'.$account.'/';
...
<table border="0">
	<tr>
		<td><font color="blue"><?=$cityname;?></font> 已填報完成國中學校列表</td>
	</tr>
</table> 
<table border="1" cellpadding="0" cellspacing="0">
	<tr align="center">
...
已填報率：<?=number_format(($serial_e+$serial_j) / ($serial_e_all+$serial_j_all) * 100,2);?>%
<p>

...
<table width="100%" border="1" cellspacing="0" cellpadding="0">
	<tr>
		...
		縣市別：<?=$cityname;?>　　　　　　　　補助項目：四、發展原住民教育文化特色及充實設備器材</font></strong></td>
	</tr>
  	<tr>
 ...
 <?
	...
	$sql = " select sd.account as sd_account, sd.schooltype, sd.cityname, sd.district, sd.schoolname, sd.area, sd.getmoney_85to91, sd.traffic_status ".
		   "      , a4.edu_total_money, a4.edu_p1_current_money, a4.edu_p1_capital_money, a4.edu_p2_current_money, a4.edu_p2_capital_money ".
		   "      , a4_e.* ".

		   " from schooldata as sd left join schooldata_year as sy on sd.account = sy.account ".
		   "                       left join $a4_table_name as a4 on sy.seq_no = a4.sy_seq ".
		   "                       left join $a4_table_name_effect as a4_e on a4.sy_seq = a4_e.sy_seq ".

<?php
	...
	//教育部核定金額
	$sql = " select a5.edu_total_money, a5.item as a5_item ".
		   "      , a5_e.* ".
...
<strong>項目：五、補助交通不便地區學校交通車  </strong><a href="/edu/modules/xSchoolForm/download/allowance-06.htm" target="_blank">(補助項目說明)</a>
<p>
<table border="0">
	<tr>
		<td>

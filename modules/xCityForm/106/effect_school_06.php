<?php
	...
	//教育部核定金額
	$sql = " select a6.edu_total_money, a6.edu_p1_current_money, a6.edu_p1_capital_money, a6.p_num as a6_p_num ".
		   "      , a6_e.* ".
...
<strong>項目：六、整修學校社區化活動場所  </strong><a href="/edu/modules/xSchoolForm/download/allowance-07.htm" target="_blank">(補助項目說明)</a>
<p>
<table border="0">
	<tr>
		<td>
			...
			補助綜合球場(
			<input type="text" size="5" name="a6_p_num" id="a6_p_num" value="<?=$a6_p_num;?>" style="border:0px; text-align: right;" readonly >座，

...
<form style="margin:0px; display:inline;"><p>
	...
	<font color="blue"><?=$cityname;?></font> 已填報完成學校列表<p>
			...
			<?
				...
				while($row = mysql_fetch_array($result))
				{
					...
					if($final_1 != null && $final_2 != null)
					{
						...
						echo "<td align='center'><a href='".$file_path.$final_1."' target='_new'>查閱</a></td>";  // 檔案一  $final_1
						echo "<td align='center'><a href='".$file_path.$final_2."' target='_new'>查閱</a></td>";  // 檔案二  $final_2
						echo "<td align='center'><a href='print_edu_examined.php?acc=".$account."' target='_blank'>審核狀況</a></td>";
						echo "<td align='center'><a href='school_upload_file.php?id=".$account."&page=2' target='_self'>計畫檔案</a></td>";
						echo "</tr>";
					}
					$serial_e_all++;
				}

...
<table border="0">
	...
	<tr>
		<td><img src="./images/dot_03.gif" align="absmiddle" /><a href="effect_report_city.php" target="_self">檢視縣市及各校執行成果報表 (104、103、102、101、100年度)</a></td>
	</tr>
	<tr>
	...
	<tr>
		<td>
			<div style="background-color:#FFCECD">101年度<br />
				...
				<img src="./images/dot_01.gif" align="absmiddle" /><a href="print_city_examine.php"  target="_blank">2.縣市審核補助結果(表Ⅱ-2)</a><br />
				<img src="./images/dot_01.gif" align="absmiddle" /><a href="print_city_examine_2.php" target="_blank">3.縣市審核指標結果(表Ⅱ-3)</a><br />
...
<?
	...
	//上傳路徑
	$file_path = '/edu_upload/104/'.$account_104.'/';
?>
...
<? 
	...
	elseif ($cityno!='0') 
	{
		echo "　(1)狀態：<font color=blue>已上傳</font>，檔名：<a href='".$file_path.$file_104_1."' target='_new'>".$file_104_1.$file_104_1_name."</a>";
	}
?>
</form>
...
<? 
	...
	elseif ($cityno!='0') 
	{
		echo "　(2)狀態：<font color=blue>已上傳</font>，檔名：<a href='".$file_path.$file_104_2."' target='_new'>".$file_104_2.$file_104_2_name."</a>";
	}
?>
</form>
...
<? 
	...
	elseif ($cityno!='0') 
	{
		echo "　(3)狀態：<font color=blue>已上傳</font>，檔名：<a href='".$file_path.$file_104_3."' target='_new'>".$file_104_3.$file_104_3_name."</a>";
	}
?>
</form>
...
<? 
	...
	elseif ($cityno!='0') 
	{
		echo "　(4)狀態：<font color=blue>已上傳</font>，檔名：<a href='".$file_path.$file_104_4."' target='_new'>".$file_104_4.$file_104_4_name."</a>";
	}
?>
</form>
...
<? 
	...
	elseif ($cityno!='0') 
	{
		echo "　(5)狀態：<font color=blue>已上傳</font>，檔名：<a href='".$file_path.$file_104_5."' target='_new'>".$file_104_5.$file_104_5_name."</a>";
	}
?>
</form>

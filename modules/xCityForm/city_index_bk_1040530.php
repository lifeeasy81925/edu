...
<table border="0">
	<tr>
		<td style="text-align:center; background-color:#FC9;">104年度 報表資料列印區</td>
	</tr>
	<tr>
...
<?
	...
	//上傳路徑     //1040505修改上傳路徑
	$file_path = '/epa_uploads/103/pub/'.$account_103.'/';
	...
	elseif ($cityno!='0') 
	{
		echo "狀態：<font color=blue>已上傳</font>&nbsp;&nbsp;&nbsp;&nbsp;<a href='".$file_path.$file_103_1."' target='_new'>下載".$file_103_1_name."</a>";
	}
	...
	elseif ($cityno!='0') 
	{
		echo "狀態：<font color=blue>已上傳</font>&nbsp;&nbsp;&nbsp;&nbsp;<a href='".$file_path.$file_103_2."' target='_new'>下載".$file_103_2_name."</a>";
	}
	...
	elseif ($cityno!='0') 
	{
		echo "狀態：<font color=blue>已上傳</font>&nbsp;&nbsp;&nbsp;&nbsp;<a href='".$file_path.$file_103_3."' target='_new'>下載".$file_103_3_name."</a>";
	}
	...
	elseif ($cityno!='0') 
	{
		echo "狀態：<font color=blue>已上傳</font>&nbsp;&nbsp;&nbsp;&nbsp;<a href='".$file_path.$file_103_4."' target='_new'>下載".$file_103_4_name."</a>";
	}
	...
	elseif ($cityno!='0') 
	{
		echo "狀態：<font color=blue>已上傳</font>&nbsp;&nbsp;&nbsp;&nbsp;<a href='".$file_path.$file_103_5."' target='_new'>下載".$file_103_5_name."</a>";
	}
?>
<br />
<!-- 1040511修改，隱藏102年以前資料
...
<?
	...
	echo "<br />　(1)";
	if ($cityno!='0' && $file_1 == ''){echo "狀態：<font color=red>未上傳".$file_1_name."</font>";} elseif ($cityno!='0') {echo '狀態：<font color=blue>已上傳</font>'.'&nbsp;&nbsp;&nbsp;&nbsp;'.'<a href="./upload/101/'.$username.'/'.$file_1.'" target="_new">下載'.$file_1_name.'</a>';}
	
	echo "<br />　(2)";
	if ($cityno!='0' && $file_2 == ''){echo "狀態：<font color=red>未上傳".$file_2_name."</font>";} elseif ($cityno!='0') {echo '狀態：<font color=blue>已上傳</font>'.'&nbsp;&nbsp;&nbsp;&nbsp;'.'<a href="./upload/101/'.$username.'/'.$file_2.'" target="_new">下載'.$file_2_name.'</a>';}
	
	echo "<br />　(3)";
	if ($cityno!='0' && $file_3 == ''){echo "狀態：<font color=red>未上傳".$file_3_name."</font>";} elseif ($cityno!='0') {echo '狀態：<font color=blue>已上傳</font>'.'&nbsp;&nbsp;&nbsp;&nbsp;'.'<a href="./upload/101/'.$username.'/'.$file_3.'" target="_new">下載'.$file_3_name.'</a>';}
	
	echo "<br />　(4)";
	if ($cityno!='0' && $file_4 == ''){echo "狀態：<font color=red>未上傳".$file_4_name."</font>";} elseif ($cityno!='0') {echo '狀態：<font color=blue>已上傳</font>'.'&nbsp;&nbsp;&nbsp;&nbsp;'.'<a href="./upload/101/'.$username.'/'.$file_4.'" target="_new">下載'.$file_4_name.'</a>';}

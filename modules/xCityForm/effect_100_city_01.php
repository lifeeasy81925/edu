...
//讀出縣市自評資料表
$sql_city = "select  *  from 100city_effect where city like '$city'";
...
?> 
<p><a href="../../doc/100年度「推動教育優先區計畫」縣市自評表.doc"><img src="/edu/modules/xCityForm/images/download_02.gif" width="20" height="20" alt="下載" align="absmiddle" /> 縣市自評表電子檔下載</a> (建議從電子檔填妥後複製貼上)
<p>
<strong>100年度<? echo $city; ?>「推動教育優先區計畫」縣市自評表</strong><br />

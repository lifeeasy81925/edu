...
//include "../../header.php";
//這之前不能有任何的output,ex:echo, print等動作 
header('Content-type: application/xls');      
header('Content-Disposition: attachment; filename=effect_100_list.xls');
session_start(); 
...
<table width="100%" border="1" cellspacing="0" cellpadding="0">
  <tr>
    ...
    <td align="center" bgcolor="#99CCCC">成果填報</td>
    <td height="40" align="center" bgcolor="#99CCCC">檔案上傳</td>
  </tr>
  <?

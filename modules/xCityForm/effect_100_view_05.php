...
<p>
<font color=blue>核定經費：<input type="text" size="5" name="fn_a5" value=<? echo number_format($fn_a5);?> style="border:0px; text-align: right;" readonly >
元。</font><br /><br />
<strong>※執行金額：</strong>
<input type="text" size="5" name="ef_1" value=<? echo number_format($ef_1);?>>
元。(執行進度依據)<br />
<p>

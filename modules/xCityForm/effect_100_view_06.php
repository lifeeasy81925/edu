...
<p>
<font color=blue>核定經費：<input type="text" size="5" name="fn_a6" value=<? echo number_format($fn_a6);?> style="border:0px; text-align: right;" readonly >元。<br />
(其他：<input type="text" size="2" name="fn_a6_1c1" value=<? echo number_format($fn_a6_1c1);?> style="border:0px; text-align: right;" readonly >式<input type="text" size="6" name="fn_a6_1" value=<? echo number_format($fn_a6_1);?> style="border:0px; text-align: right;" readonly >元，設備：<input type="text" size="2" name="fn_a6_2c1" value=<? echo number_format($fn_a6_2c1);?> style="border:0px; text-align: right;" readonly >項<input type="text" size="6" name="fn_a6_2" value=<? echo number_format($fn_a6_2);?> style="border:0px; text-align: right;" readonly >元)。</font>
<br /><br />
<font color=blue><strong>※執行金額：</strong>
<input type="text" size="6" name="ef_1" value="<? echo number_format($ef_1);?>" style="border:0px; text-align: right;" readonly >元。</font>(執行進度依據，由下方資料自動加總)<br />
經費已使用(其他：<input type="text" size="6" name="ef_2" value="<? echo number_format($ef_2);?>"  onChange="change1()">元，設備：<input type="text" size="6" name="ef_3" value="<? echo number_format($ef_3);?>"  onChange="change2()">元)。<br />

...
<table width="100%" border="1" cellspacing="0" cellpadding="0">
  <tr>
    <td height="60" colspan="21" align="center"><strong><font color=blue>教育部101年度推動教育優先區計畫直轄市、縣(市)政府各補助項目執行成果一覽表<br />縣市別：<? echo $city;?>　　　　　　　　補助項目：四、修繕偏遠或離島地區師生宿舍</font></strong></td>
  </tr>
  <tr>

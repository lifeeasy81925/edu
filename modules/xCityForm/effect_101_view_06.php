...
(經常門：<input type="text" size="2" name="fn_a6_1c1" value='<? echo number_format($fn_a6_1c1);?>' style="border:0px; text-align: right;" readonly >式<input type="text" size="6" name="fn_a6_1" value='<? echo number_format($fn_a6_1);?>' style="border:0px; text-align: right;" readonly >元，資本門：<input type="text" size="2" name="fn_a6_2c1" value='<? echo number_format($fn_a6_2c1);?>' style="border:0px; text-align: right;" readonly >項<input type="text" size="6" name="fn_a6_2" value='<? echo number_format($fn_a6_2);?>' style="border:0px; text-align: right;" readonly >元)。</font>
<br /><br />

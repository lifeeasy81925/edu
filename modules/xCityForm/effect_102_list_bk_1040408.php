	...
	*/##############################################################################
	...
	while($row = mysql_fetch_row($result_school))
	{
		...
		{ 
			...
			echo "<td align='left'>";
			echo "核定後執行計畫：".(($effect_a1_1 == "")?"<font color='red'>未上傳</font>":"<a href='".$file_path.$effect_a1_1."' target='_new'>".$effect_a1_1."</a>")."<br />";
			echo "核定後執行經費概算表：".(($effect_a1_2 == "")?"<font color='red'>未上傳</font>":"<a href='".$file_path.$effect_a1_2."' target='_new'>".$effect_a1_2."</a>")."<br />";
			echo "執行成果照片：".(($effect_a1_3 == "")?"<font color='red'>未上傳</font>":"<a href='".$file_path.$effect_a1_3."' target='_new'>".$effect_a1_3."</a>")."<br />";
			echo "</td>";
		...
		{ 
			...
			echo "<td align='left'>";
			echo "核定後執行計畫：".(($effect_a2_1 == "")?"<font color='red'>未上傳</font>":"<a href='".$file_path.$effect_a2_1."' target='_new'>".$effect_a2_1."</a>")."<br />";
			echo "核定後執行經費概算表：".(($effect_a2_2 == "")?"<font color='red'>未上傳</font>":"<a href='".$file_path.$effect_a2_2."' target='_new'>".$effect_a2_2."</a>")."<br />";
			echo "執行成果照片：".(($effect_a2_3 == "")?"<font color='red'>未上傳</font>":"<a href='".$file_path.$effect_a2_3."' target='_new'>".$effect_a2_3."</a>")."<br />";
			echo "</td>";
		...
		{ 
			...
			echo "<td align='left'>";
			echo "核定後執行計畫：".(($effect_a3_1 == "")?"<font color='red'>未上傳</font>":"<a href='".$file_path.$effect_a3_1."' target='_new'>".$effect_a3_1."</a>")."<br />";
			echo "核定後執行經費概算表：".(($effect_a3_2 == "")?"<font color='red'>未上傳</font>":"<a href='".$file_path.$effect_a3_2."' target='_new'>".$effect_a3_2."</a>")."<br />";
			echo "執行成果照片：".(($effect_a3_3 == "")?"<font color='red'>未上傳</font>":"<a href='".$file_path.$effect_a3_3."' target='_new'>".$effect_a3_3."</a>")."<br />";
			echo "</td>";
		...
		{ 
			...
			echo "<td align='left'>";
			echo "核定後執行計畫：".(($effect_a4_1 == "")?"<font color='red'>未上傳</font>":"<a href='".$file_path.$effect_a4_1."' target='_new'>".$effect_a4_1."</a>")."<br />";
			echo "核定後執行經費概算表：".(($effect_a4_2 == "")?"<font color='red'>未上傳</font>":"<a href='".$file_path.$effect_a4_2."' target='_new'>".$effect_a4_2."</a>")."<br />";
			echo "執行成果照片：".(($effect_a4_3 == "")?"<font color='red'>未上傳</font>":"<a href='".$file_path.$effect_a4_3."' target='_new'>".$effect_a4_3."</a>")."<br />";
			echo "</td>";
		...
		{ 
			...
			echo "<td align='left'>";
			echo "核定後執行計畫：".(($effect_a5_1 == "")?"<font color='red'>未上傳</font>":"<a href='".$file_path.$effect_a5_1."' target='_new'>".$effect_a5_1."</a>")."<br />";
			echo "核定後執行經費概算表：".(($effect_a5_2 == "")?"<font color='red'>未上傳</font>":"<a href='".$file_path.$effect_a5_2."' target='_new'>".$effect_a5_2."</a>")."<br />";
			echo "執行成果照片：".(($effect_a5_3 == "")?"<font color='red'>未上傳</font>":"<a href='".$file_path.$effect_a5_3."' target='_new'>".$effect_a5_3."</a>")."<br />";
			echo "</td>";
		...
		{ 
			...
			echo "<td align='left'>";
			echo "核定後執行計畫：".(($effect_a6_1 == "")?"<font color='red'>未上傳</font>":"<a href='".$file_path.$effect_a6_1."' target='_new'>".$effect_a6_1."</a>")."<br />";
			echo "核定後執行經費概算表：".(($effect_a6_2 == "")?"<font color='red'>未上傳</font>":"<a href='".$file_path.$effect_a6_2."' target='_new'>".$effect_a6_2."</a>")."<br />";
			echo "執行成果照片：".(($effect_a6_3 == "")?"<font color='red'>未上傳</font>":"<a href='".$file_path.$effect_a6_3."' target='_new'>".$effect_a6_3."</a>")."<br />";
			echo "</td>";
		...
		{ 
			...
			echo "<td align='left'>";
			echo "核定後執行計畫：".(($effect_a7_1 == "")?"<font color='red'>未上傳</font>":"<a href='".$file_path.$effect_a7_1."' target='_new'>".$effect_a7_1."</a>")."<br />";
			echo "核定後執行經費概算表：".(($effect_a7_2 == "")?"<font color='red'>未上傳</font>":"<a href='".$file_path.$effect_a7_2."' target='_new'>".$effect_a7_2."</a>")."<br />";
			echo "執行成果照片：".(($effect_a7_3 == "")?"<font color='red'>未上傳</font>":"<a href='".$file_path.$effect_a7_3."' target='_new'>".$effect_a7_3."</a>")."<br />";
			echo "</td>";

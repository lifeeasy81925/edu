...
<? 
	//教育部核定金額
	$sql = "select a192, a201, a196, a202, a197, a203, a199, a204, a200 from 102allowance3 where account like '$school'";
...
<p>
<font color=blue>※核定經費：<input type="text" size="6" name="fn_a3" value='<? echo number_format($fn_a3);?>' style="border:0px; text-align: right;" readonly >元。<br />

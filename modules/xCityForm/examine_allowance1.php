...
<? if($examine == '2') echo '縣市審核結果'.'<font face="Arial, Helvetica, sans-serif" color="#FF0000" size="+1">'.number_format($city_examine_2).'</font>元。'?>
審核金額<input type="text" size="5" name="fam_money" value= "<?  if($examine == '1' ) {
																	if($city2 !=0){

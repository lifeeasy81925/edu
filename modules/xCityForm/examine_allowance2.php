...
●申請課後學習輔導<font face="Arial, Helvetica, sans-serif" color="#FF0000" size="+1"><? echo $a;?></font>班，申請經費<font face="Arial, Helvetica, sans-serif" color="#FF0000" size="+1"><? echo number_format($b);?></font>元。<? if($examine == '2') echo '縣市審核結果'.'<font face="Arial, Helvetica, sans-serif" color="#FF0000" size="+1">'.$city_examine_1.'</font>元。'?>
審核金額<input type="text" size="5" name="assist" value= "<? if($examine == '1' ) {
																if($city1 != 0){
																if($b= $city1) echo $city1;
																 ...
																 ?>"/>元。<br>
●寒暑假學習輔導<font face="Arial, Helvetica, sans-serif" color="#FF0000" size="+1"><? echo $c;?></font>班，申請經費<font face="Arial, Helvetica, sans-serif" color="#FF0000" size="+1"><? echo number_format($d);?></font>元。<? if($examine == '2') echo '縣市審核結果'.'<font face="Arial, Helvetica, sans-serif" color="#FF0000" size="+1">'.$city_examine_2.'</font>元。'?>
審核金額<input type="text" size="5" name="holidayassist" value= "<?  
																 if($examine == '1' ) {
																 if($city2 != 0 ){
...
●住校生夜間學習輔導<font face="Arial, Helvetica, sans-serif" color="#FF0000" size="+1"><? echo $e;?></font>班，申請經費<font face="Arial, Helvetica, sans-serif" color="#FF0000" size="+1"><? echo number_format($f);?></font>元。<? if($examine == '2') echo '縣市審核結果'.'<font face="Arial, Helvetica, sans-serif" color="#FF0000" size="+1">'.$city_examine_3.'</font>元。'?>
審核金額<input type="text" size="5" name="nightassist" value= "<?  if($examine == '1' ) {
																	if($city3 != 0){
...
<p>
<? if($examine == '2') echo '•縣市審核意見說明:'.'<font face="Arial, Helvetica, sans-serif" color="#FF0000" size="+1">'.$suggestion1.'</font><br>'?>

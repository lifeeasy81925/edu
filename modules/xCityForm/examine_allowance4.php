...
&nbsp;&nbsp;&nbsp;&nbsp;
●申請經常門<font face="Arial, Helvetica, sans-serif" color="#FF0000" size="+1"><? echo number_format($a);?></font>元，<? if($examine == '2') echo '縣市審核'.'<font face="Arial, Helvetica, sans-serif" color="#FF0000" size="+1">'.$city_examine_1.'</font>元。'?>審核金額<input type="text" size="5" name="money_1" value= "<? 
if($examine == '1' ){
	if($city1 != 0){
		if($a != $city1){
			echo $city1;
...
?>"/>元。<br>
&nbsp;&nbsp;&nbsp;&nbsp;
●申請資本門<font face="Arial, Helvetica, sans-serif" color="#FF0000" size="+1"><? echo number_format($b);?></font>元，<? if($examine == '2') echo '縣市審核'.'<font face="Arial, Helvetica, sans-serif" color="#FF0000" size="+1">'.$city2.'</font>元。'?>審核金額<input type="text" size="5" name="money_2" value= "<? 
if($examine == '1' ){
	if($city2 != 0 ){
		if($b != $city2){
			echo $city2;
...
<? if($examine == '2') echo '縣市審核結果'.'<font face="Arial, Helvetica, sans-serif" color="#FF0000" size="+1">'.number_format($city_total_2).'</font>元。'?><br>
&nbsp;&nbsp;&nbsp;&nbsp;
●申請經常門<font face="Arial, Helvetica, sans-serif" color="#FF0000" size="+1"><? echo number_format($d);?></font>元，<? if($examine == '2') echo '縣市審核結果'.'<font face="Arial, Helvetica, sans-serif" color="#FF0000" size="+1">'.$city_examine_3.'</font>元。'?>審核金額<input type="text" size="5" name="money_3" value= "<? 
if($examine == '1' ){
	if($city1 != 0){
		if($d != $city3){
			echo $city3;
...
?>"/>元。<br>
&nbsp;&nbsp;&nbsp;&nbsp;
●申請資本門<font face="Arial, Helvetica, sans-serif" color="#FF0000" size="+1"><? echo number_format($e);?></font>元，<? if($examine == '2') echo '縣市審核結果'.'<font face="Arial, Helvetica, sans-serif" color="#FF0000" size="+1">'.$city_examine_4.'</font>元。'?>審核金額<input type="text" size="5" name="money_4" value= "<? 
if($examine == '1' ){
	if($city4 != 0 ){
		if($b != $city4){
			echo $city4;
...
&nbsp;&nbsp;
●審核意見說明：<textarea name="other" cols="30" rows="2"><? if($examine == '1'){ echo $suggestion1;}
...
<label>
	<input type="radio" name="allowance4_pass"  value="1" id="1" <? if ($pass1 == '1') echo 'checked';?>/>
    審核通過</label>
<label>
    <input type="radio" name="allowance4_pass"  value="2" id="2" <? if ($pass1 == '2') echo 'checked';?>/>
    審核不通過且列入退件名單</label>
<br><br>

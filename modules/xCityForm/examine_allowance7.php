...
?>
※申請資料與審核：<br>
●搭車人數<font face="Arial, Helvetica, sans-serif" color="#FF0000" size="+1"><? echo $a;?></font>人，申請租車經費<font face="Arial, Helvetica, sans-serif" color="#FF0000" size="+1"><? echo number_format($b);?></font>元。<? if($examine == '2') echo '縣市審核'.'<font face="Arial, Helvetica, sans-serif" color="#FF0000" size="+1">'.number_format($city1).'</font>元。'?>複核金額<input type="text" size="5" name="money_1" value= "<?
if($examine == '1' ){
	if($city1 != 0){
		if($b= $city1){
			echo $city1;
...
?>"/>元。
<p>
●補助交通費<font face="Arial, Helvetica, sans-serif" color="#FF0000" size="+1"><? echo $c;?></font>人，申請經費<font face="Arial, Helvetica, sans-serif" color="#FF0000" size="+1"><? echo number_format($d);?></font>元。<? if($examine == '2') echo '縣市審核'.'<font face="Arial, Helvetica, sans-serif" color="#FF0000" size="+1">'.number_format($city2).'</font>元。'?>複核金額<input type="text" size="5" name="money_2" value= "<?
if($examine == '1' ){
	if($city2 != 0 ){
		if($d!= $city2){
			echo $city2;
...
<p>
●補助交通車<font face="Arial, Helvetica, sans-serif" color="#FF0000" size="+1"><? echo $e;?></font>人座，申請經費<font face="Arial, Helvetica, sans-serif" color="#FF0000" size="+1"><? echo number_format($f);?></font>元。<? if($examine == '2') echo '縣市審核'.'<font face="Arial, Helvetica, sans-serif" color="#FF0000" size="+1">'.number_format($city3).'</font>元。'?>複核金額費<input type="text" size="5" name="money_3" value= "<?  if($examine == '1' ){
	if($city3 != 0){
		if($f != $city3){
			echo $city3;
		}else{

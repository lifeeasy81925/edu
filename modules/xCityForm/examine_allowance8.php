...
?>
※申請資料與審核：<br>
●補助綜合球場申請經費<font face="Arial, Helvetica, sans-serif" color="#FF0000" size="+1"><? echo number_format($d);?></font>元，<font face="Arial, Helvetica, sans-serif" color="#FF0000" size="+1"><? echo $a;?></font>座，<br />　　　　　　　　　　修建金額<font face="Arial, Helvetica, sans-serif" color="#FF0000" size="+1"><? echo number_format($b);?></font>元，設備金額<font face="Arial, Helvetica, sans-serif" color="#FF0000" size="+1"><? echo number_format($c);?></font>元。<p>
<? if($examine == '2') echo '縣市審核結果'.'<font face="Arial, Helvetica, sans-serif" color="#FF0000" size="+1">'.$city1.'</font>元。'?>

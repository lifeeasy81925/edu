...
{
	case "city_1":
		$sql = "update 100city_upload_name set city2_1 = '$filename' where account = '$username' ";
		mysql_query($sql);
		break;
	case "city_2":
		$sql = "update 100city_upload_name set city2_2 = '$filename' where account = '$username' ";
		mysql_query($sql);
		break;
	case "city_3":
		$sql = "update 100city_upload_name set city2_3 = '$filename' where account = '$username' ";
		mysql_query($sql);
		break;
	case "city_4":
		$sql = "update 100city_upload_name set city2_4 = '$filename' where account = '$username' ";
		mysql_query($sql);
		break;
	default:
		$point = "0000";

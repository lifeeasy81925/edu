...
$username = $xoopsUser->getVar('uname');
  ...
  echo $cityman;
?>
補助項目六,發展原住民文化特色及充實設備器材<br>
<? /*
	$sql_element_allowance = "SELECT * FROM 100element_allowance where school like '%$city%' and pointer6='1' and a6_1='0' and a6_2='0';";//符合有補助項目1的國小
    $result_element_allowance= mysql_query($sql_element_allowance);
	while($row = mysql_fetch_row($result_element_allowance)){
		$p1 = $row[6];
	}
	$sql_junior_allowance = "SELECT * FROM 100junior_allowance where school like '%$city%' and pointer6='1' and a6_1='0' and a6_2='0';";//符合有補助項目1的國中
    $result_junior_allowance = mysql_query($sql_junior_allowance);
	while($row = mysql_fetch_row($result_junior_allowance)){
		$p2 = $row[6];
	}*/
	$sql_element = "SELECT * FROM 100element_money where school like '%$city%' and pointer6='1' and a6_1='0' and a6_2='0';";//國小資料
...
<? 	
	$sql_junior = "SELECT * FROM 100junior_money where school like '%$city%' and pointer6='1' and a6_1='0' and a6_2='0';";//國中資料

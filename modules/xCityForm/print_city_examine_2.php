...
<table border="1" align="center" cellpadding="0" cellspacing="0">
  <tr>
    ...
    <td colspan="9" align="left">指標二：低收入戶、隔代教養、單(寄)親家庭、親子年齡差距過大、新移民子女學生比例偏高之學校</td>
  ...
  <tr>
    ...
    <td colspan="5" align="center">目標學生人數</td>
    <td rowspan="2" align="center">佔全校學生比例</td>
    <td colspan="3" align="center">指標界定</td>
    <td rowspan="2" align="center">99學年畢業生人數</td>
    <td rowspan="2" align="center">99 學年第一次學測PR ≦ 25 人數</td>
    <td rowspan="2" align="center">PR ≦ 25 人數佔畢業生人數之比例 (%)</td>
    <td align="center">指標界定</td>
    <td rowspan="2" align="center">99/9/1 - 100/6/30 中輟學生人數</td>
    <td rowspan="2" align="center">100/6/1 在籍學生人數</td>
    ...
    <td rowspan="2" align="center">教師編制總人數 98 + 99 + 100 年</td>
  ...
  <tr>
    ...
    <td align="center">低收入戶子女學生人數</td>
    <td align="center">隔代教養單寄親家庭學生人數</td>
    <td align="center">親子年齡差距45歲以上學生人數</td>
    <td align="center">新移民子女</td>
    <td align="center">目標學生合計人數</td>
    <td align="center">二 ~ (一) 20% 以上</td>
    <td align="center">二 ~ (二) 60 人以上</td>
    <td align="center">併計未達百分比界定標準之指標一原住民學生人數合計達全校學生總數30%以上</td>
    ...
    <td align="center">99 學年</td>
    <td align="center">100 學年</td>
    <td align="center">教師異動總人數 98 + 99 + 100 年=</td>
    <td align="center">98 學年</td>
    <td align="center">99 學年</td>
    <td align="center">100 學年</td>
    <td align="center">代理教師總人數 98 + 99 + 100 年=</td>
    <td align="center">六 - (一)教師流動率平均 ≧ 30%</td>
    <td align="center">六 - (二) 代理教師比例平均 ≧ 30%</td>
  </tr>
<?
// 國小+國中
$sql_school = "select * from edu_school where school like '%$city%'  ORDER BY edu_school.account;";
$result_school = mysql_query($sql_school);
while($row_school = mysql_fetch_row($result_school))
{
	$school_id=$row_school[0];
	$school_city=$row_school[1];
	//$school_name=$row_school[2];
	$school_name = str_replace("市立","",str_replace("縣立","",$row_school[2]));//縮減學校名稱
	$school_class=$row_school[3];
	//echo $school_id.$school_city.$school_name.$school_class;
	
	if($school_class == '1' ){
		
		$basedata="100element_"; ////////////////////////////// 國小
		
		$sql_basedata = "select  *  from ".$basedata."basedata where account like '$school_id';";
		$result_basedata = mysql_query($sql_basedata);
		while($row_basedata = mysql_fetch_row($result_basedata)){
			$school_allstudent = $row_basedata[2];//學生總數
			$school_classes = $row_basedata[3];//學校班級數
			$school_area = $row_basedata[11];//學校地區
			$area_0 = ' ';
			$area_1 = ' ';
			$area_2 = ' ';
			$area_3 = ' ';
			...
			echo "<td>"."<div align='left'>".$school_name."</td>";//學校名稱
			$sum_e ++;
		...
		$sql_basedata = "select  *  from ".$basedata."point6 where account like '$school_id';";
		$result_basedata = mysql_query($sql_basedata);
		while($row_basedata = mysql_fetch_row($result_basedata)){
			$t99 = $row_basedata[1];//99年編制教師數
			$t98 = $row_basedata[2];//98年編制教師數
			$t97 = $row_basedata[3];//97年編制教師數
			echo "<td>"."<div align='right'>".$t97."</td>";//97年編制教師數
			$sum_e_3 = $sum_e_3 + $t97;
			echo "<td>"."<div align='right'>".$t98."</td>";//98年編制教師數
			$sum_e_4 = $sum_e_4 + $t98;
		...
		$sql_basedata = "select  *  from ".$basedata."point12 where account like '$school_id';";
		$result_basedata = mysql_query($sql_basedata);
		while($row_basedata = mysql_fetch_row($result_basedata)){
			echo "<td>"."<div align='right'>".$row_basedata[1]."</td>";//原住民學生數
			$sum_e_10 = $sum_e_10 + $row_basedata[1];
			echo "<td>"."<div align='right'>".number_format($row_basedata[1]/$school_allstudent*100,2)."</td>";//原住民學生數百分比(%)
			$sum_e_11 = '';
		}
		
		$sql_basedata = "select  *  from ".$basedata."point where account like '$school_id';";
		$result_basedata = mysql_query($sql_basedata);
		while($row_basedata = mysql_fetch_row($result_basedata)){
			$p1_1=' ';
			$p1_2=' ';
			...
			$p6_1=' ';
			$p6_2=' ';
			if($row_basedata[1]==1)$p1_1="1";
			if($row_basedata[2]==1)$p1_2="1";
			if($row_basedata[3]==1)$p1_3="1";
			if($row_basedata[4]==1)$p1_4="1";
			if($row_basedata[5]==1)$p2_1="1";
			if($row_basedata[6]==1)$p2_2="1";
			if($row_basedata[10]==1)$p2_3="1";
			if($row_basedata[7]==1)$p3="1";
			if($row_basedata[8]==1)$p4="1";
			if($row_basedata[11]==1)$p5_1="1";
			if($row_basedata[13]==1)$p5_2="1";
			if($row_basedata[14]==1)$p5_3="1";
			if($row_basedata[9]==1)$p6_1="1";
			if($row_basedata[12]==1)$p6_2="1";
		...
		$result_basedata = mysql_query($sql_basedata);
		while($row_basedata = mysql_fetch_row($result_basedata)){
			echo "<td>"."<div align='right'>".$row_basedata[2]."</td>";//低收入戶
			$sum_e_16 = $sum_e_16 + $row_basedata[2];
			echo "<td>"."<div align='right'>".(($row_basedata[3]*1)+($row_basedata[8]*1))."</td>";//隔代教養+單寄親家庭
			$sum_e_17 = $sum_e_17 + (($row_basedata[3]*1)+($row_basedata[8]*1));
			echo "<td>"."<div align='right'>".$row_basedata[4]."</td>";//親子年齡差距45歲以上
			$sum_e_18 = $sum_e_18 + $row_basedata[4];
			echo "<td>"."<div align='right'>".$row_basedata[5]."</td>";//新移民子女
			$sum_e_19 = $sum_e_19 + $row_basedata[5];
			echo "<td>"."<div align='right'>".$row_basedata[6]."</td>";//目標學生合計人數
			$sum_e_20 = $sum_e_20 + $row_basedata[6];
			echo "<td>"."<div align='right'>".number_format($row_basedata[6]/$school_allstudent*100,2)."</td>";//目標學生佔全校學生比例
			$sum_e_21 = '';
		...
		$sql_basedata = "select  *  from ".$basedata."point345 where account like '$school_id';";
		$result_basedata = mysql_query($sql_basedata);
		while($row_basedata = mysql_fetch_row($result_basedata)){
			echo "<td>"."<div align='right'>".$row_basedata[1]."</td>";//國中前學年度畢業生人數
			$sum_e_25 = $sum_e_25 + $row_basedata[1];
			echo "<td>"."<div align='right'>".$row_basedata[2]."</td>";//國中第一次學測PR<=25人數
			$sum_e_26 = $sum_e_26 + $row_basedata[2];
			echo "<td>"."<div align='right'>".number_format($row_basedata[2]/$row_basedata[1]*100,2)."</td>";//國中第一次學測PR<=25人數比例
			$sum_e_27 = '';
			echo "<td>"."<div align='center'>".$p3."</td>";//指標3
			if($p3 > 0){$sum_e_28 ++;};
			echo "<td>"."<div align='right'>".$row_basedata[3]."</td>";//中輟學生人數 (指標4)
			$sum_e_29 = $sum_e_29 + $row_basedata[3];
			echo "<td>"."<div align='right'>".$row_basedata[11]."</td>";//在籍學生人數 (指標4)
			$sum_e_30 = $sum_e_30 + $row_basedata[11];
			echo "<td>"."<div align='right'>".number_format($row_basedata[3]/$row_basedata[11]*100,2)."</td>";//中輟學生佔在籍學生人數比例
			$sum_e_31 = '';
			echo "<td>"."<div align='center'>".$p4."</td>";//指標4
			if($p4 > 0){$sum_e_32 ++;};
			//echo "<td colspan=4>"."<div align='right'>".$row_basedata[4]."</td>";//離島 (指標5)
			echo "<td>"."<div align='right'>".$row_basedata[4]."</td>";//離島 (指標5)
			if($row_basedata[4] > 0){$sum_e_33 ++;};
			echo "<td>"."<div align='right'>".$row_basedata[5]."</td>";//無公共交通工具 (指標5)
			if($row_basedata[5] > 0){$sum_e_34 ++;};
			echo "<td>"."<div align='right'>".$row_basedata[6]."</td>";//學校距站牌5km以上 (指標5)
			if($row_basedata[6] > 0){$sum_e_35 ++;};
			echo "<td>"."<div align='right'>".$row_basedata[7]."</td>";//社區5km無公車 (指標5)
			if($row_basedata[7] > 0){$sum_e_36 ++;};
			echo "<td>"."<div align='right'>".$row_basedata[8]."</td>";//每天少於4班 (指標5)
			if($row_basedata[8] > 0){$sum_e_37 ++;};
			echo "<td>"."<div align='right'>".$row_basedata[9]."</td>";//因裁併校需交通車 (指標5)
			if($row_basedata[9] > 0){$sum_e_38 ++;};
		}

		$sql_basedata = "select  *  from ".$basedata."point6 where account like '$school_id';";
		$result_basedata = mysql_query($sql_basedata);
		while($row_basedata = mysql_fetch_row($result_basedata)){
			$t_sum = $row_basedata[1]+$row_basedata[2]+$row_basedata[3];//97+98+99年編制教師數
			echo "<td>"."<div align='right'>".$t_sum."</td>";//97+98+99年編制教師數
			$sum_e_39 = $sum_e_39 + $t_sum;
			echo "<td>"."<div align='right'>".($row_basedata[6]+$row_basedata[9])."</td>";//97教師異動人數
			$sum_e_40 = $sum_e_40 + ($row_basedata[6]+$row_basedata[9]);
			echo "<td>"."<div align='right'>".($row_basedata[5]+$row_basedata[8])."</td>";//98教師異動人數
			$sum_e_41 = $sum_e_41 + ($row_basedata[5]+$row_basedata[8]);
			echo "<td>"."<div align='right'>".($row_basedata[4]+$row_basedata[7])."</td>";//99教師異動人數
			$sum_e_42 = $sum_e_42 + ($row_basedata[4]+$row_basedata[7]);
			$t_sum_1 = $row_basedata[6]+$row_basedata[9]+$row_basedata[5]+$row_basedata[8]+$row_basedata[4]+$row_basedata[7];//異動總人數
			...
			$sum_e_44 = '';
			echo "<td>"."<div align='right'>".($row_basedata[12]+$row_basedata[9])."</td>";//97教師代理人數
			$sum_e_45 = $sum_e_45 + ($row_basedata[12]+$row_basedata[9]);
			echo "<td>"."<div align='right'>".($row_basedata[11]+$row_basedata[8])."</td>";//98教師代理人數
			$sum_e_46 = $sum_e_46 + ($row_basedata[11]+$row_basedata[8]);
			echo "<td>"."<div align='right'>".($row_basedata[10]+$row_basedata[7])."</td>";//99教師代理人數
			$sum_e_47 = $sum_e_47 + ($row_basedata[10]+$row_basedata[7]);
			$t_sum_2 = $row_basedata[12]+$row_basedata[9]+$row_basedata[11]+$row_basedata[8]+$row_basedata[10]+$row_basedata[7];//異動總人數
			...
			if($p6_2 > 0){$sum_e_51 ++;};
			$p_sum_school = $p1_1+$p1_2+$p1_3+$p1_4+$p2_1+$p2_2+$p2_3+$p3+$p4+$p5_1+$p5_2+$p5_3+$p6_1+$p6_2;
		...
		//if ($show_j == 0) {echo "<tr><td colspan=54>以下為國中資料</tr></td>";};
		//$show_j ++;
	
		$basedata="100junior_"; ////////////////////////////////// 國中
		...
		while($row_basedata = mysql_fetch_row($result_basedata)){
			$school_allstudent = $row_basedata[2];//學生總數
			$school_classes = $row_basedata[3];//學校班級數
			$school_area = $row_basedata[8];//學校地區
			$area_0 = ' ';
			$area_1 = ' ';
			$area_2 = ' ';
			$area_3 = ' ';
		...
		while($row_basedata = mysql_fetch_row($result_basedata)){
			echo "<td>"."<div align='right'>".$row_basedata[1]."</td>";//原住民學生數
			$sum_j_10 = $sum_j_10 + $row_basedata[1];
			echo "<td>"."<div align='right'>".number_format($row_basedata[1]/$school_allstudent*100,2)."</td>";//原住民學生數百分比(%)
			$sum_j_11 = '';
		}
		...
		while($row_basedata = mysql_fetch_row($result_basedata)){
			echo "<td>"."<div align='right'>".$row_basedata[2]."</td>";//低收入戶
			$sum_j_16 = $sum_j_16 + $row_basedata[2];
			echo "<td>"."<div align='right'>".(($row_basedata[3]*1)+($row_basedata[8]*1))."</td>";//隔代教養+單寄親家庭
			$sum_j_17 = $sum_j_17 + (($row_basedata[3]*1)+($row_basedata[8]*1));
			echo "<td>"."<div align='right'>".$row_basedata[4]."</td>";//親子年齡差距45歲以上
			$sum_j_18 = $sum_j_18 + $row_basedata[4];
			echo "<td>"."<div align='right'>".$row_basedata[5]."</td>";//新移民子女
			$sum_j_19 = $sum_j_19 + $row_basedata[5];
			echo "<td>"."<div align='right'>".$row_basedata[6]."</td>";//目標學生合計人數
			$sum_j_20 = $sum_j_20 + $row_basedata[6];
			echo "<td>"."<div align='right'>".number_format($row_basedata[6]/$school_allstudent*100,2)."</td>";//目標學生佔全校學生比例
			$sum_j_21 = '';
			echo "<td>"."<div align='center'>".$p2_1."</td>";//指標2-1
			if($p2_1 > 0){$sum_j_22 ++;};
		...
		while($row_basedata = mysql_fetch_row($result_basedata)){
			echo "<td>"."<div align='right'>".$row_basedata[1]."</td>";//國中前學年度畢業生人數
			$sum_j_25 = $sum_j_25 + $row_basedata[1];
			echo "<td>"."<div align='right'>".$row_basedata[2]."</td>";//國中第一次學測PR<=25人數
			$sum_j_26 = $sum_j_26 + $row_basedata[2];
			echo "<td>"."<div align='right'>".number_format($row_basedata[2]/$row_basedata[1]*100,2)."</td>";//國中第一次學測PR<=25人數比例
			$sum_j_27 = '';
			echo "<td>"."<div align='center'>".$p3."</td>";//指標3
			if($p3 > 0){$sum_j_28 ++;};
			echo "<td>"."<div align='right'>".$row_basedata[3]."</td>";//中輟學生人數 (指標4)
			$sum_j_29 = $sum_j_29 + $row_basedata[3];
			echo "<td>"."<div align='right'>".$row_basedata[11]."</td>";//在籍學生人數 (指標4)
			$sum_j_30 = $sum_j_30 + $row_basedata[11];
			echo "<td>"."<div align='right'>".number_format($row_basedata[3]/$row_basedata[11]*100,2)."</td>";//中輟學生佔在籍學生人數比例
			$sum_j_31 = '';
			echo "<td>"."<div align='center'>".$p4."</td>";//指標4
			if($p4 > 0){$sum_j_32 ++;};
			//echo "<td colspan=4>"."<div align='right'>".$row_basedata[4]."</td>";//離島 (指標5)
			echo "<td>"."<div align='right'>".$row_basedata[4]."</td>";//離島 (指標5)
			if($row_basedata[4] > 0){$sum_j_33 ++;};
			echo "<td>"."<div align='right'>".$row_basedata[5]."</td>";//無公共交通工具 (指標5)
			if($row_basedata[5] > 0){$sum_j_34 ++;};
			echo "<td>"."<div align='right'>".$row_basedata[6]."</td>";//學校距站牌5km以上 (指標5)
			if($row_basedata[6] > 0){$sum_j_35 ++;};
			echo "<td>"."<div align='right'>".$row_basedata[7]."</td>";//社區5km無公車 (指標5)
			if($row_basedata[7] > 0){$sum_j_36 ++;};
			echo "<td>"."<div align='right'>".$row_basedata[8]."</td>";//每天少於4班 (指標5)
			if($row_basedata[8] > 0){$sum_j_37 ++;};
			echo "<td>"."<div align='right'>".$row_basedata[9]."</td>";//因裁併校需交通車 (指標5)
			if($row_basedata[9] > 0){$sum_j_38 ++;};
		}
		...
		while($row_basedata = mysql_fetch_row($result_basedata)){
			...
			echo "<td>"."<div align='right'>".($row_basedata[6]+$row_basedata[9])."</td>";//97教師異動人數
			$sum_j_40 = $sum_j_40 + ($row_basedata[6]+$row_basedata[9]);
			echo "<td>"."<div align='right'>".($row_basedata[5]+$row_basedata[8])."</td>";//98教師異動人數
			$sum_j_41 = $sum_j_41 + ($row_basedata[5]+$row_basedata[8]);
			echo "<td>"."<div align='right'>".($row_basedata[4]+$row_basedata[7])."</td>";//99教師異動人數
			$sum_j_42 = $sum_j_42 + ($row_basedata[4]+$row_basedata[7]);
			$t_sum_1 = $row_basedata[6]+$row_basedata[9]+$row_basedata[5]+$row_basedata[8]+$row_basedata[4]+$row_basedata[7];//異動總人數
			echo "<td>"."<div align='right'>".$t_sum_1."</td>";//最近三年教師流動人數
			...
			$sum_j_44 = '';
			echo "<td>"."<div align='right'>".($row_basedata[12]+$row_basedata[9])."</td>";//97教師代理人數
			$sum_j_45 = $sum_j_45 + ($row_basedata[12]+$row_basedata[9]);
			echo "<td>"."<div align='right'>".($row_basedata[11]+$row_basedata[8])."</td>";//98教師代理人數
			$sum_j_46 = $sum_j_46 + ($row_basedata[11]+$row_basedata[8]);
			echo "<td>"."<div align='right'>".($row_basedata[10]+$row_basedata[7])."</td>";//99教師代理人數
			$sum_j_47 = $sum_j_47 + ($row_basedata[10]+$row_basedata[7]);
			$t_sum_2 = $row_basedata[12]+$row_basedata[9]+$row_basedata[11]+$row_basedata[8]+$row_basedata[10]+$row_basedata[7];//異動總人數
			echo "<td>"."<div align='right'>".$t_sum_2."</td>";//最近三年教師代理人數

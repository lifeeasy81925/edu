...
<table border="1" cellpadding="0" cellspacing="0">
	<tr>
		...
		<td rowspan="3" align="center">核准金額</td>
	</tr>
	<tr>
  ...
  <?
  //補助金額-國小			
$sql_element = "select  *  from 100element_examine_education where school like '%$city%' order by 100element_examine_education.account;";
...
while($row = mysql_fetch_row($result_element)){
	...
	while($a3row = mysql_fetch_row($result_a3)){
		$a3_1_1 = $a3row[15];	//教育部審核特色一經常門金額
		$a3_1_2 = $a3row[16];	//教育部審核特色一資本門金額
		$a3_2_1 = $a3row[17];	//教育部審核特色二經常門金額
		$a3_2_2 = $a3row[18];	//教育部審核特色二資本門金額
	}
	$school_id=$row[0];
	$a1_1=$row[1];
	$a1_2=$row[2];
...
<?
//補助金額-國中			
$sql_junior = "select  *  from 100junior_examine_education where school like '%$city%' order by 100junior_examine_education.account;";

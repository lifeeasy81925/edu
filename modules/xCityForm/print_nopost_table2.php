...
$result_element= mysql_query('select edu_school.*, 100element_point12.abcd ,100element_point12.abcde from edu_school INNER JOIN 100element_point12 ON edu_school.account=100element_point12.account ;');
...
<?      
    $result_junior= mysql_query('select edu_school.*,100junior_point12.abcd ,100element_point12.abcde from edu_school INNER JOIN 100junior_point12 ON edu_school.account=100junior_point12.account ;');

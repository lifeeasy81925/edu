...
$result_element= mysql_query('select edu_school.*, 100element_point345.enrollment  from edu_school INNER JOIN 100element_point345 ON edu_school.account=100element_point345.account ;');
...
if($row[1] == "$city"){
		...
		echo "</td>";
		echo "<td>";
		 	echo "<a href="."print_point4.php?id="."$row[0]"." target="."_self".">"."檢視"."</a>";//指標四審核
		echo "</td>";
  echo "</tr>";
 }
 }
...
<?      
    $result_junior= mysql_query('select edu_school.*,100junior_point345.enrollment from edu_school INNER JOIN 100junior_point345 ON edu_school.account=100junior_point345.account ;');

...
<p>
•上一個學年度中途輟學學生數
    <font face="Arial, Helvetica, sans-serif" color="#FF0000" size="+1"><? echo $a; ?></font> 人<br>
...
<input type="hidden" name="point4"  value="<? echo 'point4'; ?>">
<label>
	<input type="radio" name="point4_pass"  value="1" id="1" <? if ($pass == '1') echo 'checked';?>/>
    審核通過</label>
<label>
    <input type="radio" name="point4_pass"  value="2" id="2" <? if ($pass == '2') echo 'checked';?>/>
    審核不通過且列入退件名單</label>

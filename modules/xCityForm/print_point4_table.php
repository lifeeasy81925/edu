...
//  $result_element = mysql_query($sql_element);
	...
	if($row[1] == "$city"){
		...
		echo "<tr>";
		echo "<td>";
			echo "<a href="."print_point4.php?id="."$row[0]"." target="."_self".">"."$row[0]"."</a>";//學校代碼
		echo "</td>";
		echo "<td>";
      		echo "$row[2]";//學校名稱
		echo "</td>";
		...
		echo "<td>";
		if($row[23] == '0'){
		 	echo "<a href="."print_point4.php?id="."$row[0]"." target="."_self".">"."待審核"."</a>";//指標審核
			}
		elseif($row[23] == '1'){
			echo "<a href="."print_point4.php?id="."$row[0]"." target="."_self".">"."已審畢"."</a>";//指標審核
			echo '<img src='.'"../../images/ok1.jpg"'.' width="18"'.' height="18"'.'>';
		}elseif($row[23] == '2'){
			echo "<a href="."print_point4.php?id="."$row[0]"." target="."_self".">"."已退件"."</a>";//指標審核
			//echo '<img src='.'"../../images/ok1.jpg"'.' width="18"'.' height="18"'.'>';
		}
		echo "</td>";
  echo "</tr>";

...
//  $result_element = mysql_query($sql_element);
	while($row = mysql_fetch_row($result_element))
        {
		if($row[1] == "$city"){
		if($row[16] == "$point" || $row[18] == "$point" || $row[19] == "$point" ){
		echo "<tr>";
		echo "<td>";
			echo "<a href="."print_point5.php?id="."$row[0]"." target="."_self".">"."$row[0]"."</a>";//學校代碼
		echo "</td>";
		echo "<td>";
      		echo "$row[2]";//學校名稱
		echo "</td>";
		echo "<td>";
		if($row[16] == '0' && $row[18] == '0' && $row[19] == '0' ){
		 	echo "未符合指標五";
			}
			else{
			echo "符合指標五";//條件符合
		...
		echo "<td>";
		if($row[24] == '0'){
		 	echo "<a href="."print_point5.php?id="."$row[0]"." target="."_self".">"."待審核"."</a>";//指標審核
		}elseif($row[24] == '1'){
			echo "<a href="."print_point5.php?id="."$row[0]"." target="."_self".">"."已審畢"."</a>";//指標審核
			echo '<img src='.'"../../images/ok1.jpg"'.' width="18"'.' height="18"'.'>';
		}elseif($row[24] == '2'){
			echo "<a href="."print_point5.php?id="."$row[0]"." target="."_self".">"."已退件"."</a>";//指標審核
			//echo '<img src='.'"../../images/ok1.jpg"'.' width="18"'.' height="18"'.'>';
		}
		echo "</td>";
  echo "</tr>";

...
while($row = mysql_fetch_row($result_school)){
	...
	$s1=array("","經常門","資本門");
	$s2=array("","鐘點費","器材購置","器材維護","服裝","道具","硬體設備","教材","其他");
}

//補助項目資料	
$sql_allowance = "select * from 102allowance2 where account like '$id'";
...
//第二個經費表
$sql = "select * from 102allowance2_2 where account like '$id' ";
...
<form name="form" method="post" action="102_examine_allowance2_finish.php?id=<? echo $id;?>">
...
<br>
<b>※申請資料與審核：</b><br />
●學校班級數為<font face="Arial, Helvetica, sans-serif" color="#FF0000" size="+1"><? echo $classes; ?></font>班，最多可以申請<font face="Arial, Helvetica, sans-serif" color="#FF0000" size="+1"><? 
  if($classes < '13' ){
	  echo "1";
	}
	else{
...
<? if($examine == '2') echo '縣市初審<font face="Arial, Helvetica, sans-serif" color="#FF0000" size="+1">'.number_format($a132).'</font>元。'?>
<font color=blue>審核金額：<input type="text" size="5" name="a192" value= "<? if($a192 =='') echo $a135+$a138; else echo $a192;?>" style="border:0px; text-align: right;" readonly >元。</font></b>
<p>
...
縣市初審：<font face="Arial, Helvetica, sans-serif" color="#FF0000" size="+1"><? echo number_format($a135);?></font>元 
(經常門<font face="Arial, Helvetica, sans-serif" color="#FF0000" size="+1"><? echo number_format($a136);?></font>元，資本門<font face="Arial, Helvetica, sans-serif" color="#FF0000" size="+1"><? echo number_format($a137);?></font>元)<br />
<b><font color=blue>複審金額：<input type="text" size="5" name="a195" onChange="change1()" value="<? if($a195 =='') echo $a135; else echo $a195;?>" style="border:0px; text-align: right;" readonly >元 (經常門<input type="text" size="5" name="a196" onChange="change1_1()" value="<? if($a196 =='') echo $a136; else echo $a196;?>" style="border:0px; text-align: right;" readonly >元，資本門<input type="text" size="5" name="a197" onChange="change1_2()" value="<? if($a197 =='') echo $a137; else echo $a197;?>" style="border:0px; text-align: right;" readonly >
元)</font></b>
<table width="100%" border="0" cellspacing="0" cellpadding="0" bgcolor="#FFFFCC" style="font-size:12px;">
  ...
  <tr>
    ...
    <td align="left"><input type="text" size="4" name="a182" value="<? if($a182 =='') echo ''; else echo $a182;?>" style="border:0px; text-align: left;" readonly ></td>
  ...
  <tr>
    ...
    <td align="left" valign="middle"><input type="checkbox" name="a122" onclick="return false;" value="1" <? if($a122 =='1') echo 'checked';?>/>申請雜支</td>
    ...
    <td align="left"><input type="text" size="4" name="a186" value="<? if($a186 =='') echo ''; else echo $a186;?>" style="border:0px; text-align: left;" readonly ></td>
...
縣市初審：<font face="Arial, Helvetica, sans-serif" color="#FF0000" size="+1"><? echo number_format($a138);?></font>元 
(經常門<font face="Arial, Helvetica, sans-serif" color="#FF0000" size="+1"><? echo number_format($a139);?></font>元，資本門<font face="Arial, Helvetica, sans-serif" color="#FF0000" size="+1"><? echo number_format($a140);?></font>元)<br />
<b><font color=blue>複審金額：<input type="text" size="5" name="a198" onChange="change2()" value= "<? if($a198=='') echo $a138; else echo $a198;?>" style="border:0px; text-align: right;" readonly >元 (經常門<input type="text" size="5" name="a199" onChange="change2_1()" value= "<? if($a199=='') echo $a139; else echo $a199;?>" style="border:0px; text-align: right;" readonly >元，資本門<input type="text" size="5" name="a200" onChange="change2_2()" value= "<? if($a200=='') echo $a140; else echo $a200;?>" style="border:0px; text-align: right;" readonly >元)</font></b>
<? if($classes < '13') echo "<!--"; ?>
<table width="100%" border="0" cellspacing="0" cellpadding="0" bgcolor="#FFFFCC" style="font-size:12px;">
  <tr>
  ...
  <tr>
    ...
    <td align="left"><input type="text" size="4" name="b150" value="<? if($b150 =='') echo ''; else echo $b150;?>" style="border:0px; text-align: left;" readonly ></td>
  ...
  <tr>
    ...
    <td align="left"><input type="text" size="4" name="b154" value="<? if($b154 =='') echo ''; else echo $b154;?>" style="border:0px; text-align: left;" readonly ></td>
  ...
  <tr>
    ...
    <td align="left"><input type="text" size="4" name="b158" value="<? if($b158 =='') echo ''; else echo $b158;?>" style="border:0px; text-align: left;" readonly ></td>
  ...
  <tr>
    ...
    <td align="left"><input type="text" size="4" name="b162" value="<? if($b162 =='') echo ''; else echo $b162;?>" style="border:0px; text-align: left;" readonly ></td>
  ...
  <tr>
    ...
    <td align="left"><input type="text" size="4" name="b166" value="<? if($b166 =='') echo ''; else echo $b166;?>" style="border:0px; text-align: left;" readonly ></td>
  ...
  <tr>
    ...
    <td align="left"><input type="text" size="4" name="b170" value="<? if($b170 =='') echo ''; else echo $b170;?>" style="border:0px; text-align: left;" readonly ></td>
  ...
  <tr>
    ...
    <td align="left"><input type="text" size="4" name="b174" value="<? if($b174 =='') echo ''; else echo $b174;?>" style="border:0px; text-align: left;" readonly ></td>
  ...
  <tr>
    ...
    <td align="left"><input type="text" size="4" name="b178" value="<? if($b178 =='') echo ''; else echo $b178;?>" style="border:0px; text-align: left;" readonly ></td>
  ...
  <tr>
    ...
    <td align="left"><input type="text" size="4" name="b182" value="<? if($b182 =='') echo ''; else echo $b182;?>" style="border:0px; text-align: left;" readonly ></td>
  ...
  <tr>
    ...
    <td align="left" valign="middle"><input type="checkbox" name="b122" onclick="return false;" value="1" <? if($b122 =='1') echo 'checked';?>/>申請雜支</td>
    ...
    <td align="left"><input type="text" size="4" name="b186" value="<? if($b186 =='') echo ''; else echo $b186;?>" style="border:0px; text-align: left;" readonly ></td>
...
//列出狀態訊息
echo "<b>※應上傳檔案：</b><br>";
if ($a2_1 == ''){echo "‧實施計畫：<font color=red>未上傳</font>";} else {echo '‧實施計畫：<font color=blue>已上傳</font>，檔名：'.'<a href="../xSchoolForm/upload/102/'.$school.'/'.$a2_1.'" style="text-decoration:none" target="_new">'.$a2_1.'</a>';}
?>
<? if($p149=="") echo "<!--"; ?>
<br /><? if ($p2 == ''){echo "‧目標學生名冊：<font color=red>未上傳</font>";} else {echo '‧目標學生名冊：<font color=blue>已上傳</font>，檔名：'.'<a href="../xSchoolForm/upload/102/'.$school.'/'.$p2.'" style="text-decoration:none" target="_new">'.$p2.'</a>';}?>
<br />
<? echo "‧警示原因_目標學生：<font color=red>".$p191."</font><br>"; ?>
<? echo "‧學校說明_目標學生：<font color=red>".$p149."</font><br>"; ?>
<? if($p149=="") echo "-->"; ?>
<? if($p147=="") echo "<!--"; ?><br />
<? echo "‧警示原因_學校資料：<font color=red>".$p189."</font><br>"; ?>
<? echo "‧學校說明_學校資料：<font color=red>".$p147."</font><br>"; ?>
<? if($p147=="") echo "-->"; ?>
<? if($p148=="") echo "<!--"; ?><br />
<? echo "‧警示原因_教師資料：<font color=red>".$p190."</font><br>"; ?>
<? echo "‧學校說明_教師資料：<font color=red>".$p148."</font><br>"; ?>
<? if($p148=="") echo "-->"; ?>
<p>
<b>※審核結果：</b>
<input type="hidden" name="sid"  value="<? echo $school; ?>" >
<input type="hidden" name="allowance"  value="<? echo "allowance2"; ?>" >
<label>
...
function numsum() { 
	...
	f.a192.value = (f.a195.value==""?0:parseFloat(f.a195.value)) + (f.a198.value==""?0:parseFloat(f.a198.value)); 
}
function numsum1() { 
	var f = document.forms[0]; 
...
<script language="JavaScript">
	...
	function count_all(group_ab)
	{
		...
		//項次1不是下拉是選單，另外算
		if(document.getElementsByName(group_ab + "210")[0].value != "")
		{
			if(document.getElementsByName(group_ab + "030")[0].value == "經常門")
			{
				money_1 += parseInt(document.getElementsByName(group_ab + "210")[0].value);
			}			
			else
			{
				money_2 += parseInt(document.getElementsByName(group_ab + "210")[0].value);
			}
			
			total += parseInt(document.getElementsByName(group_ab + "210")[0].value);
		}
		...
		if(document.getElementsByName(group_ab + "246")[0].value != "")
		{
			money_1 += parseInt(document.getElementsByName(group_ab + "246")[0].value);
			total += parseInt(document.getElementsByName(group_ab + "246")[0].value);
		}
		...
		if (document.getElementsByName("a195")[0].value != "")
			document.getElementsByName("a192")[0].value = parseInt(document.getElementsByName("a195")[0].value);
		
		if (document.getElementsByName("a198")[0].value != "")
			document.getElementsByName("a192")[0].value = parseInt(document.getElementsByName("a192")[0].value) + parseInt(document.getElementsByName("a198")[0].value);

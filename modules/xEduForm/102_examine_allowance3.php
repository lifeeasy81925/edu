...
//補助項目資料	
$sql_allowance = "select * from 102allowance3 where account like '$id'";
...
while($row = mysql_fetch_row($result_allowance)){
	...
	$a017 = $row[17]; //學生宿舍經常忙
	$a018 = $row[18]; //學生宿舍資本門
	$a019 = $row[19]; //教師宿舍經常門項
	$a020 = $row[20]; //教師宿舍資本門式
	$a021 = $row[21]; //學生宿舍經常門項
	$a022 = $row[22]; //學生宿舍資本門式
	$a023 = $row[23]; //今年教師住宿人數
	$a024 = $row[24]; //去年教師住宿人數
	$a025 = $row[25]; //前年教師住宿人數
	$a026 = $row[26]; //今年學生住宿人數
	$a027 = $row[27]; //去年學生住宿人數
	$a028 = $row[28]; //前年學生住宿人數
	$a029 = $row[29]; //近五年是否補助
	...
	$a135 = $row[135];	//教師宿舍合計
	$a136 = $row[136];	//教師宿舍經常門
	$a137 = $row[137];	//教師宿舍資本門
	$a138 = $row[138];	//學生宿舍合計
	$a139 = $row[139];	//學生宿舍經常門
	$a140 = $row[140];	//學生宿舍資本門
	$a141 = $row[141];	//教師宿舍經常門項
	$a142 = $row[142];	//教師宿舍資本門式
	$a143 = $row[143];	//學生宿舍經常門項
	$a144 = $row[144];	//學生宿舍資本門式
	$a145 = $row[145];	//
	$a146 = $row[146];	//
	$a147 = $row[147];	//
	$a148 = $row[148];	//
	...
	$a247=$a186-$a246;	//刪減金額計算
}

//第二個經費表
$sql = "select * from 102allowance3_2 where account like '$id' ";
...
while($row = mysql_fetch_row($result)){
	...
	if($b150=='') $b150=$b036; //初審金額內定為學校申請金額
	if($b154=='') $b154=$b046; //初審金額內定為學校申請金額
	if($b158=='') $b158=$b056; //初審金額內定為學校申請金額
	if($b162=='') $b162=$b066; //初審金額內定為學校申請金額
	if($b166=='') $b166=$b076; //初審金額內定為學校申請金額
	if($b170=='') $b170=$b086; //初審金額內定為學校申請金額
	if($b174=='') $b174=$b096; //初審金額內定為學校申請金額
	if($b178=='') $b178=$b106; //初審金額內定為學校申請金額
	if($b182=='') $b182=$b116; //初審金額內定為學校申請金額
	if($b186=='') $b186=$b126; //初審金額內定為學校申請金額
	
	$b151=intval($b036)-intval($b150);	//刪減金額計算
	$b155=$b046-$b154;	//刪減金額計算
	$b159=$b056-$b158;	//刪減金額計算
	$b163=$b066-$b162;	//刪減金額計算
	$b167=$b076-$b166;	//刪減金額計算
	$b171=$b086-$b170;	//刪減金額計算
	$b175=$b096-$b174;	//刪減金額計算
	$b179=$b106-$b178;	//刪減金額計算
	$b183=$b116-$b182;	//刪減金額計算
	$b187=$b126-$b186;	//刪減金額計算
	
	//教育部資料
	$b190 = $row[190];	//本項目教育部審核狀態
	$b191 = $row[191];	//本項目教育部審核意見
	
	$b192 = $row[192];	//本項目教育部複審總額
	$b193 = $row[193];	//本項目教育部複審經常門
	$b194 = $row[194];	//本項目教育部複審資本門
	...
	if($b210=='') $b210=$b150; //複審金額內定為初審金額
	if($b214=='') $b214=$b154; //複審金額內定為初審金額
	if($b218=='') $b218=$b158; //複審金額內定為初審金額
	if($b222=='') $b222=$b162; //複審金額內定為初審金額
	if($b226=='') $b226=$b166; //複審金額內定為初審金額
	if($b230=='') $b230=$b170; //複審金額內定為初審金額
	if($b234=='') $b234=$b174; //複審金額內定為初審金額
	if($b238=='') $b238=$b178; //複審金額內定為初審金額
	if($b242=='') $b242=$b182; //複審金額內定為初審金額
	if($b246=='') $b246=$b186; //複審金額內定為初審金額
	
	$b211=$b150-$b210;	//刪減金額計算
	$b215=$b154-$b214;	//刪減金額計算
	$b219=$b158-$b218;	//刪減金額計算
	$b223=$b162-$b222;	//刪減金額計算
	$b227=$b166-$b226;	//刪減金額計算
	$b231=$b170-$b230;	//刪減金額計算
	$b235=$b174-$b234;	//刪減金額計算
	$b239=$b178-$b238;	//刪減金額計算
	$b243=$b182-$b242;	//刪減金額計算
	$b247=$b186-$b246;	//刪減金額計算
}
?> 
...
<form name="form" method="post" action="102_examine_allowance3_finish.php?id=<? echo $id;?>">
...
<br>
<b>※申請資料與審核：</b><br>
●最近五年是否曾獲本項補助：<font face="Arial, Helvetica, sans-serif" color=red size="+1"><? if ($a029=='1') {echo '近五年已接受本項補助之宿舍，不得再提出申請。';} else {echo '近五年未受補助。';};?></font><br />
●學校申請修繕(含設備)：<font face="Arial, Helvetica, sans-serif" color=red size="+1"><? echo $a4item; ?></font><br />
●最近三年住宿情形：<br>
<? if ($a4key == 1) { echo "<!--"; } ?>
　<strong>教師宿舍</strong><br />
　　今(<? echo $datetime-1912;?>)學年度教師宿舍住宿人數<font face="Arial, Helvetica, sans-serif" color=red size="+1"><? echo $a023;?></font>人<br>
　　去(<? echo $datetime-1913;?>)學年度教師宿舍住宿人數<font face="Arial, Helvetica, sans-serif" color=red size="+1"><? echo $a024;?></font>人<br>
　　前(<? echo $datetime-1914;?>)學年度教師宿舍住宿人數<font face="Arial, Helvetica, sans-serif" color=red size="+1"><? echo $a025;?></font>人<br>
<? if ($a4key == 1) { echo "-->"; } ?>
<? if ($a4key == 2) { echo "<!--"; } ?>
　<strong>學生宿舍</strong><br />
　　今(<? echo $datetime-1912;?>)學年度學生宿舍住宿人數<font face="Arial, Helvetica, sans-serif" color=red size="+1"><? echo $a026;?></font>人<br>
　　去(<? echo $datetime-1913;?>)學年度學生宿舍住宿人數<font face="Arial, Helvetica, sans-serif" color=red size="+1"><? echo $a027;?></font>人<br>
　　前(<? echo $datetime-1914;?>)學年度學生宿舍住宿人數<font face="Arial, Helvetica, sans-serif" color=red size="+1"><? echo $a028;?></font>人<br>
<? if ($a4key == 2) { echo "-->"; } ?>
<p>
<? if ($a4key == 1) { echo "<!--"; } ?>
<b>※教師宿舍</b><br />
學校申請：經費共計<font face="Arial, Helvetica, sans-serif" color=red size="+1"><? echo number_format($a013);?></font>元，其中包含經常門經費<font face="Arial, Helvetica, sans-serif" color=red size="+1"><? echo $a019;?></font>項<font face="Arial, Helvetica, sans-serif" color=red size="+1"><? echo number_format($a014);?></font>元，資本門經費<font face="Arial, Helvetica, sans-serif" color=red size="+1"><? echo $a020;?></font>式<font face="Arial, Helvetica, sans-serif" color=red size="+1"><? echo number_format($a015);?></font>元。<br />
縣市初審：經費共計<font face="Arial, Helvetica, sans-serif" color=red size="+1"><? echo number_format($a135);?></font>元，其中包含經常門經費<font face="Arial, Helvetica, sans-serif" color=red size="+1"><? echo $a141;?></font>項<font face="Arial, Helvetica, sans-serif" color=red size="+1"><? echo number_format($a136);?></font>元，資本門經費<font face="Arial, Helvetica, sans-serif" color=red size="+1"><? echo $a142;?></font>式<font face="Arial, Helvetica, sans-serif" color=red size="+1"><? echo number_format($a137);?></font>元。<br />
<b>複審金額：<font color=blue>經費共計<input type="text" size="6" name="a195" value="<? if($a195=='') echo $a135; else echo $a195;?>" style="border:0px; text-align: right;" readonly>元</font>，其中包含經常門經費<input type="text" size="2" name="a201" value="<? if($a201=='') echo $a141; else echo $a201;?>" style="border:0px; text-align: right;" readonly >項<font color=blue><input type="text" size="6" name="a196" onChange="change3()" value="<? if($a196=='') echo $a136; else echo $a196;?>" style="border:0px; text-align: right;" readonly >元</font>，資本門經費<input type="text" size="2" name="a202" value="<? if($a202=='') echo $a142; else echo $a202;?>" style="border:0px; text-align: right;" readonly >式<font color=blue><input type="text" size="6" name="a197" onChange="change4()" value="<? if($a197=='') echo $a137; else echo $a197;?>" style="border:0px; text-align: right;" readonly >元</font>。</b>
...
<table width="100%" border="0" cellspacing="0" cellpadding="0" bgcolor="#FFFFCC" style="font-size:12px;">
  ...
  <tr>
    ...
    <select name="a030" id="s1_1" size="1" onChange="combo_s1_1()">
      ...
      <option <? if($a030==$s1[2]) echo "selected"; ?>><? echo $s1[2]; ?></option>
    </select>
    </td>
    <td align="left">
  ...
  <tr>
    ...
    <select name="a120" id="s10_1" size="1" onChange="combo_s10_1()">
      ...
      <option <? if($a120==$s1[2]) echo "selected"; ?>><? echo $s1[2]; ?></option>
    </select>
    </td>
    <td align="left">
    <select name="a121" id="s10_2" size="1">
      ...
      <option <? if($a121==$s2[6]) echo "selected"; ?>><? echo $s2[6]; ?></option>
      <option <? if($a121==$s2[7]) echo "selected"; ?>><? echo $s2[7]; ?></option>
      <option <? if($a121==$s2[8]) echo "selected"; ?>><? echo $s2[8]; ?></option>
    </select>
    </td>
    <td align="left" valign="middle"><input type="text" size="10" name="a122" value="<? if($a122 =='') echo ''; else echo $a122;?>" style="border:0px; text-align: left;" readonly ></td>
...
<? if ($a4key == 2) { echo "<!--"; } ?>
<b>※學生宿舍</b><br />
學校申請：經費共計<font face="Arial, Helvetica, sans-serif" color=red size="+1"><? echo number_format($a016);?></font>元，其中包含經常門經費<font face="Arial, Helvetica, sans-serif" color=red size="+1"><? echo $a021;?></font>項<font face="Arial, Helvetica, sans-serif" color=red size="+1"><? echo number_format($a017);?></font>元，資本門經費<font face="Arial, Helvetica, sans-serif" color=red size="+1"><? echo $a022;?></font>式<font face="Arial, Helvetica, sans-serif" color=red size="+1"><? echo number_format($a018);?></font>元。<br />
縣市初審：經費共計<font face="Arial, Helvetica, sans-serif" color=red size="+1"><? echo number_format($a138);?></font>元，其中包含經常門經費<font face="Arial, Helvetica, sans-serif" color=red size="+1"><? echo $a143;?></font>項<font face="Arial, Helvetica, sans-serif" color=red size="+1"><? echo number_format($a139);?></font>元，資本門經費<font face="Arial, Helvetica, sans-serif" color=red size="+1"><? echo $a144;?></font>式<font face="Arial, Helvetica, sans-serif" color=red size="+1"><? echo number_format($a140);?></font>元。<br />
<b>複審金額：<font color=blue>經費共計<input type="text" size="6" name="a198" value="<? if($a198=='') echo $a138; else echo $a198;?>" style="border:0px; text-align: right;" readonly>元</font>，其中包含經常門經費<input type="text" size="2" name="a203" value="<? if($a203=='') echo $a143; else echo $a203;?>">項<font color=blue><input type="text" size="6" name="a199" onChange="change5()" value="<? if($a199=='') echo $a139; else echo $a199;?>">元</font>，資本門經費<input type="text" size="2" name="a204" value="<? if($a204=='') echo $a144; else echo $a204;?>">
式<font color=blue><input type="text" size="6" name="a200" onChange="change6()" value="<? if($a200=='') echo $a140; else echo $a200;?>">元</font>。</b>
...
<table width="100%" border="0" cellspacing="0" cellpadding="0" bgcolor="#FFFFCC" style="font-size:12px;">
  ...
  <tr>
    <td width="10" align="center" nowrap="nowrap">1.</td>
    <td align="left">
    <select name="b030" id="b1_1" size="1" onChange="combo_b1_1()">
      <option <? if($b030==$s1[0]) echo "selected"; ?>><? echo $s1[0]; ?></option>
      <option <? if($b030==$s1[1]) echo "selected"; ?>><? echo $s1[1]; ?></option>
      <option <? if($b030==$s1[2]) echo "selected"; ?>><? echo $s1[2]; ?></option>
    </select>
    </td>
    <td align="left">
    <select name="b031" id="b1_2" size="1">
      <option <? if($b031==$s2[0]) echo "selected"; ?>><? echo $s2[0]; ?></option>
      <option <? if($b031==$s2[1]) echo "selected"; ?>><? echo $s2[1]; ?></option>
      <option <? if($b031==$s2[2]) echo "selected"; ?>><? echo $s2[2]; ?></option>
      <option <? if($b031==$s2[3]) echo "selected"; ?>><? echo $s2[3]; ?></option>
      <option <? if($b031==$s2[4]) echo "selected"; ?>><? echo $s2[4]; ?></option>
    </select>
    </td>
    ...
    <td align="left"><input type="text" size="4" name="b150" value="<? if($b150 =='') echo ''; else echo $b150;?>" style="border:0px; text-align: left;" readonly="readonly" /></td>
    ...
    <td align="left"><input type="text" size="4" name="b210" onchange="js:diffMoney(this);" value="<? if($b210 =='') echo ''; else echo $b210;?>"/></td>
    <td align="left"><input type="text" size="4" name="b211" value="<? if($b211 =='') echo ''; else echo $b211;?>" style="border:0px; text-align: left;" readonly="readonly" /></td>
    </tr>
  <tr>
    <td width="10" align="center" nowrap="nowrap">2.</td>
    <td align="left">
    ...
    <td align="left"><input type="text" size="4" name="b154" value="<? if($b154 =='') echo ''; else echo $b154;?>" style="border:0px; text-align: left;" readonly="readonly" /></td>
    ...
    <td align="left"><input type="text" size="4" name="b214" onchange="js:diffMoney(this);" value="<? if($b214 =='') echo ''; else echo $b214;?>"/></td>
    <td align="left"><input type="text" size="4" name="b215" value="<? if($b215 =='') echo ''; else echo $b215;?>" style="border:0px; text-align: left;" readonly="readonly" /></td>
    </tr>
  <tr>
    <td width="10" align="center" nowrap="nowrap">3.</td>
    <td align="left">
    ...
    <td align="left"><input type="text" size="4" name="b158" value="<? if($b158 =='') echo ''; else echo $b158;?>" style="border:0px; text-align: left;" readonly="readonly" /></td>
    ...
    <td align="left"><input type="text" size="4" name="b218" onchange="js:diffMoney(this);" value="<? if($b218 =='') echo ''; else echo $b218;?>"/></td>
    <td align="left"><input type="text" size="4" name="b219" value="<? if($b219 =='') echo ''; else echo $b219;?>" style="border:0px; text-align: left;" readonly="readonly" /></td>
    </tr>
  <tr>
    <td width="10" align="center" nowrap="nowrap">4.</td>
    <td align="left">
    ...
    <td align="left"><input type="text" size="4" name="b162" value="<? if($b162 =='') echo ''; else echo $b162;?>" style="border:0px; text-align: left;" readonly="readonly" /></td>
    ...
    <td align="left"><input type="text" size="4" name="b222" onchange="js:diffMoney(this);" value="<? if($b222 =='') echo ''; else echo $b222;?>"/></td>
    <td align="left"><input type="text" size="4" name="b223" value="<? if($b223 =='') echo ''; else echo $b223;?>" style="border:0px; text-align: left;" readonly="readonly" /></td>
    </tr>
  <tr>
    <td width="10" align="center" nowrap="nowrap">5.</td>
    <td align="left">
    ...
    <td align="left"><input type="text" size="4" name="b166" value="<? if($b166 =='') echo ''; else echo $b166;?>" style="border:0px; text-align: left;" readonly="readonly" /></td>
    ...
    <td align="left"><input type="text" size="4" name="b226" onchange="js:diffMoney(this);" value="<? if($b226 =='') echo ''; else echo $b226;?>"/></td>
    <td align="left"><input type="text" size="4" name="b227" value="<? if($b227 =='') echo ''; else echo $b227;?>" style="border:0px; text-align: left;" readonly="readonly" /></td>
    </tr>
  <tr>
    <td width="10" align="center" nowrap="nowrap">6.</td>
    <td align="left">
    ...
    <td align="left"><input type="text" size="4" name="b170" value="<? if($b170 =='') echo ''; else echo $b170;?>" style="border:0px; text-align: left;" readonly="readonly" /></td>
    ...
    <td align="left"><input type="text" size="4" name="b230" onchange="js:diffMoney(this);" value="<? if($b230 =='') echo ''; else echo $b230;?>"/></td>
    <td align="left"><input type="text" size="4" name="b231" value="<? if($b231 =='') echo ''; else echo $b231;?>" style="border:0px; text-align: left;" readonly="readonly" /></td>
    </tr>
  <tr>
    <td width="10" align="center" nowrap="nowrap">7.</td>
    <td align="left">
    ...
    <td align="left"><input type="text" size="4" name="b174" value="<? if($b174 =='') echo ''; else echo $b174;?>" style="border:0px; text-align: left;" readonly="readonly" /></td>
    ...
    <td align="left"><input type="text" size="4" name="b234" onchange="js:diffMoney(this);" value="<? if($b234 =='') echo ''; else echo $b234;?>"/></td>
    <td align="left"><input type="text" size="4" name="b235" value="<? if($b235 =='') echo ''; else echo $b235;?>" style="border:0px; text-align: left;" readonly="readonly" /></td>
    </tr>
  <tr>
    <td align="center" nowrap="nowrap">8.</td>
    <td align="left">
    ...
    <td align="left"><input type="text" size="4" name="b178" value="<? if($b178 =='') echo ''; else echo $b178;?>" style="border:0px; text-align: left;" readonly="readonly" /></td>
    ...
    <td align="left"><input type="text" size="4" name="b238" onchange="js:diffMoney(this);" value="<? if($b238 =='') echo ''; else echo $b238;?>"/></td>
    <td align="left"><input type="text" size="4" name="b239" value="<? if($b239 =='') echo ''; else echo $b239;?>" style="border:0px; text-align: left;" readonly="readonly" /></td>
    </tr>
  <tr>
    <td align="center" nowrap="nowrap">9.</td>
    <td align="left">
    ...
    <td align="left"><input type="text" size="4" name="b182" value="<? if($b182 =='') echo ''; else echo $b182;?>" style="border:0px; text-align: left;" readonly="readonly" /></td>
    ...
    <td align="left"><input type="text" size="4" name="b242" onchange="js:diffMoney(this);" value="<? if($b242 =='') echo ''; else echo $b242;?>"/></td>
    <td align="left"><input type="text" size="4" name="b243" value="<? if($b243 =='') echo ''; else echo $b243;?>" style="border:0px; text-align: left;" readonly="readonly" /></td>
    </tr>
  <tr>
    <td width="10" align="center" nowrap="nowrap">10.</td>
    <td align="left">
    <select name="b120" id="b10_1" size="1" onChange="combo_b10_1()">
      <option <? if($b120==$s1[0]) echo "selected"; ?>><? echo $s1[0]; ?></option>
      <option <? if($b120==$s1[1]) echo "selected"; ?>><? echo $s1[1]; ?></option>
      <option <? if($b120==$s1[2]) echo "selected"; ?>><? echo $s1[2]; ?></option>
    </select>
    </td>
    <td align="left">
    <select name="b121" id="b10_2" size="1">
      <option <? if($b121==$s2[0]) echo "selected"; ?>><? echo $s2[0]; ?></option>
      <option <? if($b121==$s2[1]) echo "selected"; ?>><? echo $s2[1]; ?></option>
      <option <? if($b121==$s2[2]) echo "selected"; ?>><? echo $s2[2]; ?></option>
      <option <? if($b121==$s2[3]) echo "selected"; ?>><? echo $s2[3]; ?></option>
      <option <? if($b121==$s2[4]) echo "selected"; ?>><? echo $s2[4]; ?></option>
      <option <? if($b121==$s2[5]) echo "selected"; ?>><? echo $s2[5]; ?></option>
      <option <? if($b121==$s2[6]) echo "selected"; ?>><? echo $s2[6]; ?></option>
      <option <? if($b121==$s2[7]) echo "selected"; ?>><? echo $s2[7]; ?></option>
      <option <? if($b121==$s2[8]) echo "selected"; ?>><? echo $s2[8]; ?></option>
    </select>
    </td>
    <td align="left" valign="middle"><input type="text" size="10" name="b122" value="<? if($b122 =='') echo ''; else echo $b122;?>" style="border:0px; text-align: left;" readonly ></td>
    ...
    <td align="left"><input type="text" size="4" name="b186" value="<? if($b186 =='') echo ''; else echo $b186;?>" style="border:0px; text-align: left;" readonly="readonly" /></td>
    ...
    <td align="left"><input type="text" size="4" name="b246" onchange="js:diffMoney(this);" value="<? if($b246 =='') echo ''; else echo $b246;?>"/></td>
    <td align="left"><input type="text" size="4" name="b247" value="<? if($b247 =='') echo ''; else echo $b247;?>" style="border:0px; text-align: left;" readonly="readonly" /></td>
    </tr>
</table>
<? if ($a4key == 2) { echo "-->"; } ?>
<p>
...
//列出狀態訊息
echo "<b>※應上傳檔案：</b><br>";
if ($a3_1 == ''){echo "‧實施計畫：<font color=red>未上傳</font>";} else {echo '‧實施計畫：<font color=blue>已上傳</font>，檔名：'.'<a href="../xSchoolForm/upload/102/'.$school.'/'.$a3_1.'" style="text-decoration:none" target="_new">'.$a3_1.'</a>';}
echo "<br />";
if ($a3_2 == ''){echo "‧近三年住宿人員資料：<font color=red>未上傳</font>";} else {echo '‧近三年住宿人員資料：<font color=blue>已上傳</font>，檔名：'.'<a href="../xSchoolForm/upload/102/'.$school.'/'.$a3_2.'" style="text-decoration:none" target="_new">'.$a3_2.'</a>';}
...
<input type="hidden" name="allowance"  value="<? echo "allowance3"; ?>" >
<label>
...
function numsum1() { 
	...
	f.a195.value = (f.a196.value==""?0:parseFloat(f.a196.value)) + (f.a197.value==""?0:parseFloat(f.a197.value)); 
}
function numsum2() { 
	var f = document.forms[0]; 
	f.a198.value = (f.a199.value==""?0:parseFloat(f.a199.value)) + (f.a200.value==""?0:parseFloat(f.a200.value)); 
}
function change3() { 
	var f = document.forms[0]; 
	numsum1();
...
function combo_b1_1(){
	var clsnum=0,newnum=0,i;
	clsnum=8;   // 清除下拉選單中的項目數目,取最大
	var selectName=document.form.b1_1.options[document.form.b1_1.selectedIndex].text;
	NewOpt = new Array;
	...
	newnum = NewOpt.length;
	lst = document.form.b1_2.options.length;
	//alert("newnum=" + newnum + "\nlst=" + lst);
	// 清除之前下拉選單中的項目
	for (i = 0; i < clsnum; i++) document.form.b1_2.options[i] = null;
	
	// 加入新選類別的項目
	for (i = 0; i < newnum; i++) document.form.b1_2.options[i] = NewOpt[i];

	//document.form.b1_2.options[0].selected = true;
	document.form.b1_2.options[0].selected = true;
}
//b2
function combo_b2_1(){
...
//b10
function combo_b10_1(){
	var clsnum=0,newnum=0,i;
	clsnum=8;   // 清除下拉選單中的項目數目,取最大
	var selectName=document.form.b10_1.options[document.form.b10_1.selectedIndex].text;
	NewOpt = new Array;
	...
	newnum = NewOpt.length;
	lst = document.form.b10_2.options.length;
	//alert("newnum=" + newnum + "\nlst=" + lst);
	// 清除之前下拉選單中的項目
	for (i = 0; i < clsnum; i++) document.form.b10_2.options[i] = null;
	
	// 加入新選類別的項目
	for (i = 0; i < newnum; i++) document.form.b10_2.options[i] = NewOpt[i];

	//document.form.b10_2.options[0].selected = true;
	document.form.b10_2.options[0].selected = true;
}
</script>
<script language="JavaScript">
	...
	function count_all(group_ab)
	{
		...
		var money_1 = 0; //經常門費用
		var money_2 = 0; //資本門
		var money_1_c = 0; //經常門數量
		var money_2_c = 0; //資本門數量
		...
		if(group_ab == "a")
		{
			...
			document.getElementsByName("a201")[0].value = money_1_c;	
			document.getElementsByName("a196")[0].value = money_1;	
			document.getElementsByName("a202")[0].value = money_2_c;	
			document.getElementsByName("a197")[0].value = money_2;	
		}
		else
		{
			//學生
			document.getElementsByName("a198")[0].value = total;	
			document.getElementsByName("a203")[0].value = money_1_c;	
			document.getElementsByName("a199")[0].value = money_1;	
			document.getElementsByName("a204")[0].value = money_2_c;	
			document.getElementsByName("a200")[0].value = money_2;	
		}

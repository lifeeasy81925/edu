...
說明：6班以下最高補助10萬元，7至12班最高補助15萬元，13班以上最高補助20萬元。
</p>
...
縣市初審：經費共計<font face="Arial, Helvetica, sans-serif" color=red size="+1"><? echo number_format($a132); ?></font>元，其中包含經常門經費<font face="Arial, Helvetica, sans-serif" color=red size="+1"><? echo number_format($a133); ?></font>元，資本門經費<font face="Arial, Helvetica, sans-serif" color=red size="+1"><? echo number_format($a134); ?></font>元。<br />
<b>複審金額：<font color=blue>經費共計<input type="text" size="6" name="a192" value="<? if($a192=='') echo $a132; else echo $a192;?>" style="border:0px; text-align: right;" readonly>元，其中包含經常門經費<input type="text" size="6" name="a193" onChange="change1()" value="<? if($a193=='') echo $a133; else echo $a193;?>" style="border:0px; text-align: right;" readonly >元，資本門經費<input type="text" size="6" name="a194" onChange="change2()" value="<? if($a194=='') echo $a134; else echo $a194;?>" style="border:0px; text-align: right;" readonly >元。</font></b>
<? //經費表 補助項目四 ?>
<table width="100%" border="0" cellspacing="0" cellpadding="0" bgcolor="#FFFFCC" style="font-size:12px;">
  <tr>
    <td colspan="9" align="center" nowrap="nowrap" bgcolor="#99CC66"  style="font-size:14px;">補助項目四：學校申請</td>
...
<script language="JavaScript">
	...
	function count_all(group_ab)
	{
		...
		if(group_ab == "a")
		{
			...
			document.getElementsByName("a193")[0].value = money_1;	
			document.getElementsByName("a194")[0].value = money_2;	
		}

...
<table width="100%" border="0" cellspacing="0" cellpadding="0" bgcolor="#FFFFCC" style="font-size:12px;">
  ...
  <tr>
    ...
    <td align="left" valign="middle"><input type="checkbox" onclick="js:return false;" name="a122" value="1" <? if($a122 =='1') echo 'checked';?>/>申請雜支</td>
...
<table width="100%" border="0" cellspacing="0" cellpadding="0" bgcolor="#FFFFCC" style="font-size:12px;">
  ...
  <tr>
    ...
    <td align="left" valign="middle"><input type="checkbox" onclick="js:return false;" name="b122" value="1" <? if($b122 =='1') echo 'checked';?>/>申請雜支</td>
...
<input type="hidden" name="allowance"  value="<? echo "allowance4"; ?>" >
<label>

...
echo $username."_";
echo $edu."_";
echo $eduman."【102年度教育部推動教育優先區計畫複審結果縣市列表】";
...
<?
	...
	for ($i=0;$i<22;$i++) {
		...
		while($row = mysql_fetch_row($result)){
			...
			$current += $a1_195 + $a1_198 + $a2_193 + $a3_196 + $a3_199 + $a4_193 + $a5_193 + $a6_196 + $a6_198;
			$capital += $a2_194 + $a3_197 + $a3_200 + $a4_194 + $a5_194 + $a6_200 + $a7_193;
			$city_total = $current + $capital;
		...
		echo "<tr>";
			echo "<td nowrap='nowrap' align='center'>$city_name[$i]</td>";
			echo "<td nowrap='nowrap' align='right' width='120px' bgcolor='#FFFFCC'>".number_format($current)."</td>";
			echo "<td nowrap='nowrap' align='right' width='120px' bgcolor='#CCFFCC'>".number_format($capital)."</td>";
			echo "<td nowrap='nowrap' align='right' width='120px' bgcolor='#FFFFCC'>".number_format($city_total)."</td>";
		echo "</tr>";

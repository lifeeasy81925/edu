...
$schoolid = $search_school;
?>
<meta http-equiv="Content-Type" content="text/html; charset=utf-8" />
<?
$sql = "select * from 102schooldata where account like '$search_school' ";
...
//補一
if($p158==1){
$sql_allowance = "select * from 102allowance1 where account like '$search_school'";
...
//補二
if($p159==1){
$sql_allowance = "select * from 102allowance2 where account like '$search_school'";
$result_allowance = mysql_query($sql_allowance);
while($row = mysql_fetch_row($result_allowance)){
...
//補三
if($p160==1 || $p161==1){
$sql_allowance = "select * from 102allowance3 where account like '$search_school'";
$result_allowance = mysql_query($sql_allowance);
while($row = mysql_fetch_row($result_allowance)){
...
//補四
if($p162==1){
$sql_allowance = "select * from 102allowance4 where account like '$search_school'";
$result_allowance = mysql_query($sql_allowance);
while($row = mysql_fetch_row($result_allowance)){
...
//補五
if($p163==1){
$sql_allowance = "select * from 102allowance5 where account like '$search_school'";
$result_allowance = mysql_query($sql_allowance);
while($row = mysql_fetch_row($result_allowance)){
...
//補六
if($p164==1){
$sql_allowance = "select * from 102allowance6 where account like '$search_school'";
$result_allowance = mysql_query($sql_allowance);
while($row = mysql_fetch_row($result_allowance)){
...
//補七
if($p165==1){
$sql_allowance = "select * from 102allowance7 where account like '$search_school'";
$result_allowance = mysql_query($sql_allowance);
while($row = mysql_fetch_row($result_allowance)){
...
<table width="100%" bordercolor="#000000"  border="1" cellpadding="0" cellspacing="0">
  <tr>
    ...
    <td colspan="5" class="style3"><div align="center"><span class="style7"></span><? echo $id.'　'.$city.$district.$school;?></div></td>
  </tr>
  <tr>
  ...
  <tr>
    ...
    <td height="30" rowspan="2" class="style3">推展親職教育活動<? if($a1_010 >0) echo "<a href='102_edu_funds.php?op=1&schoolid=$schoolid' target='_blank'><br />(開啟審核經費表)</a>"; else echo " "; ?></td>
    ...
    <td height="30" bgcolor="#FFCC99" class="style3"><div align="right"><? echo number_format($a1_195);?></div></td>
    <td height="30" rowspan="2" bgcolor="#FFCC99" class="style3"><? echo $a1_191;?></td>
  </tr>
  <tr>
    ...
    <td height="30" bgcolor="#FFCC99" class="style3"><div align="right"><? echo number_format($a1_198);?></div></td>
  </tr>
  <tr>
    <td height="30" rowspan="4" class="style3"><div align="center">2.</div>      <div align="center"></div></td>
    <td height="30" rowspan="4" class="style3">補助學校發展教育特色<? if($a2_010 >0) echo "<a href='102_edu_funds.php?op=2&schoolid=$schoolid' target='_blank'><br />(開啟審核經費表)</a>"; else echo " "; ?></td>
    ...
    <td height="30" bgcolor="#FFCC99" class="style3"><div align="right"><? echo number_format($a2_196);?></div></td>
    <td height="30" rowspan="4" bgcolor="#FFCC99" class="style3"><? echo $a2_191;?></td>
  </tr>
  <tr>
    ...
    <td height="30" bgcolor="#FFCC99" class="style3"><div align="right"><? echo number_format($a2_197);?></div></td>
  </tr>
  <tr>
    ...
    <td height="30" bgcolor="#FFCC99" class="style3"><div align="right"><? echo number_format($a2_199);?></div></td>
  </tr>
  <tr>
    <td height="30" nowrap="nowrap" class="style3">資本門</td>
    ...
    <td height="30" bgcolor="#FFCC99" class="style3"><div align="right"><? echo number_format($a2_200);?></div></td>
  </tr>
<tr>
  ...
  <td height="30" rowspan="4" class="style3">修繕離島或偏遠地區師生宿舍<? if($a3_010 >0) echo "<a href='102_edu_funds.php?op=3&schoolid=$schoolid' target='_blank'><br />(開啟審核經費表)</a>"; else echo " "; ?></td>
  ...
  <td height="30" bgcolor="#FFCC99" class="style3"><div align="right"><? echo number_format($a3_196);?></div></td>
  <td height="30" rowspan="4" bgcolor="#FFCC99" class="style3"><? echo $a3_191;?></td>
</tr>
<tr>
  <td height="30" nowrap="nowrap" class="style3">資本門</td>
  ...
  <td height="30" bgcolor="#FFCC99" class="style3"><div align="right"><? echo number_format($a3_197);?></div></td>
  </tr>
<tr>
  <td height="30" rowspan="2" class="style3">學生宿舍</td>
    ...
    <td height="30" bgcolor="#FFCC99" class="style3"><div align="right"><? echo number_format($a3_199);?></div></td>
  </tr>
...
<tr>
  <td height="30" nowrap="nowrap" class="style3">資本門</td>
    ...
    <td height="30" bgcolor="#FFCC99" class="style3"><div align="right"><? echo number_format($a3_200);?></div></td>
</tr>
  <tr>
    <td height="30" rowspan="2" class="style3"><div align="center">4.</div></td>
    <td height="30" rowspan="2" class="style3">充實學校基本教學設備<? if($a4_010 >0) echo "<a href='102_edu_funds.php?op=4&schoolid=$schoolid' target='_blank'><br />(開啟審核經費表)</a>"; else echo " "; ?></td>
    ...
    <td height="30" bgcolor="#FFCC99" class="style3"><div align="right"><? echo number_format($a4_193);?></div></td>
    <td height="30" rowspan="2" bgcolor="#FFCC99" class="style3"><? echo $a4_191;?></td>
  </tr>
  <tr>
    ...
    <td height="30" align="right" bgcolor="#FFCC99" class="style3"><? echo number_format($a4_194);?></td>
  </tr>
  <tr>
    <td height="30" rowspan="4" class="style3"><div align="center">5.</div>      <div align="center"></div></td>
    <td height="30" rowspan="4" class="style3">發展原住民教育文化特色及充實設備器材<? if($a5_010 >0) echo "<a href='102_edu_funds.php?op=5&schoolid=$schoolid' target='_blank'><br />(開啟審核經費表)</a>"; else echo " "; ?></td>
    ...
    <td height="30" bgcolor="#FFCC99" class="style3"><div align="right"><? echo number_format($a5_196);?></div></td>
    <td height="30" rowspan="4" bgcolor="#FFCC99" class="style3"><? echo $a5_191;?></td>
  </tr>
  <tr>
    <td height="30" nowrap="nowrap" class="style3">資本門</td>
    ...
    <td height="30" bgcolor="#FFCC99" class="style3"><div align="right"><? echo number_format($a5_197);?></div></td>
  </tr>
  <tr>
    ...
    <td height="30" bgcolor="#FFCC99" class="style3"><div align="right"><? echo number_format($a5_199);?></div></td>
  </tr>
  <tr>
    <td height="30" nowrap="nowrap" class="style3">資本門</td>
    ...
    <td height="30" bgcolor="#FFCC99" class="style3"><div align="right"><? echo number_format($a5_200);?></div></td>
  </tr>
  <tr>
    ...
    <td height="30" bgcolor="#FFCC99" class="style3"><div align="right"><? echo number_format($a6_196);?></div></td>
    <td height="30" rowspan="3" bgcolor="#FFCC99" class="style3"><? echo $a6_191;?></td>
  </tr>
  <tr>
    ...
    <td height="30" bgcolor="#FFCC99" class="style3"><div align="right"><? echo number_format($a6_198);?></div></td>
  </tr>
  <tr>
    ...
    <td height="30" bgcolor="#FFCC99" class="style3"><div align="right"><? echo number_format($a6_200);?></div></td>
  </tr>
  <tr>
    <td height="30" rowspan="2" class="style3"><div align="center">7.</div>      <div align="center"></div>      <div align="center"></div></td>
    <td height="30" rowspan="2" class="style3">整修學校社區化活動場所<? if($a7_010 >0) echo "<a href='102_edu_funds.php?op=7&schoolid=$schoolid' target='_blank'><br />(開啟審核經費表)</a>"; else echo " "; ?></td>
    ...
    <td height="30" bgcolor="#FFCC99" class="style3"><div align="right"><? echo number_format($a7_193);?></div></td>
    <td height="30" rowspan="2" bgcolor="#FFCC99" class="style3"><? echo $a7_191;?></td>
  </tr>
  <tr>
    ...
    <td height="30" bgcolor="#FFCC99" class="style3"><div align="right"><? echo number_format($a7_194);?></div></td>
  </tr>
  <tr>
    ...
    <td bgcolor="#FFCC99" class="style3"><div align="right"><? echo number_format($a1_195+$a1_198+$a2_196+$a2_197+$a2_199+$a2_200+$a3_196+$a3_197+$a3_199+$a3_200+$a4_193+$a4_194+$a5_196+$a5_197+$a5_199+$a5_200+$a6_196+$a6_198+$a6_200+$a7_193+$a7_194);?></div></td>

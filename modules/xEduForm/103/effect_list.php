...
<p><b>僅顯示：</b>
	<a href="effect_list.php?ct=<?=$cityname;?>">全部顯示</a>&nbsp;
	<a href="effect_list.php?ct=<?=$cityname;?>&op=1">補助一</a>&nbsp;
	<a href="effect_list.php?ct=<?=$cityname;?>&op=2">補助二</a>&nbsp;
	<a href="effect_list.php?ct=<?=$cityname;?>&op=3">補助三</a>&nbsp;
	<a href="effect_list.php?ct=<?=$cityname;?>&op=4">補助四</a>&nbsp;
	<a href="effect_list.php?ct=<?=$cityname;?>&op=5">補助五</a>&nbsp;
	<a href="effect_list.php?ct=<?=$cityname;?>&op=6">補助六</a>&nbsp;
	<a href="effect_list.php?ct=<?=$cityname;?>&op=7">補助七</a>&nbsp;
</p>

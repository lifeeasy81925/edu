...
<table border="0">
	...
	<tr>
		<td nowrap="nowrap" colspan="2">
			<b>複審金額：個別家庭訪視<input type="text" size="2" name="edu_p2_people" value="<?=$edu_p2_people;?>" onChange="js:Count_family(this);">人次，
			<font color=blue>補助經費<input type="text" size="6" name="edu_p2_money" value="<?=$edu_p2_money;?>" style="border:0px; text-align: right;" readonly>元</font>。
		</td>
	</tr>
</table>
<p>

...
<table border="1" align="center" cellpadding="0" cellspacing="0">
	...
	<tr>
		...
		<td rowspan="2" align="center"><?=($school_year-2);?> 學年第一次學測PR ≦ 25 人數</td>
		<td rowspan="2" align="center">PR ≦ 25 人數佔參加學測學生人數之比例 (%)</td>
...
<?
	...
	while($row = mysql_fetch_array($result))
	{
		...
		$teacher_change_in_last = $row['a138'];
		$teacher_change_lack_last = $row['a141'];
		$teacher_change_other_last = $row['a144']; 
		...
		$p6_1 = in_array('p6_1',$accord_point_ary)?'1':"0";
		$p6_2 = in_array('p6_2',$accord_point_ary)?'1':"0";	
		...
		?>
			<tr>
				...
				<td style="text-align:right"><?=$lastyear_pr25; //國中第一次學測PR<=25人數?></td>
				<td style="text-align:right"><?=number_format($lastyear_pr25/$lastyear_graduate*100,2); //國中第一次學測PR<=25人數比例?></td>

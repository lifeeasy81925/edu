...
<?
	$sql = " SELECT cn.idx, cn.cityname, cun.account, cun.city_1, cun.city_2, cun.city_3, cun.city_4, cun.city_5 ".
		   " FROM cityname AS cn LEFT JOIN  `city_upload_name` AS cun ON cn.cityname_eng = REPLACE( cun.account,  '001',  '' ) and cun.school_year = '$school_year'".  //and cun.school_year = '$school_year'
	...
	while($row = mysql_fetch_array($result))
	{
		...
		//上傳路徑
		//$file_path = '/edu_upload/103/'.$account.'/';
		//1040429修改上傳路徑
		$file_path = '/epa_uploads/103/pub/'.$account.'/';

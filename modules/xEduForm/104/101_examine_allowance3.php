...
?>
※申請資料與審核：<br>
●申請總經費<font face="Arial, Helvetica, sans-serif" color="#FF0000" size="+1"><? echo number_format($a);?></font>元。<? if($examine == '2') echo '縣市審核'.'<font face="Arial, Helvetica, sans-serif" color="#FF0000" size="+1">'.number_format($city1).'</font>元。'?>
<font color=blue>複核金額<input type="text" size="5" name="money" value= "<? 
if($examine == '1' ){
	if($city1 != 0){
		if($a != $city1){
			echo $city1;
...
資本門<font face="Arial, Helvetica, sans-serif" color="#FF0000" size="+1"><? echo number_format($c_2);?></font>元)<br /><? if($examine == '2') echo '●特色一縣市審核'.'<font face="Arial, Helvetica, sans-serif" color="#FF0000" size="+1">'.number_format($city2).'</font>元 (經常門<font face="Arial, Helvetica, sans-serif" color="#FF0000" size="+1">'.number_format($city2_1).'</font>元，
資本門<font face="Arial, Helvetica, sans-serif" color="#FF0000" size="+1">'.number_format($city2_2).'</font>元)'?>
<br /><b>--<font color=blue>特色一</b>複核金額<input type="text" size="5" name="money1" onChange="change1()" value= "<?
if($examine == '1' ){
	if($city2 != 0 ){
		if($c!= $city2){
			echo $city2;
...
資本門<font face="Arial, Helvetica, sans-serif" color="#FF0000" size="+1"><? echo number_format($e_2);?></font>元)<br /><? if($examine == '2') echo '●特色二縣市審核'.'<font face="Arial, Helvetica, sans-serif" color="#FF0000" size="+1">'.number_format($city3).'</font>元 (經常門<font face="Arial, Helvetica, sans-serif" color="#FF0000" size="+1">'.number_format($city3_1).'</font>元，
資本門<font face="Arial, Helvetica, sans-serif" color="#FF0000" size="+1">'.number_format($city3_2).'</font>元)'?>
<br /><b>--<font color=blue>特色二</b>複核金額<input type="text" size="5" name="money2" onChange="change2()" value= "<?
if($examine == '1' ){
	if($city3 != 0){
		if($e != $city3){
			echo $city3;
...
●審核意見說明：<textarea name="other" cols="40" rows="5"><? if($examine == '1'){ echo $suggestion1;}else{ echo $suggestion2;}?></textarea>
<p>
<!--審查退件功能  -->

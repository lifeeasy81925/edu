...
*/	
	...
	$account = $_GET['id'];                                                            //j10410
	//echo $account;
	
    //$account = ($_POST['account'] == '')?$_GET['id']:$_POST['account'];
...
<?
	...
	$sql = " select effect_a1_1, effect_a1_2, effect_a1_3, effect_a1_4 ".
		   ...
		   " where account = '$account' and  school_year = '$school_year' ";              //j10410
	...
	$file_path = '/epa_uploads/'.$school_year.'/pub/'.$account.'/';                         //j10410

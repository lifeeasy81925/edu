	...
	<tr>
		<td nowrap="nowrap" colspan="2"><b>※特色一：</b><?=$p1_name;?> &nbsp; <?=($p1_IsContinue == "Y")?"(本年度為第 ".$p1_ContinueYear." 年辦理)":"";?>
			<?
				if($p1_IsContinue == "Y")
				{					
					echo " ●<a href='102_examine_allowance2.php?id=$account' target='_blank'>查看102年度資料</a>";
					
					if($p1_ContinueYear > 1)
						echo " ●<a href='101_examine_allowance3.php?id=$account' target='_blank'>查看101年度資料</a>";
				}
			?>
		</td>
	</tr>

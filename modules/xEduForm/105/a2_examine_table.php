...
<?
	...
	while($row = mysql_fetch_array($result))
	{
		...
		if($s_total_money > 0 && in_array($a_num,$applied_ary) && in_array($a_num,$can_apply_ary) && $city_approved == 'Y')
		{
			...
			//echo ($inherit_year == '104')?"<font size=2 color=red>今年度免審</font><br>".get_url($effect_a2_1, $file_path, "<font size=1 color=blue>104年度<br>修正後計畫</font>"):""; 			

			echo ($inherit_year == '104')?"<font size=2 color=red>今年度免審</font><br><a href='../104/effect_view_school_up_02.php?id=".$account."' target='_blank'><font size=1 color=blue>查看104年度<br>修正後計畫</font></a>":"";			

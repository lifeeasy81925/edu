...
<b>補助項目五：發展原住民教育文化特色及充實設備器材</b><br /><br />
...
<?
	...
	while($row = mysql_fetch_array($result))
	{
		...
		if($s_total_money > 0 && in_array($a_num,$applied_ary) && in_array($a_num,$can_apply_ary) && $city_approved == 'Y')
		{
			...
			//echo ($inherit_year == '104')?"<font size=2 color=red>今年度免審</font><br>":"";    //j10407，新增，判別是否沿用，若為104，則為沿用<img src='/edu/images/ok1.jpg' width='18' height='18' >
			//echo ($inherit_year == '104')?"<font size=2 color=red>今年度免審</font><br>".get_url($effect_a5_1, $file_path, "<font size=1 color=blue>104年度<br>修正後計畫</font>"):""; 

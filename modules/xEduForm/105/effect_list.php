...
<a href="/edu/modules/xEduForm/effect_report_city.php">
...
<img src="/edu/images/assignment.png" align="absmiddle" height="20px"> 縣市及學校執行成效資料 / <b><?=$school_year;?>年度 <?=$cityname;?>成效評估填報列表</b>
...
<a href="effect_list.php?ct=<?=$cityname;?>&op=7"><u>補助七</u></a>　
<p>
...
<? if($cityname == "全國"){$cityname = "";}  // 給後面LIKE搜尋全部用 ?>
<?
	//教育部核定金額
	$sql = " select sd.account, sd.schooltype, sd.cityname, sd.district, sd.schoolname, sd.area, sd.getmoney_85to91, sd.traffic_status ".
		   ...
		   "      , a5.inherit_year as a5_inherit_year ".		 //j104
		   "      , a5.edu_p2_money as a5_edu_p2_money ".
		   ...
		   "      , sun_ly.a2_1 as a2_1_ly, sun_ly.a2_2 as a2_2_ly, sun_ly.a5_1 as a5_1_ly, sun_ly.a5_2 as a5_2_ly ".
		   "      , sun_ly.effect_a2_1 as effect_a2_1_ly, sun_ly.effect_a2_2 as effect_a2_2_ly, sun_ly.effect_a2_3 as effect_a2_3_ly".
		   "      , sun_ly.effect_a5_1 as effect_a5_1_ly, sun_ly.effect_a5_2 as effect_a5_2_ly, sun_ly.effect_a5_3 as effect_a5_3_ly".
	...
	while($row = mysql_fetch_array($result))
	{
		...
		$effect_a5_1_ly = $row['effect_a5_1_ly'];
		$effect_a5_2_ly = $row['effect_a5_2_ly'];
		$effect_a5_3_ly = $row['effect_a5_3_ly'];
		...
		if($sum_edu_total_money > 0)
		{
			...
			if($a3_edu_total_money > 0 && ($show_allowance == 3 || $show_allowance == "")) //選擇補助3或全部才顯示
			{
				?>
					<tr>
						<td align="center">
							三<br>、<br>修<br>繕<br>離<br>島<br>或<br>偏<br>遠<br>地<br>區<br>師<br>生<br>宿<br>舍<br>
						</td>
						<td>
							<table>
								<tr>
				...
				?>
					<tr>
						...
						<td>
							<table>
								<tr>
									<td valign="top" width="30%">
										...
										<font color="#8000FA">原計畫：</font><p>
										<?
											echo get_url($a4_1, $file_path, "1.實施計畫")."<p>";
										?>
									</td>
									<td valign="top" width="30%">
										<p>
							...
							<font color="#8000FA">複審意見：</font><p>
							<? echo "　"; ?>
							<textarea style="width:80%; height:50px;" readonly><?=$a4_edu_desc;?></textarea><p>
						</td>
					</tr>
				<?
			}
					...
					<tr>
						...
						<td>
							<table>
								<tr>
									<td valign="top" width="30%">
										...
										<font color="#8000FA">原計畫：</font><p>
										<?
											if($a5_inherit_year == 104)
											{
												echo "<a href='".$file_path3.$a5_1_ly."' target='_new'>沿用104年特色一</a> ".img_yes()."<p>";
												if($a5_edu_p2_money > 0)
												{
													echo "<a href='".$file_path3.$a5_2_ly."' target='_new'>沿用104年特色二</a> ".img_yes()."<p>";
												}
											}
											else
											{
												echo get_url($a5_1, $file_path, "特色一")."<p>";
												if($a5_edu_p2_money > 0)
												{
													echo get_url($a5_2, $file_path, "特色二")."<p>";
												}
											}
										?>
									</td>
							...
							<?
								...
								{
									echo "　特色一：<br>";
									echo "　<textarea style='width:80%; height:50px;' readonly>" . $a5_edu_desc . "</textarea><p>";
								}
								if($a5_s_p2_money > 0) //有錢才顯示
								{
									echo "　特色二：<br>";
									echo "　<textarea style='width:80%; height:50px;' readonly>" . $a5_edu_desc_p2 . "</textarea><p>";
								}
							?>
						</td>
					</tr>
				...
				?>
					<tr>
						...
						<td>
							<table>
								<tr>
									<td valign="top" width="30%">
										...
										<font color="#8000FA">原計畫：</font><p>
										<?
											echo get_url($a7_1, $file_path, "1.實施計畫")."<p>";
										?>
									</td>
									<td valign="top" width="30%">
										<p>
										<font color="#8000FA">修正後計畫：</font><p>
										<?
											echo get_url($effect_a7_1, $file_path, "1.修正後計畫")."<p>";
											echo get_url($effect_a7_2, $file_path, "2.經費概算表")."<p>";
											echo get_url($effect_a7_3, $file_path, "3.成果照片")."<p>";
										?>
									</td>
									<td valign="top">
										<p>
										<font color="#8000FA">成效評估：</font><p>
										複審金額：<?=number_format($a7_edu_total_money);?>元<p>
										執行金額：<?=number_format($a7_execute_money); ?>元<p>
										執行成效：<?=$a7_percnet."%"; ?><p>
							...
							<font color="#8000FA">複審意見：</font><p>
							<? echo "　"; ?>
							<textarea style="width:80%; height:50px;" readonly><?=$a7_edu_desc;?></textarea><p>
						</td>
					</tr>
				<?
			}

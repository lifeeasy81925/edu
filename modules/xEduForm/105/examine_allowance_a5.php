<?php
	...
	$sql2 = " select sun_ly.point2 as point2_ly, sun_ly.a5_1 as a5_1_ly, sun_ly.a5_2 as a5_2_ly  ".
	...
	<tr>
		...
		，目標學生佔參加學生 <?=$s_p1_per;?>%。
			<?
				if($p1_IsContinue == "Y")
				{					
					echo " <br />●<a href='104_examine_allowance_a5.php?id=$account' target='_blank'>查看".($school_year-1)."年度資料</a>";
					
					if($p1_ContinueYear > 1)
						echo " ●<a href='103_examine_allowance_a5.php?id=$account' target='_blank'>查看".($school_year-2)."年度資料</a>";
...
<? if($inherit_year == '' || $inherit_year == '104_change' ) echo "<!--"; ?>
		...
		<td nowrap="nowrap">
			特色一實施計畫：<? echo ($a5_1_ly == ''?"<font color=red>未上傳</font>":"<font color=blue>已上傳</font>，檔名：<a href='".$file_path3.$a5_1_ly."' target='_new'>$a5_1_ly</a>");?><br />
			<div style="display:<?=($a5_2_ly == '')?'none':''; //空白就不顯示?>;">
			特色二實施計畫：<? echo ($a5_2_ly == ''?"<font color=red>未上傳</font>":"<font color=blue>已上傳</font>，檔名：<a href='".$file_path3.$a5_2_ly."' target='_new'>$a5_2_ly</a>");?><br />
			</div>
			<div style="display:<?=($page3_warning == '')?'none':''; //空白就不顯示?>;">

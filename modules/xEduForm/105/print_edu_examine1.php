...
【<?=$cityname?> 政府申請教育部<?=($school_year);?>年度推動教育部推動教育優先區計畫縣市複審結果列表】
...
<?	
	...
	$sql = " select sd.account, sd.schooltype, sd.cityname, sd.district, sd.schoolname, sd.area, sd.getmoney_85to91, sd.traffic_status ".
		   ...
		   "      , a3.edu_total_money as a3_edu_total_money ".  //j104
	...
	while($row = mysql_fetch_array($result))
	{
		...
		$a3_edu_total_money = $row['a3_edu_total_money'];  //
		...
		for($i = 0;$i < 22;$i++) //縣市共22個
		{
			...
			if($apply_money > 0 && $cityname == $city_ary[$i])
			{
				...
				if ($a3_edu_total_money > 0){
				$a3_edu_p1_current_cnt_ary[$i] += $a3_edu_p1_current_cnt;//補三-教師宿舍-經常-項
				$a3_edu_p1_current_money_ary[$i] += $a3_edu_p1_current_money;//補三-教師宿舍-經常-元
				$a3_edu_p1_capital_cnt_ary[$i] += $a3_edu_p1_capital_cnt;//補三-教師宿舍-資本-項
				$a3_edu_p1_capital_money_ary[$i] += $a3_edu_p1_capital_money;//補三-教師宿舍-資本-元
				$a3_p1_total_money_ary[$i] = $a3_edu_p1_current_money_ary[$i] + $a3_edu_p1_capital_money_ary[$i];//補三-教師宿舍-總和
				$a3_edu_p2_current_cnt_ary[$i] += $a3_edu_p2_current_cnt;//補三-學生宿舍-經常-項
				$a3_edu_p2_current_money_ary[$i] += $a3_edu_p2_current_money;//補三-學生宿舍-經常-元
				$a3_edu_p2_capital_cnt_ary[$i] += $a3_edu_p2_capital_cnt;//補三-學生宿舍-資本-項
				$a3_edu_p2_capital_money_ary[$i] += $a3_edu_p2_capital_money;//補三-學生宿舍-資本-元
				$a3_p2_total_money_ary[$i] = $a3_edu_p2_current_money_ary[$i] + $a3_edu_p2_capital_money_ary[$i];//補三-學生宿舍-總和
				$a3_total_money_ary[$i] = $a3_p1_total_money_ary[$i] + $a3_p2_total_money_ary[$i];//補三-總和
				}
				
				
				$a4_edu_p1_current_money_ary[$i] += $a4_edu_p1_current_money;//補四經常
				$a4_edu_p1_capital_money_ary[$i] += $a4_edu_p1_capital_money;//補四資本
				$a4_total_money_ary[$i] = $a4_edu_p1_current_money_ary[$i] + $a4_edu_p1_capital_money_ary[$i];
				
				$a5_current_money_ary[$i] += $a5_edu_p1_current_money + $a5_edu_p2_current_money;//補五經常
				$a5_capital_money_ary[$i] += $a5_edu_p1_capital_money + $a5_edu_p2_capital_money;//補五資本
				$a5_total_money_ary[$i] = $a5_current_money_ary[$i] + $a5_capital_money_ary[$i];
				
				$a6_edu_money_1[$i] += ($a6_item == '租車費')?$a6_edu_money:0;
				$a6_edu_money_2[$i] += ($a6_item == '交通費')?$a6_edu_money:0;
				$a6_edu_money_3[$i] += ($a6_item == '購置交通車')?$a6_edu_money:0;
				$a6_total_money_ary[$i] = $a6_edu_money_1[$i] + $a6_edu_money_2[$i] + $a6_edu_money_3[$i];
				
				$a7_edu_p1_current_money_ary[$i] += $a7_edu_p1_current_money;//補七修建
				$a7_edu_p1_capital_money_ary[$i] += $a7_edu_p1_capital_money;//補七設備
				$a7_total_money_ary[$i] = $a7_edu_p1_current_money_ary[$i] + $a7_edu_p1_capital_money_ary[$i];
	...
	for($i = 0;$i < 22;$i++) //縣市共22個
	{
		?>
			<tr>
				...
				<td align="right"><?=number_format($a3_edu_p1_current_cnt_ary[$i]); //補三-教師宿舍-經常-項?></td>
				<td align="right"><?=number_format($a3_edu_p1_current_money_ary[$i]); //補三-教師宿舍-經常-元?></td>
				<td align="right"><?=number_format($a3_edu_p1_capital_cnt_ary[$i]); //補三-教師宿舍-資本-項?></td>
				<td align="right"><?=number_format($a3_edu_p1_capital_money_ary[$i]); //補三-教師宿舍-資本-元?></td>
				<td align="right"><?=number_format($a3_p1_total_money_ary[$i]); //補三-教師宿舍-總和?></td>
				<td align="right"><?=number_format($a3_edu_p2_current_cnt_ary[$i]); //補三-學生宿舍-經常-項?></td>
				<td align="right"><?=number_format($a3_edu_p2_current_money_ary[$i]); //補三-學生宿舍-經常-元?></td>
				<td align="right"><?=number_format($a3_edu_p2_capital_cnt_ary[$i]); //補三-學生宿舍-資本-項?></td>
				<td align="right"><?=number_format($a3_edu_p2_capital_money_ary[$i]); //補三-學生宿舍-資本-元?></td>
				...
				<td align="right"><?=number_format($a4_edu_p1_current_money_ary[$i]); //補四經常?></td>
				<td align="right"><?=number_format($a4_edu_p1_capital_money_ary[$i]); //補四資本?></td>
				...
				<td align="right"><?=number_format($a6_edu_money_1[$i]); //補六租車費?></td>
				<td align="right"><?=number_format($a6_edu_money_2[$i]); //補六交通費?></td>
				<td align="right"><?=number_format($a6_edu_money_3[$i]); //補六購置交通車?></td>
				<td align="right" bgcolor="#CCFFCC"><?=number_format($a6_total_money_ary[$i]);?></td>
				<td align="right"><?=number_format($a7_edu_p1_current_money_ary[$i]); //補七修建?></td>
				<td align="right"><?=number_format($a7_edu_p1_capital_money_ary[$i]); //補七設備?></td>
	...
	for($i = 0;$i < 22;$i++) //縣市共22個
	{
		...
		$sum_a3_edu_p1_current_cnt += $a3_edu_p1_current_cnt_ary[$i];//補三-教師宿舍-經常-項
		$sum_a3_edu_p1_current_money += $a3_edu_p1_current_money_ary[$i];//補三-教師宿舍-經常-元
		$sum_a3_edu_p1_capital_cnt += $a3_edu_p1_capital_cnt_ary[$i];//補三-教師宿舍-資本-項
		$sum_a3_edu_p1_capital_money += $a3_edu_p1_capital_money_ary[$i];//補三-教師宿舍-資本-元
		$sum_a3_p1_total_money = $sum_a3_edu_p1_current_money + $sum_a3_edu_p1_capital_money;//補三-教師宿舍-總和
		$sum_a3_edu_p2_current_cnt += $a3_edu_p2_current_cnt_ary[$i];//補三-學生宿舍-經常-項
		$sum_a3_edu_p2_current_money += $a3_edu_p2_current_money_ary[$i];//補三-學生宿舍-經常-元
		$sum_a3_edu_p2_capital_cnt += $a3_edu_p2_capital_cnt_ary[$i];//補三-學生宿舍-資本-項
		$sum_a3_edu_p2_capital_money += $a3_edu_p2_capital_money_ary[$i];//補三-學生宿舍-資本-元
		$sum_a3_p2_total_money = $sum_a3_edu_p2_current_money + $sum_a3_edu_p2_capital_money;//補三-學生宿舍-總和
		$sum_a3_total_money = $sum_a3_p1_total_money + $sum_a3_p2_total_money;//補三-總和
		
		$sum_a4_edu_p1_current_money += $a4_edu_p1_current_money_ary[$i];//補四經常
		$sum_a4_edu_p1_capital_money += $a4_edu_p1_capital_money_ary[$i];//補四資本
		$sum_a4_total_money = $sum_a4_edu_p1_current_money + $sum_a4_edu_p1_capital_money;
		...
		$sum_a6_edu_money_1 += $a6_edu_money_1[$i];
		$sum_a6_edu_money_2 += $a6_edu_money_2[$i];
		$sum_a6_edu_money_3 += $a6_edu_money_3[$i];
		$sum_a6_total_money = $sum_a6_edu_money_1 + $sum_a6_edu_money_2 + $sum_a6_edu_money_3;
		
		$sum_a7_edu_p1_current_money += $a7_edu_p1_current_money_ary[$i];//補七修建
		$sum_a7_edu_p1_capital_money += $a7_edu_p1_capital_money_ary[$i];//補七設備
		$sum_a7_total_money = $sum_a7_edu_p1_current_money + $sum_a7_edu_p1_capital_money;
...
?>
	...
	<tr>
		...
		<td align="right"><div align="right"><?=number_format($sum_a3_edu_p1_current_cnt);?></td>
		<td align="right"><div align="right"><?=number_format($sum_a3_edu_p1_current_money);?></td>
		<td align="right"><div align="right"><?=number_format($sum_a3_edu_p1_capital_cnt);?></td>
		...
		<td align="right"><div align="right"><?=number_format($sum_a3_edu_p2_current_cnt);?></td>
		<td align="right"><div align="right"><?=number_format($sum_a3_edu_p2_current_money);?></td>

		<td align="right"><div align="right"><?=number_format($sum_a3_edu_p2_capital_cnt);?></td>
		<td align="right"><div align="right"><?=number_format($sum_a3_edu_p2_capital_money);?></td>
		...
		<td align="right"><div align="right"><?=number_format($sum_a4_edu_p1_current_money);?></td>
		<td align="right"><div align="right"><?=number_format($sum_a4_edu_p1_capital_money);?></td>
		...
		<td align="right"><div align="right"><?=number_format($sum_a6_edu_money_1);?></td>
		<td align="right"><div align="right"><?=number_format($sum_a6_edu_money_2);?></td>
		<td align="right"><div align="right"><?=number_format($sum_a6_edu_money_3);?></td>
		<td align="right" bgcolor="#CCFFCC"><div align="right"><?=number_format($sum_a6_total_money);?></td>
		<td align="right"><div align="right"><?=number_format($sum_a7_edu_p1_current_money);?></td>
		<td align="right"><div align="right"><?=number_format($sum_a7_edu_p1_capital_money);?></td>

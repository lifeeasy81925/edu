...
<?
	...
	while($row = mysql_fetch_array($result))
	{
		...
		//差額
		$diff_total_money = $edu_total_money - $city_total_money; 
		...
		switch($a_num)
		{
			case "a1":
				...
				//差額
				$diff_p1_money = $edu_p1_money - $city_p1_money;
				$diff_p2_money = $edu_p2_money - $city_p2_money;
				...
				if($s_total_money > 0)
				{
					...
					?>
						<tr>
							...
							<td align='right' bgcolor="#66FF99"><?=number_format($city_total_money);?></td>
							...
							<td align='right' bgcolor="#FF9933"><?=number_format($edu_total_money);?></td>
			...
			case "a2":
				...
				//差額
				$diff_p1_current_money = $edu_p1_current_money - $city_p1_current_money;
				$diff_p1_capital_money = $edu_p1_capital_money - $city_p1_capital_money;
				$diff_p2_current_money = $edu_p2_current_money - $city_p2_current_money;
				$diff_p2_capital_money = $edu_p2_capital_money - $city_p2_capital_money;
				...
				if($s_total_money > 0)
				{
					...
					?>
						<tr>
							...
							<td align='left'>
								<?
									echo ($edu_desc != '')?$school_year."年特色一：".$edu_desc."<br />":"";
									echo ($edu_desc_p2 != '')?$school_year."年特色二：".$edu_desc_p2."<br />":"";
									/*
									echo ($edu_desc != '')?$school_year."年特色一：".$edu_desc."<br />":"";
									echo ($edu_desc_ny1 != '')?($school_year+1)."年特色一：".$edu_desc_ny1."<br />":"";
									echo ($edu_desc_ny2 != '')?($school_year+2)."年特色一：".$edu_desc_ny2."<br />":"";
									echo ($edu_desc_p2 != '')?$school_year."年特色二：".$edu_desc_p2."<br />":"";
									echo ($edu_desc_ny1_p2 != '')?($school_year+1)."年特色二：".$edu_desc_ny1_p2."<br />":"";
									echo ($edu_desc_ny2_p2 != '')?($school_year+2)."年特色二：".$edu_desc_ny2_p2."<br />":"";*/
								?>
							</td>
						</tr>
					<?
			...
			case "a6":
				...
				$diff_money = $edu_money - $city_money;
				...
				$sum_diff_money_1 = ($sum_edu_money_1 - $sum_city_money_1);
				$sum_diff_money_2 = ($sum_edu_money_2 - $sum_city_money_2);
				$sum_diff_money_3 = ($sum_edu_money_3 - $sum_city_money_3);
				...
				if($s_total_money > 0)
				{
					...
					?>
						<tr>
							...
							<td align='right' bgcolor="#FF9933"><?=number_format($edu_total_money);?></td>
							<td align='left'><?=$edu_desc;?><br /><?=$edu_desc_p2;?></td>
						</tr>
					<?
				}
				//補六資料
		...
		case "a1":
			?>
					<tr>
						...
						<td align='right' bgcolor="#66FF99"><?=number_format($sum_city_p1_money);?></td>
						<td align='right' bgcolor="#66FF99"><?=number_format($sum_city_p2_money);?></td>
						<td align='right' bgcolor="#66FF99"><?=number_format($sum_city_total_money);?></td>
						...
						<td align='right' bgcolor="#FF9933"><?=number_format($sum_edu_p1_money);?></td>
						<td align='right' bgcolor="#FF9933"><?=number_format($sum_edu_p2_money);?></td>
						<td align='right' bgcolor="#FF9933"><?=number_format($sum_edu_total_money);?></td>
		...
		case "a2":
			?>
					<tr>
						<td colspan="2" align="center">合計</td>
						<td align="center"><?=$serial;?>校</td>
						<td align="right" bgcolor="#66FF99"><? echo number_format($sum_city_current_money); ?></td>
						<td align="right" bgcolor="#66FF99"><? echo number_format($sum_city_capital_money); ?></td>
						<td align="right" bgcolor="#66FF99"><? echo number_format($sum_city_total_money); ?></td>
						...
						<td align="right" bgcolor="#FF9933"><? echo number_format($sum_edu_current_money); ?></td>
						<td align="right" bgcolor="#FF9933"><? echo number_format($sum_edu_capital_money); ?></td>
						<td align="right" bgcolor="#FF9933"><? echo number_format($sum_edu_total_money); ?></td>
						<td bgcolor="#FF9933">&nbsp;</td>
					</tr>
				</table>
			<?
		...
		case "a6":
			?>
					<tr>
						<td colspan="2" align="center">合計</td>
						<td align="center"><?=$serial;?>校</td>
							<td align='right' bgcolor="#66FF99"><?=number_format($sum_city_money_1);?></td>
							<td align='right' bgcolor="#66FF99"><?=number_format($sum_city_money_2);?></td>
							<td align='right' bgcolor="#66FF99"><?=number_format($sum_city_money_3);?></td>
							<td align='right' bgcolor="#66FF99"><?=number_format($sum_city_total_money);?></td>
							<td align='right' bgcolor="#FFCC66"><?=number_format($sum_diff_money_1);?></td>
							<td align='right' bgcolor="#FFCC66"><?=number_format($sum_diff_money_2);?></td>
							<td align='right' bgcolor="#FFCC66"><?=number_format($sum_diff_money_3);?></td>
							<td align='right' bgcolor="#FFCC66"><?=number_format($sum_diff_total_money);?></td>
							<td align='right' bgcolor="#FF9933"><?=number_format($sum_edu_money_1);?></td>
							<td align='right' bgcolor="#FF9933"><?=number_format($sum_edu_money_2);?></td>
							<td align='right' bgcolor="#FF9933"><?=number_format($sum_edu_money_3);?></td>
							<td align='right' bgcolor="#FF9933"><?=number_format($sum_edu_total_money);?></td>
						<td bgcolor="#FF9933">&nbsp;</td>
					</tr>
				</table>
...
<a href="print_suggest.php?id=7">補助七</a>&nbsp;
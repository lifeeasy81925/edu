			...
			while($row = mysql_fetch_array($result))
			{
				...
				if($s_total_money > 0 && in_array($a_num,$applied_ary) && in_array($a_num,$can_apply_ary) && $city_approved == 'Y')
				{
					...
					echo "<tr height='40px'>";
						...
						echo "<td align='right' nowrap='nowrap' nowrap='nowrap'>"."$ ".number_format($s_total_money)."</td>";     // 申請金額
						echo "<td align='right' nowrap='nowrap' nowrap='nowrap'>"."$ ".number_format($city_total_money)."</td>";  // 初審金額
						echo "<td align='right' nowrap='nowrap' nowrap='nowrap'>"."$ ".number_format($edu_total_money)."</td>";   // 複審金額

		...
		if($sum_edu_total_money > 0)
		{
			...
			if($a3_edu_total_money > 0 && ($show_allowance == 4 || $show_allowance == "")) //選擇補助4或全部才顯示
			{
				?>
					<tr>
						<td align="center">
							三<br>、<br>充<br>實<br>學<br>校<br>基<br>本<br>教<br>學<br>設<br>備<br>
						</td>
						<td>
							<table>
								<tr>
			...
			if($a4_edu_total_money > 0 && ($show_allowance == 5 || $show_allowance == "")) //選擇補助5或全部才顯示
			{
				?>
					<tr>
						<td align="center">
							四<br>、<br>發<br>展<br>原<br>住<br>民<br>教<br>育<br>文<br>化<br>特<br>色<br>及<br>充<br>實<br>設<br>備<br>器<br>材<br>
						</td>
						<td>
							<table>
								<tr>
			...
			if($a5_edu_total_money > 0 && ($show_allowance == 6 || $show_allowance == "")) //選擇補助6或全部才顯示
			{
				?>
					<tr>
						<td align="center">
							五<br>、<br>補<br>助<br>交<br>通<br>不<br>便<br>地<br>區<br>學<br>校<br>交<br>通<br>車<br>
						</td>
						<td>
							<table>
								<tr>
			...
			if($a6_edu_total_money > 0 && ($show_allowance == 7 || $show_allowance == "")) //選擇補助7或全部才顯示
			{
				?>
					<tr>
						<td align="center">
							六<br>、<br>整<br>修<br>學<br>校<br>社<br>區<br>化<br>活<br>動<br>場<br>所<br>
						</td>
						<td>
							<table>
								<tr>

...
<table width="100%" border="1" cellspacing="0" cellpadding="0">
	...
	<tr>
		...
		補助學校發展教育特色</td>
		<td colspan="3" align="center" bgcolor="#CCFFFF">補助項目三<br />
		充實學校基本教學設備</td>
		<td colspan="3" align="center" bgcolor="#FFFFCC">補助項目四<br />
		發展原住民教育文化特色及充實設備器材</td>
		<td colspan="3" align="center" bgcolor="#CCFFFF">補助項目五<br />
		補助交通不便地區學校交通車</td>
		<td colspan="3" align="center" bgcolor="#FFFFCC">補助項目六<br />
		整修學校社區化活動場所</td>

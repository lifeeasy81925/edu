...
<?php
	...
	$edu_p1_money = $_POST['edu_p1_money'];			//p1元、場
	$edu_p1_times = $_POST['edu_p1_times'];
	
	$edu_p2_money = $_POST['edu_p2_money'];			//p2元、場
	$edu_p2_people = $_POST['edu_p2_people'];
	...
	$sql = " update $table_name set edu_total_money	= '$edu_total_money' ". 	//新增資料進資料庫語法  
		   "                      , edu_p1_money  	= '$edu_p1_money' ".
		   "                      , edu_p1_times  	= '$edu_p1_times' ".
		   "                      , edu_p2_money  	= '$edu_p2_money' ".
		   "                      , edu_p2_people 	= '$edu_p2_people' ".
		   "                      , edu_desc		= '$edu_desc' ".
	...
	if(mysql_query($sql))	//成功與否，做例外處理
	{
		...
		echo "</tr>";
		echo "</table>";
		echo "<meta http-equiv=REFRESH CONTENT=2;url=a1_examine_table.php?id=$audit_city&a=$a>";
	}
	else
	{
		echo "新增失敗。";

...
<div id="print_content">
	...
	<table width="900px" align="center" border="1" cellpadding="5" cellspacing="0">
		...
		<tr height="40px">
			...
			<td rowspan="2">推展親職教育活動<br><?=($a1_money > 0)?"<a href='edu_funds.php?op=1&acc=".$username."' target='_blank'>(開啟審核經費表)</a>":"";?></td>
		...
		<tr height="40px">
			...
			<td rowspan="4">補助學校發展教育特色<br><?=($a2_money > 0)?"<a href='edu_funds.php?op=2&acc=".$username."' target='_blank'>(開啟審核經費表)</a>":"";?></td>
		...
		<tr height="40px">
			...
			<td rowspan="2">充實學校基本教學設備<br><?=($a3_money > 0)?"<a href='edu_funds.php?op=3&acc=".$username."' target='_blank'>(開啟審核經費表)</a>":"";?></td>
		...
		<tr height="40px">
			...
			<td rowspan="4">發展原住民教育文化特色及充實設備器材<br><?=($a4_money > 0)?"<a href='edu_funds.php?op=4&acc=".$username."' target='_blank'>(開啟審核經費表)</a>":"";?></td>
		...
		<tr height="40px">
			...
			<td rowspan="3">補助交通不便學校交通車<br><?=($a5_money > 0)?"<a href='edu_funds.php?op=5&acc=".$username."' target='_blank'>(開啟審核經費表)</a>":"";?></td>
		...
		<tr height="40px">
			...
			<td rowspan="2">整修學校社區化活動場所<br><?=($a6_money > 0)?"<a href='edu_funds.php?op=6&acc=".$username."' target='_blank'>(開啟審核經費表)</a>":"";?></td>

				...
				if($s_total_money > 0)
				{
					...
					?>
						<tr>
							...
							<td align='left'>
								<?
									echo ($city_desc != '')?$school_year."年特色一：".$city_desc."<br />":"";
									echo ($city_desc_p2 != '')?$school_year."年特色二：".$city_desc_p2."<br />":"";
									/*
									echo ($city_desc != '')?$school_year."年特色一：".$city_desc."<br />":"";
									echo ($city_desc_ny1 != '')?($school_year+1)."年特色一：".$city_desc_ny1."<br />":"";
									echo ($city_desc_ny2 != '')?($school_year+2)."年特色一：".$city_desc_ny2."<br />":"";
									echo ($city_desc_p2 != '')?$school_year."年特色二：".$city_desc_p2."<br />":"";
									echo ($city_desc_ny1_p2 != '')?($school_year+1)."年特色二：".$city_desc_ny1_p2."<br />":"";
									echo ($city_desc_ny2_p2 != '')?($school_year+2)."年特色二：".$city_desc_ny2_p2."<br />":"";*/
								?>
							</td>
						</tr>
					<?

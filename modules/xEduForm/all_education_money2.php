...
<table border="1" cellpadding="0" cellspacing="0">
	...
	<tr>
		...
		<td colspan="3" align="center" bgcolor="#00CCCC">綜合球場</td>
  ...
  //補助金額-國小			
	...
	echo "</td>";
	echo "<td>"."<div align='right'>";
	echo number_format($a7_3_person);//a7_3 座
	echo "</td>";	
	echo "<td bgcolor='#FFFFCC'>"."<div align='right'>";
  ...
  ?>
  <tr>
    <td width="110" height="46" align="center">合計</td>

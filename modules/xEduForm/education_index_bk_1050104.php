...
<table border="0">
	<tr>
		<td style="text-align:center; background-color:#FC9;">105年度 審查區</td>
	</tr>
	<tr>
		<td><img src="/edu/images/dot_02.gif" align="absmiddle" /><a href="105/allowance_examine.php" target="_self">105審核補助項目</a><p></td>
	</tr>
	<!--
	<tr>
		<td><img src="/edu/images/dot_02.gif" align="absmiddle" /><a href="104/allowance_examine.php" target="_self">104審核補助項目</a></td>
	</tr>
	-->
</table>
<p>
<table border="0">
	<tr>
		<td style="text-align:center; background-color:#FC9;">105年度 報表資料列印區(全國性報表輸出時間約1分鐘)</td>
	</tr>
	<tr>
		<td><img src="/edu/images/dot_02.gif" align="absmiddle" /><a href="105/print_city_examine3.php" target="_blank">1.縣市申請金額列表</a></td>
	</tr>
	<tr>
		<td><img src="/edu/images/dot_02.gif" align="absmiddle" /><a href="105/print_city_examine.php" target="_blank">2.縣市初審結果列表</a></td>
	</tr>
	<tr>
		<td><img src="/edu/images/dot_02.gif" align="absmiddle" /><a href="105/print_city_examine2.php" target="_blank">3.各校指標資料查詢(全國)</a></td>
	</tr>
	<tr>
		<td><img src="/edu/images/dot_02.gif" align="absmiddle" /><a href="105/print_edu_examine1.php" target="_blank">4.教育部審核結果(各縣市)</a></td>
	</tr>
	<tr>
		<td><img src="/edu/images/dot_02.gif" align="absmiddle" /><a href="105/print_edu_examine2.php" target="_blank">5.教育部審核結果(各學校)</a></td>
	</tr>
	<tr>
		<td><img src="/edu/images/dot_02.gif" align="absmiddle" /><a href="105/print_edu_examine5.php" target="_blank">6.申請金額縣市列表(依資本門/經常門劃分)</a></td>
	</tr>
	<tr>
		<td><img src="/edu/images/dot_02.gif" align="absmiddle" /><a href="105/print_edu_examine4.php" target="_blank">7.初審結果縣市列表(依資本門/經常門劃分)</a></td>
	</tr>
	<tr>
		<td><img src="/edu/images/dot_02.gif" align="absmiddle" /><a href="105/print_edu_examine3.php" target="_blank">8.複審結果縣市列表(依資本門/經常門劃分)</a></td>
	</tr>
	<tr>
		<td><img src="/edu/images/dot_02.gif" align="absmiddle" />9.依補助項目查詢初審結果列表
			...
			<input Type="Button" id="btn_105_3" name="btn_105_3" value="查詢" OnClick="window.open(document.getElementById('opt_105_3').value)"></td>
	</tr>
	<tr>
		<td><img src="/edu/images/dot_02.gif" align="absmiddle" />10.依補助項目查詢複審結果列表
			...
			<input Type="Button" id="btn_105_2" name="btn_105_2" value="查詢" OnClick="window.open(document.getElementById('opt_105_2').value)"></td>
	</tr>
	<tr>
		<td><img src="/edu/images/dot_02.gif" align="absmiddle" /><a href="105/school_update.php" target="_self">11.各校填報及審查狀態查詢</a></td>
	</tr>
	<tr>
		<td><img src="/edu/images/dot_02.gif" align="absmiddle" />12.縣市審核狀態及上傳檔案
			...
			</Select><input Type="Button" id="btn_nopost105" name="btn_nopost105" value="查詢" OnClick="self.location.href=document.getElementById('nopost105').value">
		</td>
	</tr>
...
<img src="/edu/images/dot_03.gif" align="absmiddle" /><a href="effect_report_city.php" target="_self">檢視縣市執行成果報表 (105、104、103年度)</a><br />

<img src="/edu/images/dot_03.gif" align="absmiddle" />105年度各校執行成果填報狀況
<Select id="op105_list" name="op105_list" Size=1>
	<option value="105/effect_list.php?ct=新北市">新北市</option>
	<option value="105/effect_list.php?ct=臺北市">臺北市</option>
	<option value="105/effect_list.php?ct=臺中市">臺中市</option>
    <option value="105/effect_list.php?ct=臺南市">臺南市</option>
    <option value="105/effect_list.php?ct=高雄市">高雄市</option>
    <option value="105/effect_list.php?ct=宜蘭縣">宜蘭縣</option>
    <option value="105/effect_list.php?ct=桃園市">桃園市</option>
    <option value="105/effect_list.php?ct=新竹縣">新竹縣</option>
    <option value="105/effect_list.php?ct=苗栗縣">苗栗縣</option>
    <option value="105/effect_list.php?ct=彰化縣">彰化縣</option>
    <option value="105/effect_list.php?ct=南投縣">南投縣</option>
    <option value="105/effect_list.php?ct=雲林縣">雲林縣</option>
    <option value="105/effect_list.php?ct=嘉義縣">嘉義縣</option>
    <option value="105/effect_list.php?ct=屏東縣">屏東縣</option>
    <option value="105/effect_list.php?ct=臺東縣">臺東縣</option>
    <option value="105/effect_list.php?ct=花蓮縣">花蓮縣</option>
    <option value="105/effect_list.php?ct=澎湖縣">澎湖縣</option>
    <option value="105/effect_list.php?ct=基隆市">基隆市</option>
    <option value="105/effect_list.php?ct=新竹市">新竹市</option>
    <option value="105/effect_list.php?ct=嘉義市">嘉義市</option>
    <option value="105/effect_list.php?ct=金門縣">金門縣</option>
    <option value="105/effect_list.php?ct=連江縣">連江縣</option>
    <option value="105/effect_list.php?ct=全國">全國(需1分鐘)</option>
</Select>
<input Type="Button" id="op105_list" name="op105_list" value="查詢" OnClick="window.open(document.getElementById('op105_list').value)"><br />
...
<Select id="op104_list" name="op104_list" Size=1>
    ...
    <option value="104/effect_list.php?ct=桃園市">桃園市</option>
...
<Select id="op103_list" name="op103_list" Size=1>
    ...
    <option value="103/effect_list.php?ct=桃園市">桃園市</option>
...
{
//教育部特殊權限2
echo '<form action=105/open_school.php method=post name=form>';

...
<table width="100%" border="1" cellspacing="0" cellpadding="0">
  <tr>
    <td height="60" colspan="12" align="center"><strong><font color=blue>教育部100年度推動教育優先區計畫直轄市、縣(市)政府各補助項目執行成果一覽表<br />縣市別：<? echo $cityname;?>　　　　　　　　補助項目：三、補助學校發展教育特色</font></strong></td>
  </tr>
  <tr>
  ...
  <tr>
    <td width="100" align="center" bgcolor="#FFFFCC">其餘</td>
    <td width="100" align="center" bgcolor="#FFFFCC">設備</td>
    <td width="100" align="center" bgcolor="#FFFFCC">合計</td>
    <td width="100" align="center" bgcolor="#FFFFCC">其餘</td>
    <td width="100" align="center" bgcolor="#FFFFCC">設備</td>
    <td width="100" align="center" bgcolor="#FFFFCC">合計</td>
    <td width="40" align="center" bgcolor="#FFFFCC">其餘</td>
    <td width="40" align="center" bgcolor="#FFFFCC">設備</td>

...
<table width="100%" border="1" cellspacing="0" cellpadding="0">
  <tr>
    <td height="60" colspan="18" align="center"><strong><font color=blue>教育部100年度推動教育優先區計畫直轄市、縣(市)政府各補助項目執行成果一覽表<br />縣市別：<? echo $cityname;?>　　　　　　　　補助項目：七、補助原補助交通不便地區學校交通車</font></strong></td>
  </tr>
  <tr>

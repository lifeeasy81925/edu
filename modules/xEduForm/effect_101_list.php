...
<font color="blue"><strong>教育部推動教育優先區計畫101年度 <? echo $cityname; ?> 成效評估填報狀況一覽表</strong></font>
<table width="100%" border="1" cellspacing="0" cellpadding="0">
  <tr>
    ...
    <td align="center" bgcolor="#99CCCC">執行<br />情形</td>
    <td height="40" align="center" bgcolor="#99CCCC">上傳<br />修正後<br />計畫與<br />經費<br /><font color="red">(必填)</font></td>
  </tr>
<?
if ($cityname == "全國"){
...
while($row = mysql_fetch_row($result_school)){
	...
	if($fn_a1 > 1){ 
		...
		echo '<td align="center"><input type="button" value="進入" onclick="location='.'\'effect_101_view_01.php?school='.$school.'\'" /></td>';
		echo '<td align="center"><INPUT TYPE="button" VALUE="進入" onClick="location='.'\'effect_101_view_up_01.php?school='.$school.'\'"></td>';
		echo '</tr>';
	}
	//補二
	if($fn_a2 > 1){ 
		...
		echo '<td align="center">'.$temp.'</td>';
		echo '<td align="center"><input type="button" value="進入" onclick="location='.'\'effect_101_view_02.php?school='.$school.'\'" /></td>';
		echo '<td align="center"><INPUT TYPE="button" VALUE="進入" onClick="location='.'\'effect_101_view_up_02.php?school='.$school.'\'"></td>';
		echo '</tr>';
	}	
	//補三
	if($fn_a3 > 1){ 
		...
		echo '<td align="center">'.$temp.'</td>';
		echo '<td align="center"><input type="button" value="進入" onclick="location='.'\'effect_101_view_03.php?school='.$school.'\'" /></td>';
		echo '<td align="center"><INPUT TYPE="button" VALUE="進入" onClick="location='.'\'effect_101_view_up_03.php?school='.$school.'\'"></td>';
		echo '</tr>';
	}	
	//補四
	if($fn_a4 > 1){ 
		...
		echo '<td align="center">'.$temp.'</td>';
		echo '<td align="center"><input type="button" value="進入" onclick="location='.'\'effect_101_view_04.php?school='.$school.'\'" /></td>';
		echo '<td align="center"><INPUT TYPE="button" VALUE="進入" onClick="location='.'\'effect_101_view_up_04.php?school='.$school.'\'"></td>';
		echo '</tr>';
	}
	//補五
	if($fn_a5 > 1){ 
		...
		echo '<td align="center">'.$temp.'</td>';
		echo '<td align="center"><input type="button" value="進入" onclick="location='.'\'effect_101_view_05.php?school='.$school.'\'" /></td>';
		echo '<td align="center"><INPUT TYPE="button" VALUE="進入" onClick="location='.'\'effect_101_view_up_05.php?school='.$school.'\'"></td>';
		echo '</tr>';
	}
	//補六
	if($fn_a6 > 1){ 
		...
		echo '<td align="center">'.$temp.'</td>';
		echo '<td align="center"><input type="button" value="進入" onclick="location='.'\'effect_101_view_06.php?school='.$school.'\'" /></td>';
		echo '<td align="center"><INPUT TYPE="button" VALUE="進入" onClick="location='.'\'effect_101_view_up_06.php?school='.$school.'\'"></td>';
		echo '</tr>';
	}
	//補七
	if($fn_a7 > 1){ 
		...
		echo '<td align="center">'.$temp.'</td>';
		echo '<td align="center"><input type="button" value="進入" onclick="location='.'\'effect_101_view_07.php?school='.$school.'\'" /></td>';
		echo '<td align="center"><INPUT TYPE="button" VALUE="進入" onClick="location='.'\'effect_101_view_up_07.php?school='.$school.'\'"></td>';
		echo '</tr>';
	}
	//補八
	if($fn_a8 > 1){ 
		...
		echo '<td align="center">'.$temp.'</td>';
		echo '<td align="center"><input type="button" value="進入" onclick="location='.'\'effect_101_view_08.php?school='.$school.'\'" /></td>';
		echo '<td align="center"><INPUT TYPE="button" VALUE="進入" onClick="location='.'\'effect_101_view_up_08.php?school='.$school.'\'"></td>';
		echo '</tr>';
	}
	//單校合計
	if($fn_total > 1){ 

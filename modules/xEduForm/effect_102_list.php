...
<table width="100%" border="1" cellspacing="0" cellpadding="0">
  <tr>
	...
	<td height="40" align="center" bgcolor="#99CCCC">教育部<br />核定經費</td>
  </tr>
<?
	/*##############################################################################
	...
	*/##############################################################################
	...
	$edu_school = " SELECT sd.account, sd.cityname, sd.district, sd.school, se.last ".
				  ...
				  if($cityname != "全國")
					$edu_school .= " where sd.cityname like '$cityname' ";
					
	$edu_school .= " order by sd.type, sd.account ; "; // and sd.account = '014632'測試用
	...
	while($row = mysql_fetch_row($result_school))
	{
		...
		{ 
			...
			echo '<td align="center"><INPUT TYPE="button" VALUE="檢視"></td>';
			echo '</tr>';
		}
		//補二
		if($fn_a2 > 1)

...
<p>
<b>補助項目三：充實學校基本教學設備</b><a href="/edu/modules/xSchoolForm/<?=$school_year;?>/allowance-03.htm" target="_blank">（補助項目說明）</a><p>
　補助原則：<p>
　　● 6 班以下最高補助 10 萬元，7 至 12 班最高補助 15 萬元，13 班以上最高補助 20 萬元。<p>
<p>
<hr>
<p>
...
● 最近三年是否曾獲本項補助：<?=($apply_last3year == 'Y')?"<font color=red>曾受補助，原則上不予補助</font>":'未受補助'?>。<p>
...
　● 應上傳檔案：<p>
	實施計畫：<? echo ($a3_1 == ''?"<font color=red>未上傳</font>":"<font color=blue>已上傳</font>，檔名：<a href='".$file_path.$a3_1."' target='_new'>$a3_1</a>");?><p>
	領域小組會議紀錄：<? echo ($a3_2 == ''?"<font color=red>未上傳</font>":"<font color=blue>已上傳</font>，檔名：<a href='".$file_path.$a3_2."' target='_new'>$a3_2</a>");?><p>

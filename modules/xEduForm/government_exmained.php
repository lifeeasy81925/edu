...
while($row = mysql_fetch_row($result_school))
		...
		$total = $a1_1+$a1_2+$a2_1+$a2_2+$a3+$a4_1+$a4_2+$a5+$a6+$a7_1+$a7_2+$a7_3+$a8_1+$a8_2+$a8_3;
?>
...
<div align="left"><span class="style1">教育部100年度教育優先區計畫補助項目經費需求彙整表</span><span class="style3"><br>
<table width="1390" border="3" bordercolor="#000000">
  <tr>
    <td height="76" colspan="4" class="style3">教育優先區:學校名稱</td>
  ...
  <tr>
    ...
    <td class="style3"><div align="right"><span class="style7"></span><? echo $a1_1?></div></td>
    <td width="140" class="style3"><div align="right"><? echo $lec_money;?></div></td>
    <td rowspan="2" class="style3"><? echo $other;?></td>
    <td class="style3"><div align="right"><? echo $lec_money_1;?></div></td>
    <td rowspan="2" class="style3"><? echo $other_1;?></td>
  </tr>
  <tr>
    <td height="36" colspan="2" class="style3">目標學生家庭訪視輔導</td>
    <td class="style3"><div align="right"><span class="style7"></span><? echo $a1_2?></div></td>
    <td class="style3"><div align="right"><? echo $fam_money;?></div></td>
    <td class="style3"><div align="right"><? echo $fam_money_1;?></div></td>
  </tr>
    <?
  	if($class == '1' ){
  ...
  <tr>
    ...
    <td class="style3"><div align="right"><span class="style7"></span><? echo $a2_1?></div></td>
    <td class="style3"><div align="right"><? echo $assist;?></div></td>
    <td width="150" rowspan="3" class="style3"><? echo $other;?></td>
    <td width="133" class="style3"><div align="right"><? echo $assist_1;?></div></td>
    <td rowspan="3" class="style3"><? echo $other_1;?></td>
  </tr>
  <tr>
    <td height="37" colspan="2" class="style3">寒暑假學習輔導</td>
    <td class="style3"><div align="right"><span class="style7"></span><? echo $a2_2?></div></td>
    <td class="style3"><div align="right"><? echo $nightassist;?></div></td>
    <td width="133" class="style3"><div align="right"><? echo $nightassist_1;?></div></td>
  </tr>
  <tr>
    <td height="43" colspan="2" class="style3">住校生夜間學校輔導</td>
    <td class="style3"><div align="right"><span class="style7"></span><? echo $a2_3?></div></td>
    <td class="style3"><div align="right"><? echo $holidayassist;?></div></td>
    <td width="133" class="style3"><div align="right"><? echo $holidayassist_1;?></div></td>
  </tr>
      <?
  	if($class == '1' ){
  ...
  <tr>
    ...
    <td class="style3"><div align="right"><span class="style7"></span><? echo $a3?></div></td>
    <td class="style3"><div align="right"><? echo $money+$money_1+$money_2;?></div></td>
    <td class="style3"><? echo $other;?></td>
    <td class="style3"><div align="right"><? echo $money_1+$money_1_1+$money_2_1;?></div></td>
  ...
  ?>
   <? 
  	$total_examine = $total_examine+$money+$money_1;
 	$total_examine_1 = $total_examine_1+$money_1+$money_1_1;
  ?>
  <tr>
    <td rowspan="2" class="style3"><div align="center">4.</div>      <div align="center"></div>      <div align="center"></div>      <div align="center"></div></td>
    <td rowspan="2" class="style3">修繕離島或偏遠地區師生宿舍</td>
    <td width="119" rowspan="2" class="style3">教師、學生宿舍</td>
    <td width="175" height="35" class="style3">修繕</td>
    <td class="style3"><div align="right"><span class="style7"></span><? echo $a4_1?></div></td>
    <td class="style3"><div align="right"><? echo $money;?></div></td>
    <td rowspan="2" class="style3"><? echo $other;?></td>
    <td class="style3"><div align="right"><? echo $money_1;?></div></td>
    <td rowspan="2" class="style3"><? echo $other_1;?></td>
  </tr>
  
  <tr>
    <td height="34" class="style3">充實設備</td>
    <td class="style3"><div align="right"><span class="style7"></span><? echo $a4_2?></div></td>
    <td class="style3"><div align="right"><? echo $money_1;?></div></td>
    <td class="style3"><div align="right"><? echo $money_1_1;?></div></td>
  </tr>
   <?
  	if($class == '1' ){
  ...
  <tr>
    ...
    <td class="style3"><div align="right"><span class="style7"></span><? echo $a5?></div></td>
    <td class="style3"><div align="right"><? echo $money;?></div></td>
    <td class="style3"><? echo $other;?></td>
    <td class="style3"><div align="right"><? echo $money_1;?></div></td>
    <td class="style3"><? echo $other_1;?></td>
  ...
  <tr>
    ...
    <td class="style3"><div align="right"><span class="style7"></span><? echo $a6?></div></td>
    <td class="style3"><div align="right"><? echo $money;?></div></td>
    <td class="style3"><? echo $other;?></td>
    <td class="style3"><div align="right"><? echo $money_1;?></div></td>
    <td class="style3"><? echo $other_1;?></td>
  ...
  <tr>
    ...
    <td class="style3"><div align="right"><span class="style7"></span><? echo $a7_1?></div></td>
    <td class="style3"><div align="right"><? echo $money_1;?></div></td>
  ...
  <tr>
    ...
    <td class="style3"><div align="right"><span class="style7"></span><? echo $a7_2?></div></td>
    <td class="style3"><div align="right"><? echo $money_2;?></div></td>
    <td class="style3"><div align="right"><? echo $money_2_1;?></div></td>
  </tr>
  <tr>
    <td height="33" colspan="2" class="style3">購交通車費</td>
    <td class="style3"><div align="right"><span class="style7"></span><? echo $a7_3?></div></td>
    <td class="style3"><div align="right"><? echo $money_3;?></div></td>
    <td class="style3"><div align="right"><? echo $money_3_1;?></div></td>
  </tr>
      <?
  	if($class == '1' ){
  ...
  <tr>
    ...
    <td class="style3"><div align="right"><span class="style7"></span><? echo $a8_1?></div></td>
    <td class="style3"><div align="right"><? echo $money_1;?></div></td>
    <td rowspan="3" class="style3"><? echo $other;?></td>
    <td class="style3"><div align="right"><? echo $money_1_1;?></div></td>
    <td rowspan="3" class="style3"><? echo $other_1;?></td>
  ...
  <tr>
    ...
    <td class="style3"><div align="right"><span class="style7"></span><? echo $a8_2?></div></td>
    <td class="style3"><div align="right"><? echo $money_2;?></div></td>
    <td class="style3"><div align="right"><? echo $money_2_1;?></div></td>
  </tr>
  <tr>
    <td height="34" colspan="2" class="style3">運動場</td>
    <td class="style3"><div align="right"><span class="style7"></span><? echo $a8_3?></div></td>
    <td class="style3"><div align="right"><? echo $money_3;?></div></td>
    <td class="style3"><div align="right"><? echo $money_3_1;?></div></td>
  </tr>
  <tr>
    <td height="43" colspan="4" class="style3"><div align="center">總計</div></td>
    <td class="style3"><div align="right"><span class="style7"></span><? echo $total?></div></td>
    <td colspan="2" class="style3"><div align="right"><? echo $total_examine?></div></td>
    <td colspan="2" class="style3"><div align="right"><? echo $total_examine_1?></div></td>
  </tr>
</table>
<br>
<?php

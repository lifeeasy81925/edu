...
$sql_school = "select  *  from ".$basedata." where account = '$school'";
...
&nbsp;&nbsp;
&nbsp;&nbsp;<a href="government_exmained_print.php?id=<? echo $search_school;?>" target="_black">友善列印</a>
...
<table width="1390" border="3" bordercolor="#000000">
  <tr>
    <td height="76" colspan="4" align="center" class="style3">學校名稱</td>

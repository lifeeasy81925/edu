...
<? /*
	$sql_element_allowance = "SELECT * FROM 100element_allowance where  pointer6='1' and a6_1='0' and a6_2='0';";//符合有補助項目1的國小
    $result_element_allowance= mysql_query($sql_element_allowance);
	while($row = mysql_fetch_row($result_element_allowance)){
		$p1 = $row[6];
	}
	$sql_junior_allowance = "SELECT * FROM 100junior_allowance where  pointer6='1' and a6_1='0' and a6_2='0';";//符合有補助項目1的國中
...
<table width="500" border="1">
    ...
    <td>申請條件</td>
<?
	$sql_element = "SELECT * FROM 100element_money where  pointer6='1' and a6_1='0' and a6_2='0';";//國小資料
...
<table width="500" border="1">
    ...
    <td>申請條件</td>
<?
	$sql_junior = "SELECT * FROM 100junior_money where  pointer6='1' and a6_1='0' and a6_2='0';";//國中資料

...
指標一-1<br>
<? 
    $result_element= mysql_query('select edu_school.*, 100element_point.point4 from edu_school INNER JOIN 100element_point ON edu_school.account=100element_point.account;');
...
<table width="500" border="1">
    ...
    <td>申請結果</td>
<?	
$result_junior= mysql_query('select edu_school.*, 100junior_point.point4 from edu_school INNER JOIN 100iunior_point ON edu_school.account=100junior_point.account;');

...
<table width="100%" bordercolor="#000000"  border="1" cellpadding="0" cellspacing="0">
  <tr>
    ...
    <td colspan="5" class="style3"><div align="center"><span class="style7"></span><? echo $username.'　'.$city.$district.$school;?></div></td>
  </tr>
  <tr>
  ...
  <tr>
    ...
    <td height="30" rowspan="2" class="style3">推展親職教育活動<? if($a1_010 >0) echo "<a href='102_edu_funds.php?op=1' target='_blank'><br />(開啟審核經費表)</a>"; else echo " "; ?></td>
  ...
  <tr>
    ...
    <td height="30" rowspan="4" class="style3">補助學校發展教育特色<? if($a2_010 >0) echo "<a href='102_edu_funds.php?op=2' target='_blank'><br />(開啟審核經費表)</a>"; else echo " "; ?></td>
...
<tr>
  ...
  <td height="30" rowspan="4" class="style3">修繕離島或偏遠地區師生宿舍<? if($a3_010 >0) echo "<a href='102_edu_funds.php?op=3' target='_blank'><br />(開啟審核經費表)</a>"; else echo " "; ?></td>
...
<tr>
  ...
  <tr>
    ...
    <td height="30" rowspan="2" class="style3">充實學校基本教學設備<? if($a4_010 >0) echo "<a href='102_edu_funds.php?op=4' target='_blank'><br />(開啟審核經費表)</a>"; else echo " "; ?></td>
  ...
  <tr>
    ...
    <td height="30" rowspan="4" class="style3">發展原住民教育文化特色及充實設備器材<? if($a5_010 >0) echo "<a href='102_edu_funds.php?op=5' target='_blank'><br />(開啟審核經費表)</a>"; else echo " "; ?></td>
  ...
  <tr>
    ...
    <td height="30" rowspan="2" class="style3">整修學校社區化活動場所<? if($a7_010 >0) echo "<a href='102_edu_funds.php?op=7' target='_blank'><br />(開啟審核經費表)</a>"; else echo " "; ?></td>

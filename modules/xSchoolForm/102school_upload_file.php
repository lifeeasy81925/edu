...
<div style="background-color:#9CC"><b>※上傳未經校長核章之電子檔：</b>（已核章之書面資料留校備查）<br></div>
<?
	//a1 學校申請總額
...
<table width="90%" border="1" cellspacing="0" cellpadding="0">
  ...
  <tr>
	...
	<form action="102_file_up.php" method="post" enctype="multipart/form-data" target="_self">
		...
		<input type="file" name="myfile">
		<input type="submit" value="上傳「實施計畫」">
<br /><? if ($a2_1 == ''){echo "　實施計畫：<font color=red>未上傳</font> (上傳後請按F5更新狀態)";} else {echo '　實施計畫：<font color=blue>已上傳</font>，檔名：'.'<a href="./upload/102/'.$username.'/'.$a2_1.'" target="_new">'.$a2_1.'</a>';}?>
 	</form>
    </td>
  </tr>
  <? if($a159==0) echo "-->"; ?>
  ...
  <tr>
	...
	<form action="102_file_up.php" method="post" enctype="multipart/form-data" target="_self">
		...
		<input type="file" name="myfile">
		<input type="submit" value="上傳「實施計畫」">
<br /><? if ($a3_1 == ''){echo "　實施計畫：<font color=red>未上傳</font> (上傳後請按F5更新狀態)";} else {echo '　實施計畫：<font color=blue>已上傳</font>，檔名：'.'<a href="./upload/102/'.$username.'/'.$a3_1.'" target="_new">'.$a3_1.'</a>';}?>
 	</form>
	<form action="102_file_up.php" method="post" enctype="multipart/form-data" target="_self">
		<input type="hidden" name="max_file_size" value="102400000">　
...
<br /><? if ($a3_2 == ''){echo "　近三年住宿人員資料：<font color=red>未上傳</font> (上傳後請按F5更新狀態)";} else {echo '　近三年住宿人員資料：<font color=blue>已上傳</font>，檔名：'.'<a href="./upload/102/'.$username.'/'.$a3_2.'" target="_new">'.$a3_2.'</a>';}?>
 	</form>
  ...
  <tr>
	...
	<form action="102_file_up.php" method="post" enctype="multipart/form-data" target="_self">
		...
		<input type="file" name="myfile">
		<input type="submit" value="上傳「實施計畫」">
<br /><? if ($a4_1 == ''){echo "　實施計畫：<font color=red>未上傳</font> (上傳後請按F5更新狀態)";} else {echo '　實施計畫：<font color=blue>已上傳</font>，檔名：'.'<a href="./upload/102/'.$username.'/'.$a4_1.'" target="_new">'.$a4_1.'</a>';}?>
 	</form>
    </td>
  </tr>
  <? if($a162==0) echo "-->"; ?>
  ...
  <tr>
	...
	<form action="102_file_up.php" method="post" enctype="multipart/form-data" target="_self">
		...
		<input type="file" name="myfile">
		<input type="submit" value="上傳「實施計畫」">
<br /><? if ($a5_1 == ''){echo "　實施計畫：<font color=red>未上傳</font> (上傳後請按F5更新狀態)";} else {echo '　實施計畫：<font color=blue>已上傳</font>，檔名：'.'<a href="./upload/102/'.$username.'/'.$a5_1.'" target="_new">'.$a5_1.'</a>';}?>
 	</form>
    </td>
  </tr>
  <? if($a163==0) echo "-->"; ?>
  ...
  <tr>
	...
	<form action="102_file_up.php" method="post" enctype="multipart/form-data" target="_self">
		...
		<input type="file" name="myfile">
		<input type="submit" value="上傳「實施計畫(含經費申請表)」">
<br /><? if ($a6_1 == ''){echo "　實施計畫(含經費申請表)：<font color=red>未上傳</font> (上傳後請按F5更新狀態)";} else {echo '　實施計畫(含經費申請表)：<font color=blue>已上傳</font>，檔名：'.'<a href="./upload/102/'.$username.'/'.$a6_1.'" target="_new">'.$a6_1.'</a>';}?>
 	</form>
	<form action="102_file_up.php" method="post" enctype="multipart/form-data" target="_self">
		<input type="hidden" name="max_file_size" value="102400000">
...
<br /><? if ($a6_2 == ''){echo "　各搭車路線學生名冊：<font color=red>未上傳</font> (上傳後請按F5更新狀態)";} else {echo '　各搭車路線學生名冊：<font color=blue>已上傳</font>，檔名：'.'<a href="./upload/102/'.$username.'/'.$a6_2.'" target="_new">'.$a6_2.'</a>';}?>
 	</form>
	<form action="102_file_up.php" method="post" enctype="multipart/form-data" target="_self">
		<input type="hidden" name="max_file_size" value="102400000">　
		<input type="hidden" name="table" value="a_6_3">
		<input type="file" name="myfile">
		<input type="submit" value="上傳「學校現有交通車調查表」">
<br /><? if ($a6_3 == ''){echo "　學校現有交通車調查表：<font color=red>未上傳</font> (上傳後請按F5更新狀態)";} else {echo '　學校現有交通車調查表：<font color=blue>已上傳</font>，檔名：'.'<a href="./upload/102/'.$username.'/'.$a6_3.'" target="_new">'.$a6_3.'</a>';}?>
 	</form>
    </td>
  </tr>
  <? if($a164==0) echo "-->"; ?>
  ...
  <tr>
	...
	<form action="102_file_up.php" method="post" enctype="multipart/form-data" target="_self">
		...
		<input type="file" name="myfile">
		<input type="submit" value="上傳「實施計畫」">
<br /><? if ($a7_1 == ''){echo "　實施計畫：<font color=red>未上傳</font> (上傳後請按F5更新狀態)";} else {echo '　實施計畫：<font color=blue>已上傳</font>，檔名：'.'<a href="./upload/102/'.$username.'/'.$a7_1.'" target="_new">'.$a7_1.'</a>';}?>
 	</form>
    </td>
  </tr>
  <? if($a165==0) echo "-->"; ?>

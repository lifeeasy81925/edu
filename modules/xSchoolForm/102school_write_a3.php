...
//第二個經費表
$sql = "select * from 102allowance3_2 where account like '$username' ";
$result = mysql_query($sql);
while($row = mysql_fetch_row($result)){
	$b030 = $row[30]; //經費表1-1
	$b031 = $row[31]; //
...
<form name="form" method="post" action="102school_write_a3_finish.php"  onSubmit="return toCheck();" onKeyDown="if(event.keyCode == 13) return false;">
<p><b>補助項目三：修繕離島或偏遠地區師生宿舍</b>　<a href="/edu/modules/xSchoolForm/download/allowance-03.htm" target="_blank">(補助項目說明)</a></p>
<font color=blue>※補助師生宿舍</font><br />
說明：本項目最高補助140萬元。
<p>
※最近五年曾獲本項補助<br />
<label><input type="radio" name="RadioGroup1" value="1" id="RadioGroup1_0" <? if ($a029=='1') echo 'checked';?>/>是</label>(97、98、99、100、101年度已接受本項補助之宿舍，不得再提出申請)<br />
<label><input type="radio" name="RadioGroup1" value="0" id="RadioGroup1_1" <? if ($a029=='0') echo 'checked';?>/>否</label><p>
※貴校申請修繕(含設備)：<font color=red><? echo $a4item; ?></font><p>
<? if ($a4key == 1) { echo "<!--"; } ?>
※預計申請<font color=blue>教師宿舍</font>：<font color=blue>經費共計<input type="text" size="6" name="TafterEquipMon" value="<? if($a013=='') echo ''; else echo $a013;?>" style="border:0px; text-align: right;" readonly >元。</font><br>
　其中包含經常門經費<input type="text" size="2" name="TafterMonNum" value="<? if($a019=='') echo ''; else echo $a019;?>"/>項<input type="text" size="6" name="TafterMon" onChange="change5()" value="<? if($a014=='') echo ''; else echo $a014;?>" style="border:0px; text-align: right;" readonly ><font color=blue>元</font>，資本門經費<input type="text" size="2" name="TafterEquipNum" value="<? if($a020 =='') echo ''; else echo $a020;?>"/>項<input type="text" size="6" name="TafterEquip" onChange="change6()" value="<? if($a015=='') echo ''; else echo $a015;?>" style="border:0px; text-align: right;" readonly ><font color=blue>元</font>。
<? //經費表 教師宿舍 ?>
<table width="100%" border="0" cellspacing="0" cellpadding="0" bgcolor="#FFFFCC" style="font-size:12px;">
  ...
  <tr>
    ...
    <script language="javascript"> 
  		//document.form.s1_1.value="<? echo $a030;?>";
	</script>
    </td>
    <td align="left">
    ...
    <script> 
  		//document.form.s1_2.value="<? echo $a031;?>";
	</script>
    </td>
  ...
  <tr>
    ...
    <script> 
  		//document.form.s3_1.value="<? echo $a050;?>";
	</script>
    </td>
    <td align="left">
    ...
    <script> 
  		//document.form.s3_2.value="<? echo $a051;?>";
	</script>
    </td>
  ...
  <tr>
    ...
    <script> 
  		//document.form.s4_1.value="<? echo $a060;?>";
	</script>
    </td>
    <td align="left">
    ...
    <script> 
  		//document.form.s4_2.value="<? echo $a061;?>";
	</script>
    </td>
  ...
  <tr>
    ...
    <script> 
  		//document.form.s5_1.value="<? echo $a070;?>";
	</script>
    </td>
    <td align="left">
    ...
    <script> 
  		//document.form.s5_2.value="<? echo $a071;?>";
	</script>
    </td>
  ...
  <tr>
    ...
    <script> 
  		//document.form.s6_1.value="<? echo $a080;?>";
	</script>
    </td>
    <td align="left">
    ...
    <script> 
  		//document.form.s6_2.value="<? echo $a081;?>";
	</script>
    </td>
  ...
  <tr>
    ...
    <script> 
  		//document.form.s7_1.value="<? echo $a090;?>";
	</script>
    </td>
    <td align="left">
    ...
    <script> 
  		//document.form.s7_2.value="<? echo $a091;?>";
	</script>
    </td>
  ...
  <tr>
    ...
    <script> 
  		//document.form.s8_1.value="<? echo $a100;?>";
	</script>
    </td>
    <td align="left">
    ...
    <script> 
  		//document.form.s8_2.value="<? echo $a101;?>";
	</script>
    </td>
  ...
  <tr>
    ...
    <script> 
  		//document.form.s9_1.value="<? echo $a110;?>";
	</script>
    </td>
    <td align="left">
    ...
    <script> 
  		//document.form.s9_2.value="<? echo $a111;?>";
	</script>
    </td>
  ...
  <tr>
    ...
    <td align="left" valign="middle"><input type="text" size="10" name="a122" value="<? if($a122 =='') echo ''; else echo $a122;?>"/></td>
...
<p>
<? if ($a4key == 2) { echo "<!--"; } ?>
※預計申請<font color=blue>學生宿舍</font>：<font color=blue>經費共計<input type="text" size="6" name="afterEquipMon" value="<? if($a016=='') echo ''; else echo $a016;?>" style="border:0px; text-align: right;" readonly>元。</font><br>
　其中包含經常門經費<input type="text" size="2" name="afterMonNum" value="<? if($a021=='') echo ''; else echo $a021;?>"/>項<input type="text" size="6" name="afterMon" onChange="change3()" value="<? if($a017=='') echo ''; else echo $a017;?>" style="border:0px; text-align: right;" readonly ><font color=blue>元</font>，資本門經費<input type="text" size="2" name="afterEquipNum" value="<? if($a022=='') echo ''; else echo $a022;?>"/>式<input type="text" size="6" name="afterEquip" onChange="change4()" value="<? if($a018=='') echo ''; else echo $a018;?>" style="border:0px; text-align: right;" readonly ><font color=blue>元</font>。<br />
<? //經費表 學生宿舍 ?>
<table width="100%" border="0" cellspacing="0" cellpadding="0" bgcolor="#FFFFCC" style="font-size:12px;">
  <tr>
  ...
  <tr>
    ...
    <script> 
  		//document.form.b1_1.value="<? echo $b030;?>";
	</script>
    </td>
    <td align="left">
    ...
    <script> 
  		//document.form.b1_2.value="<? echo $b031;?>";
	</script>
    </td>
    <td align="left"><input type="text" size="10" name="b032" value="<? if($b032 =='') echo ''; else echo $b032;?>"/></td>
    <td align="left"><input type="text" size="2" name="b033" value="<? if($b033 =='') echo ''; else echo $b033;?>"/></td>
  ...
  <tr>
    ...
    <script> 
  		//document.form.b2_1.value="<? echo $b040;?>";
	</script>
    </td>
    <td align="left">
    ...
    <script> 
  		//document.form.b2_2.value="<? echo $b041;?>";
	</script>
    </td>
  ...
  <tr>
    ...
    <script> 
  		//document.form.b3_1.value="<? echo $b050;?>";
	</script>
    </td>
    <td align="left">
    ...
    <script> 
  		//document.form.b3_2.value="<? echo $b051;?>";
	</script>
    </td>
  ...
  <tr>
    ...
    <script> 
  		//document.form.b4_1.value="<? echo $b060;?>";
	</script>
    </td>
    <td align="left">
    ...
    <script> 
  		//document.form.b4_2.value="<? echo $b061;?>";
	</script>
    </td>
  ...
  <tr>
    ...
    <script> 
  		//document.form.b5_1.value="<? echo $b070;?>";
	</script>
    </td>
    <td align="left">
    ...
    <script> 
  		//document.form.b5_2.value="<? echo $b071;?>";
	</script>
    </td>
  ...
  <tr>
    ...
    <script> 
  		//document.form.b6_1.value="<? echo $b080;?>";
	</script>
    </td>
    <td align="left">
    ...
    <script> 
  		//document.form.b6_2.value="<? echo $b081;?>";
	</script>
    </td>
  ...
  <tr>
    ...
    <script> 
  		//document.form.b7_1.value="<? echo $b090;?>";
	</script>
    </td>
    <td align="left">
    ...
    <script> 
  		//document.form.b7_2.value="<? echo $b091;?>";
	</script>
    </td>
  ...
  <tr>
    ...
    <script> 
  		//document.form.b8_1.value="<? echo $b100;?>";
	</script>
    </td>
    <td align="left">
    ...
    <script> 
  		//document.form.b8_2.value="<? echo $b101;?>";
	</script>
    </td>
  ...
  <tr>
    ...
    <script> 
  		//document.form.b9_1.value="<? echo $b110;?>";
	</script>
    </td>
    <td align="left">
    ...
    <script> 
  		//document.form.b9_2.value="<? echo $b111;?>";
	</script>
    </td>
  ...
  <tr>
    ...
    <td align="left" valign="middle"><input type="text" size="10" name="b122" value="<? if($b122 =='') echo ''; else echo $b122;?>"/></td>
    <td align="left"><input type="text" size="2" name="b123" value="<? if($b123 =='') echo ''; else echo $b123;?>"/></td>
    <td align="left"><input type="text" size="4" name="b124" onchange="js:Count(this);" value="<? if($b124 =='') echo ''; else echo $b124;?>"/></td>
    <td align="left"><input type="text" size="2" name="b125" onchange="js:Count(this);" value="<? if($b125 =='') echo ''; else echo $b125;?>"/></td>
...
　　今(<? echo $datetime-1912;?>)學年度教師宿舍住宿人數<input type="text" size="6" name="TthisDorm" value="<? if($a023=='') echo ''; else echo $a023;?>"/>人<br>
　　去(<? echo $datetime-1913;?>)學年度教師宿舍住宿人數<input type="text" size="6" name="TlastDorm" value="<? if($a024=='') echo ''; else echo $a024;?>"/>人<br>
　　前(<? echo $datetime-1914;?>)學年度教師宿舍住宿人數<input type="text" size="6" name="TbeforeDorm" value="<? if($a025=='') echo ''; else echo $a025;?>"/>人<br>
<? if ($a4key == 1) { echo "-->"; } ?>
<? if ($a4key == 2) { echo "<!--"; } ?>
　<strong>學生宿舍</strong><br />
　　今(<? echo $datetime-1912;?>)學年度學生宿舍住宿人數<input type="text" size="6" name="thisDorm" value="<? if($a026=='') echo ''; else echo $a026;?>"/>人<br>
　　去(<? echo $datetime-1913;?>)學年度學生宿舍住宿人數<input type="text" size="6" name="lastDorm" value="<? if($a027=='') echo ''; else echo $a027;?>"/>人<br>
　　前(<? echo $datetime-1914;?>)學年度學生宿舍住宿人數<input type="text" size="6" name="beforeDorm" value="<? if($a028=='') echo ''; else echo $a028;?>"/>人<br>
<? if ($a4key == 2) { echo "-->"; } ?>
<p>
<a href="/edu/modules/xSchoolForm/download/表(四)~2修繕離島或偏遠地區師生宿舍計畫及近三年住宿情形.doc" target="_new">下載：修繕離島或偏遠地區師生宿舍計畫及近三年住宿情形(參考表格)</a><br />
...
<script language="JavaScript">
	function Count(obj) //
	{
		...
		//chkbox(document.getElementsByName(group_ab + "122")[0]); //雜支選項被拿掉
		count_all(group_ab);
	}
	...
	function count_all(group_ab)
	{
		...
		{
			//教師
			document.getElementsByName("TafterEquipMon")[0].value = total;	
			document.getElementsByName("TafterMonNum")[0].value = money_1_c;	
			document.getElementsByName("TafterMon")[0].value = money_1;	
			document.getElementsByName("TafterEquipNum")[0].value = money_2_c;	
			document.getElementsByName("TafterEquip")[0].value = money_2;	
		}
		else
		{
			//學生
			document.getElementsByName("afterEquipMon")[0].value = total;	
			document.getElementsByName("afterMonNum")[0].value = money_1_c;	
			document.getElementsByName("afterMon")[0].value = money_1;	
			document.getElementsByName("afterEquipNum")[0].value = money_2_c;	
			document.getElementsByName("afterEquip")[0].value = money_2;	
		}

...
<form name="form" method="post" action="102school_write_a4_finish.php"  onSubmit="return toCheck();" onKeyDown="if(event.keyCode == 13) return false;">
<p><b>補助項目四：充實學校基本教學設備</b>　<a href="/edu/modules/xSchoolForm/download/allowance-04.htm" target="_blank">(補助項目說明)</a></p>
<font color=blue>※補助充實學校基本設備</font><br />
說明：6班以下最高補助10萬元，7至12班最高補助15萬元，13班以上最高補助20萬元。<br />
貴校班級數：<? echo $classes; ?>班
<!--
<p>
※近二年接受補助狀況<br />
　100年補助：<? echo number_format($p014); ?>元<br />
　101年補助：<? echo number_format($p076); ?>元<br />
-->
<p>
※最近三年是否曾獲本項補助：<br />
　<label><input type="radio" name="RadioGroup1" value="1" id="RadioGroup1_0" <? if ($a029=='1') echo 'checked';?>/>是</label>(99、100、101年度已接受本項補助者，不得再提出申請)<br />
　<label><input type="radio" name="RadioGroup1" value="0" id="RadioGroup1_1" <? if ($a029=='0') echo 'checked';?>/>否</label>
<p>
<font color=blue>※申請補助經費<input type="text" size="6" name="afterMon" value="<? if($a010 =='') echo ''; else echo $a010;?>" style="border:0px; text-align: right;" readonly >元。<br />
　其中包含經常門經費<input type="text" size="5" name="afterMonA" onChange="change1()" value="<? if($a011 =='') echo ''; else echo $a011;?>" style="border:0px; text-align: right;" readonly >元，資本門經費<input type="text" size="5" name="afterMonB" onChange="change2()" value="<? if($a012 =='') echo ''; else echo $a012;?>" style="border:0px; text-align: right;" readonly >元。</font>
<? //經費表 補助充實學校基本設備 ?>
...
function toCheck() {
	...
	//數值檢核
	if (<? echo $classes;?> < 7 && document.form.afterMon.value > 100000) {
		alert('6班以下申請經費不得大於10萬元！\n'+'貴校班數：'+<? echo $classes;?>);
		document.form.afterMon.focus();
		return false;
    } else if (<? echo $classes;?> < 13 && document.form.afterMon.value > 150000) {
...
<script language="JavaScript">
	...
	function count_all(group_ab)
	{
		...
		if(group_ab == "a")
		{
			...
			document.getElementsByName("afterMonA")[0].value = money_1;	
			document.getElementsByName("afterMonB")[0].value = money_2;
		}

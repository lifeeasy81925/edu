...
<table border="0">
	<tr>
		<td>
			...
			教師宿舍：
			經常門：
			<input type="text" size="2" name="edu_p1_current_cnt" id="edu_p1_current_cnt" value="<?=$edu_p1_current_cnt;?>" style="border:0px; text-align: right;" readonly >項，
			<input type="text" size="5" name="edu_p1_current_money" id="edu_p1_current_money" value="<?=$edu_p1_current_money;?>" style="border:0px; text-align: right;" readonly >元，
			資本門：
			<input type="text" size="2" name="edu_p1_capital_cnt" id="edu_p1_capital_cnt" value="<?=$edu_p1_capital_cnt;?>" style="border:0px; text-align: right;" readonly >式，
			<input type="text" size="5" name="edu_p1_capital_money" id="edu_p1_capital_money" value="<?=$edu_p1_capital_money;?>" style="border:0px; text-align: right;" readonly >元。<br />
			學生宿舍：
			經常門：
			<input type="text" size="2" name="edu_p2_current_cnt" id="edu_p2_current_cnt" value="<?=$edu_p2_current_cnt;?>" style="border:0px; text-align: right;" readonly >項，
			<input type="text" size="5" name="edu_p2_current_money" id="edu_p2_current_money" value="<?=$edu_p2_current_money;?>" style="border:0px; text-align: right;" readonly >元，
			資本門：
			<input type="text" size="2" name="edu_p2_capital_cnt" id="edu_p2_capital_cnt" value="<?=$edu_p2_capital_cnt;?>" style="border:0px; text-align: right;" readonly >式，
			<input type="text" size="5" name="edu_p2_capital_money" id="edu_p2_capital_money" value="<?=$edu_p2_capital_money;?>" style="border:0px; text-align: right;" readonly >元。</font>
			<p>
		</td>
	</tr>
	<tr>
		<td>
			...
			<input size="6" name="execute_money" type="text" id="execute_money" value="<?=$execute_money;?>" style="border:0px; text-align: right;" readonly >元。<br />
			經常門：
			<input type="text" size="2" name="execute_current_cnt" id="execute_current_cnt" value="<?=$execute_current_cnt;?>" style="border:0px; text-align: right;" readonly >項，
			<input type="text" size="5" name="execute_current_money" id="execute_current_money" value="<?=$execute_current_money;?>" style="border:0px; text-align: right;" readonly >元，
			資本門：
			<input type="text" size="2" name="execute_capital_cnt" id="execute_capital_cnt" value="<?=$execute_capital_cnt;?>" style="border:0px; text-align: right;" readonly >式，
			<input type="text" size="5" name="execute_capital_money" id="execute_capital_money" value="<?=$execute_capital_money;?>" style="border:0px; text-align: right;" readonly >元。</font>(執行進度依據，由下方資料自動加總)
			<p>
		</td>
	</tr>
	<tr>
		<td>
			...
			已執行經費：經常門
			<input type="text" size="3" name="p1_current_cnt" id="p1_current_cnt" value="<?=$p1_current_cnt;?>" onChange="sum(this)">項，
			<input type="text" size="5" name="p1_current_money" id="p1_current_money" value="<?=$p1_current_money;?>" onChange="sum(this)">元，
			資本門
			<input type="text" size="3" name="p1_capital_cnt" id ="p1_capital_cnt" value="<?=$p1_capital_cnt;?>" onChange="sum(this)">式，
			<input type="text" size="5" name="p1_capital_money" id ="p1_capital_money" value="<?=$p1_capital_money;?>" onChange="sum(this)">元。
	...
	<tr>
		<td>
			...
			已執行經費：經常門
			<input type="text" size="3" name="p2_current_cnt" id="p2_current_cnt" value="<?=$p2_current_cnt;?>" onChange="sum(this)">項，
			<input type="text" size="5" name="p2_current_money" id="p2_current_money" value="<?=$p2_current_money;?>" onChange="sum(this)">元，
			資本門
			<input type="text" size="3" name="p2_capital_cnt" id ="p2_capital_cnt" value="<?=$p2_capital_cnt;?>" onChange="sum(this)">式，
			<input type="text" size="5" name="p2_capital_money" id ="p2_capital_money" value="<?=$p2_capital_money;?>" onChange="sum(this)">元。
...
<script language="JavaScript">
	function toCheck() 
	{
		...
		//教師
		if ( parseInt(document.getElementById("p1_current_cnt").value) > parseInt(document.getElementById("edu_p1_current_cnt").value) ) 
		{
			errmsg += "「執行金額-教師宿舍-經常門-項」不得大於「核定金額-教師宿舍-經常門-項」！\n";
			flag = 0;
		}
		if ( parseInt(document.getElementById("p1_current_money").value) > parseInt(document.getElementById("edu_p1_current_money").value) ) 
		{
			errmsg += "「執行金額-教師宿舍-經常門」不得大於「核定金額-教師宿舍-經常門」！\n";
			flag = 0;
		}
		if ( parseInt(document.getElementById("p1_capital_cnt").value) > parseInt(document.getElementById("edu_p1_capital_cnt").value) ) 
		{
			errmsg += "「執行金額-教師宿舍-資本門-式」不得大於「核定金額-教師宿舍-資本門-式」！\n";
			flag = 0;
		}
		if ( parseInt(document.getElementById("p1_capital_money").value) > parseInt(document.getElementById("edu_p1_capital_money").value) ) 
		{
			errmsg += "「執行金額-教師宿舍-資本門」不得大於「核定金額-教師宿舍-資本門」！\n";
			flag = 0;
		}
		
		//學生
		if ( parseInt(document.getElementById("p2_current_cnt").value) > parseInt(document.getElementById("edu_p2_current_cnt").value) ) 
		{
			errmsg += "「執行金額-學生宿舍-經常門-項」不得大於「核定金額-學生宿舍-經常門-項」！\n";
			flag = 0;
		}
		if ( parseInt(document.getElementById("p2_current_money").value) > parseInt(document.getElementById("edu_p2_current_money").value) ) 
		{
			errmsg += "「執行金額-學生宿舍-經常門」不得大於「核定金額-學生宿舍-經常門」！\n";
			flag = 0;
		}
		if ( parseInt(document.getElementById("p2_capital_cnt").value) > parseInt(document.getElementById("edu_p2_capital_cnt").value) ) 
		{
			errmsg += "「執行金額-學生宿舍-資本門-式」不得大於「核定金額-學生宿舍-資本門-式」！\n";
			flag = 0;
		}
		if ( parseInt(document.getElementById("p2_capital_money").value) > parseInt(document.getElementById("edu_p2_capital_money").value) ) 
		{
			errmsg += "「執行金額-學生宿舍-資本門」不得大於「核定金額-學生宿舍-資本門」！\n";
			flag = 0;
		}

...
<table width="100%" border="1" cellspacing="0" cellpadding="0">
	<tr>
		...
		<td height="40" align="center" bgcolor="#99CCCC">修正後計畫<br>檔案上傳區<br><font color=red>（必填）</font></td>
	</tr>
<? if($sum_edu_total_money < 1) {echo "-->";} ?>
	...
	<tr>
		...
		<td align="center"><INPUT TYPE="button" VALUE="進入" onClick="location='effect_school_up_01.php'"></td>
	</tr>
	<? if($a1_edu_total_money < 1) {echo "-->";}?>
	...
	<tr>
		...
		<td align="center"><INPUT TYPE="button" VALUE="進入" onClick="location='effect_school_up_02.php'"></td>
	</tr>
	<? if($a2_edu_total_money < 1) {echo "-->";}?>
	...
	<tr>
		...
		<td align="center"><INPUT TYPE="button" VALUE="進入" onClick="location='effect_school_up_03.php'"></td>
	</tr>
	<? if($a3_edu_total_money < 1) {echo "-->";}?>
	...
	<tr>
		...
		<td align="center"><INPUT TYPE="button" VALUE="進入" onClick="location='effect_school_up_04.php'"></td>
	</tr>
	<? if($a4_edu_total_money < 1) {echo "-->";}?>
	...
	<tr>
		...
		<td align="center"><INPUT TYPE="button" VALUE="進入" onClick="location='effect_school_up_05.php'"></td>
	</tr>
	<? if($a5_edu_total_money < 1) {echo "-->";}?>
	...
	<tr>
		...
		<td align="center"><INPUT TYPE="button" VALUE="進入" onClick="location='effect_school_up_06.php'"></td>
	</tr>
	<? if($a6_edu_total_money < 1) {echo "-->";}?>
	...
	<tr>
		...
		<td align="center"><INPUT TYPE="button" VALUE="進入" onClick="location='effect_school_up_07.php'"></td>
	</tr>
	<? if($a7_edu_total_money < 1) {echo "-->";}?>
<? if($sum_edu_total_money < 1) {echo "<!--";} ?>
	<tr>
...
<? 
	...
	{
		echo "<p><font color='blue'><strong>注意事項：</strong></font><p>";
		echo "1. 各補助項目請分別進入「<font color=red>執行情形</font>」及「<font color=red>檔案上傳區</font>」，輸入或上傳項目資料。<p>";

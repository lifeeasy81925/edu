...
<?
	...
	//1040422修改，新增可能含個資的pri資料夾
	//建立pri資料夾
	if(!is_dir($_SERVER['DOCUMENT_ROOT'].'/epa_uploads/'.$school_year.'/pri')) 
	{	
		//echo "<br />建立目錄:".$_SERVER['DOCUMENT_ROOT'].'/epa_uploads/'.$school_year.'/pri'.'<br />';
		//$msg[0] = "建立目錄:".$_SERVER['DOCUMENT_ROOT']."/epa_uploads/".$school_year.'/pri'." \n";	
		mkdir($_SERVER['DOCUMENT_ROOT'].'/epa_uploads/'.$school_year.'/pri', 0777);
	
	}
	//1040422修改，以上為建立pri資料夾
	
	//建立account 資料夾
	if(!is_dir($_SERVER['DOCUMENT_ROOT'].'/epa_uploads/'.$school_year.'/pri/'.$username)) 
	{	
		//echo "<br />建立目錄:".$_SERVER['DOCUMENT_ROOT'].'/epa_uploads/'.$school_year.'/pri/'.$username.'<br />';
		//$msg[0] = "建立目錄:".$_SERVER['DOCUMENT_ROOT']."/epa_uploads/".$school_year.'/pri/'.$username." \n";	

...
<p><b>補助項目二：補助學校發展教育特色</b>　<a href="/edu/modules/xSchoolForm/download/allowance-02.htm" target="_blank">(補助項目說明)</a>
<p>
<font color=blue>※補助學校發展特色-申請補助經費：<input type="text" size="6" name="s_total_money" value="<?=$s_total_money;?>" style="border:0px; text-align: right;" readonly >
元 (本列自動計算)</font><br />
說明：分校分班最高核列6萬元，12班以下最高核列8萬元，13班以上最高核列2項特色，每項最高8萬元；設備採購單價一萬元以上者，始列入資本門；<font color="red">鐘點費(含補充保費)，會自動計入額外2%金額</font>。
<p>
...
<?
	//顯示特色一 細項
	print_item('alc_education_features_item', 'p1', $main_seq);
...
<?
	//顯示特色二 細項
	print_item('alc_education_features_item', 'p2', $main_seq);
...
<script language="JavaScript">
	...
	function toCheck() 
	{
		...
		if(s_p_money != null)
		{
			if ( <?=$class_total;?> >= <?=$keyClasses;?> && document.form.p2_name.value == "" ) 
			{
				errmsg += "請填寫「特色二申請項目名稱」，若無請填「無」\n";

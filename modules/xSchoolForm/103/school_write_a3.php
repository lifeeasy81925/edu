<?php
	...
	while($row = mysql_fetch_array($result))
	{
		...
		if($money_last > 0 || $money_last2 > 0 || $money_last3 > 0 || $money_last4 > 0 || $money_last5 > 0) 
		{
			...
			$strmsg .= ($money_last4 > 0)?($school_year - 4)." 年度獲得補助 <font color='red'>".$money_last4."</font> 元。":"";
			$strmsg .= ($money_last5 > 0)?($school_year - 5)." 年度獲得補助 <font color='red'>".$money_last5."</font> 元。":"";
...
<p><b>補助項目三：修繕離島或偏遠地區師生宿舍</b>　<a href="/edu/modules/xSchoolForm/download/allowance-03.htm" target="_blank">(補助項目說明)</a>
<p>
...
說明：本項目最高補助140萬元。
<p>
※最近五年是否曾獲本項補助：<font color="blue"><?=$strmsg;?></font><br />
　<label><input type="radio" name="rdo_last5year" value="Y" id="rdo_last5year_0" onclick="<?=$disable_radio;?>" <?=($apply_last5year == 'Y')?'checked':'';?> />是</label>(98、99、100、101、102年度曾接受本項補助之宿舍，不得再提出申請)<br />

...
<p><b>補助項目四：充實學校基本教學設備</b>　<a href="/edu/modules/xSchoolForm/download/allowance-04.htm" target="_blank">(補助項目說明)</a>
<p>
...
　<label><input type="radio" name="rdo_last3year" value="Y" id="rdo_last3year_0" onclick="<?=$disable_radio;?>" <?=($apply_last3year == 'Y')?'checked':'';?> />是</label>(100、101、102年度已接受本項補助者，不得再提出申請)<br />

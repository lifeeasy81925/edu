...
<strong>項目：一、推展親職教育活動  </strong><a href="allowance-01.htm" target="_blank">(補助項目說明)</a>
<table border="0">
	<tr>
		<td>
	...
	<tr>
		<td>
			...
			已辦理場次<input name="p1_times" type="text" id="p1_times" size="6" value="<?=$p1_times;?>">場，
			已使用經費<input name="p1_used_money" type="text" id="p1_used_money" size="6" value="<?=$p1_used_money;?>" onChange="sum()">元。<br />
			參與家長人數<input name="p1_parents" type="text" id="p1_parents" size="4" value="<?=$p1_parents;?>">人，
			其中目標學生家長<input name="p1_target_parents" type="text" id="p1_target_parents" size="4" value="<?=$p1_target_parents;?>">人。
			<p>
		</td>
	</tr>
	<tr>
		<td>
			...
			已輔導學生數<input name="p2_people" type="text" id="p2_people" size="6" value="<?=$p2_people;?>">次，
			已使用經費<input name="p2_used_money" type="text" id="p2_used_money" size="6" value="<?=$p2_used_money;?>" onChange="sum()" >元。
			<p>
		</td>
	</tr>
	<tr>

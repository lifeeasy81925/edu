...
<strong>項目：四、充實學校基本教學設備  </strong><a href="allowance-04.htm" target="_blank">(補助項目說明)</a>
<p>
<table border="0">
	<tr>
		<td>
	...
	<tr>
		<td>
			...
			經常門：<input type="text" size="5" name="execute_current_money" id="execute_current_money" value="<?=$execute_current_money;?>" onChange="sum()">元，
			資本門：<input type="text" size="5" name="execute_capital_money" id="execute_capital_money" value="<?=$execute_capital_money;?>" onChange="sum()">元。
			<p>
		</td>
	</tr>
	<tr>

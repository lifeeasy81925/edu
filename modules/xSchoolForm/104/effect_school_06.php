...
<strong>項目：六、補助交通不便地區學校交通車  </strong><a href="allowance-06.htm" target="_blank">(補助項目說明)</a>
<p>
<table border="0">
	<tr>
		<td>
	...
	<tr>
		<td>
			...
			<?
				...
				{
					?>
						已補助人數<input type="text" size="5" name="students" id="students" value="<?=$students;?>">人，
						租用<input type="text" size="5" name="cars" id ="cars" value="<?=$cars;?>">輛，
						已使用經費<input type="text" size="5" name="used_money" id="used_money" value="<?=$used_money;?>" onChange="sum()">元。
					<?
				}
				if($item == '交通費')
				{
				...
				{
					?>
						已購買交通車，座位<input type="text" size="5" name="students" id="students" value="<?=$students;?>">人座，
						<input type="text" size="5" name="cars" id ="cars" value="<?=$cars;?>">輛，
						已使用經費<input type="text" size="5" name="used_money" id="used_money" value="<?=$used_money;?>" onChange="sum()">元。
					<?
				}
			?>

...
<strong>項目：七、整修學校社區化活動場所  </strong><a href="allowance-07.htm" target="_blank">(補助項目說明)</a>
<p>
<table border="0">
	<tr>
		<td>
	...
	<tr>
		<td>
			...
			整修綜合球場(
			<input type="text" size="5" name="p_num" id="p_num" value="<?=$p_num;?>" >座，
			修建：<input type="text" size="5" name="execute_current_money" id="execute_current_money" value="<?=$execute_current_money;?>" onChange="sum()">元，
			設備：<input type="text" size="5" name="execute_capital_money" id="execute_capital_money" value="<?=$execute_capital_money;?>" onChange="sum()">元。)
			<p>
		</td>
	</tr>
	<tr>

...
<p><b>補助項目一：推展親職教育活動</b>　<a href="allowance-01.htm" target="_blank">(補助項目說明)</a>
<p>
...
　　　　　<font color="red">鐘點費(含補充保費)，金額會自動計入額外2%金額</font>。<br />
...
•預計申請個別家庭訪視<input type="text" size="3" name="s_p2_student" onchange="js:Count_family(this);" value="<?=$s_p2_student;?>"/>人，
每人訪視2-4次，共<input type="text" size="3" name="s_p2_people" onchange="js:Count_family(this);" value="<?=$s_p2_people;?>"/>人次，
...
<script language="JavaScript">
	...
	function Count_family(obj)
	{
		...
		if (!(regex.test(s_p2_student.value)))
		{
			errmsg += '「家庭訪視人次」必須為數字\n';
			s_p2_student.value = "";
			flag = 0;

...
<?php
	...
	$table_name_item = "alc_parenting_education_item";
	...
	$s_p1_times = $_POST['s_p1_times'];
	$s_p1_people = $_POST['s_p1_people'];
	
	$s_p2_money = $_POST['s_p2_money'];
	$s_p2_people = $_POST['s_p2_people'];
	$s_p2_student = $_POST['s_p2_student'];
	
	for($i = 1;$i <= 1;$i++) //補助一只有特色一有細項
	{
		$p = "p".$i;
	...
	$sql = " update $table_name set s_total_money='$s_total_money' ".
		   ...
		   "                      , s_p1_times='$s_p1_times' ".
		   "                      , s_p1_people='$s_p1_people' ".
		   "                      , s_p2_money='$s_p2_money' ".
		   "                      , s_p2_people='$s_p2_people' ".
	...
	{
		echo '新增失敗!';
		echo '<meta http-equiv=REFRESH CONTENT=2;url=school_write_a1.php>';

...
<?
	//顯示特色一 細項
	print_item($a5_table_name_item, 'p1_105', $main_seq);
...
<?
	//顯示特色一 細項
	print_item($a5_table_name_item, 'p1_106', $main_seq);
...
<?
	//顯示特色二 細項
	print_item($a5_table_name_item, 'p2_105', $main_seq);
...
<?
	//顯示特色二 細項
	print_item($a5_table_name_item, 'p2_106', $main_seq);

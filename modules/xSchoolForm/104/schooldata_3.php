...
<p>
<b>一、目標學生數</b>
<input type="button" name="Submit" value="下載目標學生名冊範例檔案" onclick="location.href='/edu_dl/104/目標學生名冊_模擬範例.xls'"> 
<input type="button" name="Submit" value="下載目標學生空白名冊" onclick="location.href='/edu_dl/104/目標學生名冊_空白.xls'">
<p>
...
<table border="0">
	...
	<tr>
		<td nowrap="nowrap" >
			※本校目標學生數（不含僅具原住民身分者）共：<input type="text" size="6" name="target_no_aboriginal" value="<?=$target_no_aboriginal;?>"/>人<br />
			<font color=blue>　（各類目標學生若同時符合原住民與其他身分，應計入統計，但不含僅具原住民身分者）</font><br />
			※本校目標學生數（含僅原住民身分者）共：<input type="text" size="6" name="target_aboriginal" value="<?=$target_aboriginal;?>"/>人<br />
	...
	<tr>
		<td nowrap="nowrap" >
			※去(<?=$school_year-2;?>)學年度中途輟學學生數：<input type="text" size="6" name="lastyear_leaving" value="<?=$lastyear_leaving;?>"/>人<br />

...
<div id="print_content">
	...
	<? if($a2_p1 == 'show') { ?>
		...
		<table border="0">
			<tr>
				...
				<br /><?=$school_year;?>年度 <!-- 2012.12.31補上年度 --></td>
			</tr>
			<tr>
	...
	<? if($table_1 == 'show') { ?>
		<table width="100%" border="0" cellspacing="0" cellpadding="0" bgcolor="#FFFFCC" style="font-size:14px;">
			...
			<tr>
				<td width="35" align="left" nowrap="nowrap" bgcolor="#99CCCC">項次</td>
	...
	<? } ?>
	<? if($table_1_ny1 == 'show') { ?>
		<?=$school_year+1;?>年度 <!-- 2012.12.31補上年度 -->
        <table border="0">
			<tr>
	...
	<? } ?>
	<? if($table_1_ny2 == 'show') { ?>
    <?=$school_year+2;?>年度 <!-- 2012.12.31補上年度 -->
		<table border="0">
			<tr>

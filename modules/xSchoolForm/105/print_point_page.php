...
$sql = " select sd.account, sd.schooltype, sd.cityname, sd.district, sd.schoolname, sd.area ".
		   ...
		   "	  , sy_ly.teacher as teacher_ly ".  //去年老師
		   ...
		   "                       left join school_examdata as se on sd.account = se.account and se.school_year = '".($school_year + 1)."' ".  //j10407，抓105年匯入的資料，原本'$school_year'
...
<p>
<input type="button" value="確認採用103學年度學校及學生基本資料(建議選取)" onclick="location.href='school_select_allowance.php'">
<p>
<input type="button" value="重新填寫104學年度學校及學生基本資料"  onclick="javascript:if(confirm('按下「確定」後，將重新填寫資料，原資料將消除，將無法再採用103年度學校及學生資料!!')) location.href='school_update.php' " >  <!-- j10407新增  -->
<p>
<div id="print_content">
<div style="font-family:標楷體;font-size:20px;text-align:left"><strong>教育部<?=$school_year+1;?>年度教育優先區指標界定調查紀錄表─<? echo $cityname.$district.$schoolname; ?></strong></div>
<?
	//列印顯示用
	echo "學校代碼：".$account;
	echo "　　承辦人：".$user_from;
...
<table border="1" cellspacing="0" cellpadding="0" align="left" style="font-family:標楷體; width:950px">
	...
	<tr>
		...
		<td height="30" colspan="2"><p>從<?=($school_year-2);?>/9/1至<?=($school_year-1);?>/6/30 中途輟學學生人數</p></td>
	...
	<tr>
		<td height="30" colspan="2"><p><?=($school_year-2);?>學年度在籍學生人數 </p></td>

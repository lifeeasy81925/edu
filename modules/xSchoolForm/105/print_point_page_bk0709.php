...
$sql = " select sd.account, sd.schooltype, sd.cityname, sd.district, sd.schoolname, sd.area ".
		   ...
		   "      , sy_l2y.student as student_l2y ".  //去年學生		   
		   
		   "	  , sy_ly.teacher as teacher_ly ".  //去年老師
		   "	  , sy_l2y.teacher as teacher_l2y ".  //去年老師		   
		   ...
		   "      , a4_ly.edu_total_money as a4_ly_money ".     //104
		   "      , a4_l2y.edu_total_money as a4_l2y_money ".	//103	   
		   ...
		   //去年資料的資料表
		   "                       left join schooldata_year as sy_ly on sd.account = sy_ly.account and sy_ly.school_year = '".($school_year - 1)."' ".   //j10407
		   ...
		   //j10407,新增，前年資料的資料表
		   "                       left join schooldata_year as sy_l2y on sd.account = sy_l2y.account and sy_l2y.school_year = '".($school_year - 2)."' ".   //j10407
...
*/
	...
	while($row = mysql_fetch_array($result))
	{
		...
		$money_last3 = ($row['a169'] == '')?0:$row['a169'];                                 //j10407,換成102年，移除101年($row['a5'] == '')?0:$row['a5'];
		$money_last2 = $a4_l2y_money;                                                       //j10407,換成103年
		$money_last =  $a4_ly_money;                                                        //104年
	...
	$a4 = ($p1_1==1 || $p1_2==1 || $p1_3==1 || $p3_1==1 || $p3_2==1 || $p5_1==1 || $p5_2==1);    //j-10407,新增$p3_2，只要任一年的學測達標準，即可申請補四!!
	...
	$p_ary = array("p1_1", "p1_2", "p1_3", "p1_4", "p2_1", "p2_2", "p2_3", "p3_1", "p3_2", "p4_1", "p5_1", "p5_2", "p5_3", "p6_1", "p6_2");   //j-10407,新增$p3_2
...
<table border="1" cellspacing="0" cellpadding="0" align="left" style="font-family:標楷體; width:950px">
	...
	<tr>
		<td height="30" colspan="2"><p>教師編制人數<?=($school_year-4)?>學年</p></td>
	...
	<tr>
		<td height="30" colspan="2">教師編制人數<?=($school_year-2)?>學年</td>
	...
	<tr>
		<td height="30" rowspan="4" nowrap="nowrap"><p align="center">四 </p></td>
		<td height="30" rowspan="4" nowrap="nowrap"><p>指標三：<br />國中學習弱勢學生比例偏高之學校</p></td>
	<!--   j104007,以下新增 102會考資料                             -->		
		<td height="30" colspan="2"><p><?=($school_year-3)?>學年度參加教育會考學生人數 </p></td>
		<td height="30" nowrap="nowrap"><p align="right"><?=$student_exam_ly; ?>(人)</p></td>
		<td height="30" rowspan="2" align="left" nowrap="nowrap">
		<p align="left">
		<?
			echo ($p3_2 == 1)?'符合指標三'.'<br />':'';
		?>&nbsp;
		</p></td>
	</tr>
	...
	<tr>
		...
		<td height="30" nowrap="nowrap"><p align="right"><?=$count_p3_ly; ?>(科)</p></td>
	</tr>
	<!--   j104007,以上新增                              -->
	<tr>
	...
	<tr>
		...
		<td height="30" colspan="2"><p><?=($school_year-4);?>至<?=($school_year-2);?>學年教師編制人數</p></td>            <!-- j10407,修改為   -->
	...
	<tr>
		...
		<td height="30" nowrap="nowrap"><p>教師異動人數<?=($school_year-4);?>學年度 </p></td>                             <!-- j10407,修改為   -->
	...
	<tr>
		<td height="30" nowrap="nowrap"><p>教師異動人數<?=($school_year-4);?>至<?=($school_year-2);?>學年合計 </p></td>
	...
	<tr>
		...
		<td height="30" nowrap="nowrap"><p>教師代理人數<?=($school_year-4);?>學年度 </p></td>
	...
	<tr>
		<td height="30" nowrap="nowrap"><p>教師代理人數<?=($school_year-4);?>至<?=($school_year-2);?>學年合計 </p></td>

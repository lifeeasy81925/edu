<?php
	...
	while($row = mysql_fetch_array($result))
	{
		...
		$q3_10_1b = $row['q3_10_1b'];
		$q3_10_1c = $row['q3_10_1c'];
		$q3_10_1d = $row['q3_10_1d'];
		
		$q3_10_2 = $row['q3_10_2'];
		$q3_10_2a = $row['q3_10_2a'];
		$q3_10_2b = $row['q3_10_2b'];
		$q3_10_2c = $row['q3_10_2c'];
		$q3_10_2d = $row['q3_10_2d'];
		
		$q3_10_3 = $row['q3_10_3'];
		$q3_10_3a = $row['q3_10_3a'];
		$q3_10_3b = $row['q3_10_3b'];
		$q3_10_3c = $row['q3_10_3c'];
		$q3_10_3d = $row['q3_10_3d'];
		
		$q3_10_4 = $row['q3_10_4'];
		$q3_10_4a = $row['q3_10_4a'];
		$q3_10_4b = $row['q3_10_4b'];
		$q3_10_4c = $row['q3_10_4c'];
		$q3_10_4d = $row['q3_10_4d'];		
...
<!-- 
	...
	<tr>
		...
		<tr>
		<td class="bg_content3">
			5.在指標界定方面，部分指標界定採用比率(例如:20%以上)，部分則採用人數(例如:…35人以上)，您認為:<br />
			<input type="radio" name="q1_5"  value="1" <?=(($q1_5 == '1')?"checked":"");?>/>只採用比率即可<br />
			<input type="radio" name="q1_5"  value="2" <?=(($q1_5 == '2')?"checked":"");?>/>只採用人數即可<br />
			<input type="radio" name="q1_5"  value="3" <?=(($q1_5 == '3')?"checked":"");?>/>兩者皆可<br />
	...
	<tr>
		<td class="bg_content2">
			6.您對教育優先區計畫之指標、補助項目以及指標與補助項目對照表之想法與意見為何? 請詳加說明：<br />
	...
	<tr>
		<td class="bg_content2">
			4.對於教育優先區計畫審核依據，您認為應如何進行?<br />
			<input type="radio" name="q2_4"  value="1" <?=(($q2_4 == '1')?"checked":"");?>/>維持現行審核計畫方式，以核定補助經費<br />
			<input type="radio" name="q2_4"  value="2" <?=(($q2_4 == '2')?"checked":"");?>/>將前一年度計畫執行成效納入審核依據<br />
			<input type="radio" name="q2_4"  value="3" <?=(($q2_4 == '3')?"checked":"");?>/>兩者皆納入審核依據<br />
	...
	<tr>
	    <td>
	        <table width="100%" border="1" cellspacing="0" cellpadding="0">
	           <tr>
		          <td align='center' valign='center' COLSPAN=5 height='30'>
                   <b>企業、團體或基金會名稱
				  </td>
				</tr>
	           <tr align='center'>
		         <td>
			           <select name="q3_10_1">
			           <option value="1" <?=(($q3_10_1 == '1')?"selected":"");?>>無</option>
...
　                     <option value="3" <?=(($q3_10_1 == '3')?"selected":"");?>>物資(設備)</option>
		          ...
		          <td>
		              <input type="text" size="13" name="q3_10_1a" value="<?=$q3_10_1a;?>">
		          </td>
		          <td>
		              <input type="text" size="13" name="q3_10_1b" value="<?=$q3_10_1b;?>">
		          </td>
				  <td>
		              <input type="text" size="13" name="q3_10_1c" value="<?=$q3_10_1c;?>">
		          </td>
				  <td>
		              <input type="text" size="13" name="q3_10_1d" value="<?=$q3_10_1d;?>">
		          </td>
		        <p>
		     </tr>
			 <tr align='center'>
		         <td>
			           <select name="q3_10_2">
			           <option value="1" <?=(($q3_10_2 == '1')?"selected":"");?>>無</option>
...
　                     <option value="3" <?=(($q3_10_2 == '3')?"selected":"");?>>物資(設備)</option>
		          ...
		          <td>
		              <input type="text" size="13" name="q3_10_2a" value="<?=$q3_10_2a;?>">
		          </td>
		          <td>
		              <input type="text" size="13" name="q3_10_2b" value="<?=$q3_10_2b;?>">
		          </td>
				  <td>
		              <input type="text" size="13" name="q3_10_2c" value="<?=$q3_10_2c;?>">
		          </td>
				  <td>
		              <input type="text" size="13" name="q3_10_2d" value="<?=$q3_10_2d;?>">
		          </td>
		        <p>
		     </tr>
			 <tr align='center'>
		         <td>
			           <select name="q3_10_3">
			           <option value="1" <?=(($q3_10_3 == '1')?"selected":"");?>>無</option>
...
　                     <option value="3" <?=(($q3_10_3 == '3')?"selected":"");?>>物資(設備)</option>
		          ...
		          <td>
		              <input type="text" size="13" name="q3_10_3a" value="<?=$q3_10_3a;?>">
		          </td>
		          <td>
		              <input type="text" size="13" name="q3_10_3b" value="<?=$q3_10_3b;?>">
		          </td>
				  <td>
		              <input type="text" size="13" name="q3_10_3c" value="<?=$q3_10_3c;?>">
		          </td>
				  <td>
		              <input type="text" size="13" name="q3_10_3d" value="<?=$q3_10_3d;?>">
		          </td>
		        <p>
		     </tr>
			 <tr align='center'>
		         <td>
			           <select name="q3_10_4">
			           <option value="1" <?=(($q3_10_4 == '1')?"selected":"");?>>無</option>
...
　                     <option value="3" <?=(($q3_10_4 == '3')?"selected":"");?>>物資(設備)</option>
		          ...
		          <td>
		              <input type="text" size="13" name="q3_10_4a" value="<?=$q3_10_4a;?>">
		          </td>
		          <td>
		              <input type="text" size="13" name="q3_10_4b" value="<?=$q3_10_4b;?>">
		          </td>
				  <td>
		              <input type="text" size="13" name="q3_10_4c" value="<?=$q3_10_4c;?>">
		          </td>
				  <td>
		              <input type="text" size="13" name="q3_10_4d" value="<?=$q3_10_4d;?>">
		          </td>
		        <p>
		     </tr>
		</table>

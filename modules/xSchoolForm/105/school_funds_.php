...
<div id="print_content">
	...
	<div style="display:<?=($a2_p1 == 'show')?'':'none';?>;">
		<table border="0">
			<tr>
				<td nowrap="nowrap">※特色一： <?=$p1_name;?>&nbsp;<?=($p1_IsContinue == "Y")?"(本年度為第 ".$p1_ContinueYear." 年辦理)":"";?>&nbsp;
	...
	<div style="display:<?=($table_1_ny1 == 'show')?'':'none';?>;">
		<table border="0">
			<tr>
				<td nowrap="nowrap">
	...
	<div style="display:<?=($table_1_ny2 == 'show')?'':'none';?>;">
		<table border="0">
			<tr>
				<td nowrap="nowrap">
	...
	<div style="display:<?=($a1_p1 == 'show')?'':'none';?>;">
		※家庭訪視<br />
		•預計申請個別家庭訪視 <?=$s_p2_people;?> 人次，
		申請輔助經費 <?=$s_p2_money;?> 元(200元/人)。
	</div>
	...
	<div style="display:<?=($table_2_ny1 == 'show')?'':'none';?>;">
		<table border="0">
			<tr>
				<td nowrap="nowrap">
		...
		<table width="800px" border="0" cellspacing="0" cellpadding="0" bgcolor="#FFFFCC" style="font-size:14px;">
			<tr>
				<td colspan="9" align="left" nowrap="nowrap" bgcolor="#FFCC66"  style="font-size:14px;"><?=$title_a;?><?=($a3_p1 == "show")?"　教師宿舍":"";?></td>
			</tr>
			<tr>
				<td width="10" align="center" nowrap="nowrap" bgcolor="#99CCCC">項次</td>
				<td align="left" nowrap="nowrap" bgcolor="#99CCCC">科目</td>
	...
	<div style="display:<?=($table_2_ny2 == 'show')?'':'none';?>;">
		<table border="0">
			<tr>
				<td nowrap="nowrap">
...
?>
<b>前往其他頁面：</b>
<a href="school_funds.php?op=1">補助一</a>&nbsp;
<a href="school_funds.php?op=2">補助二</a>&nbsp;
<a href="school_funds.php?op=3">補助三</a>&nbsp;
<a href="school_funds.php?op=4">補助四</a>&nbsp;
<a href="school_funds.php?op=5">補助五</a>&nbsp;
<a href="school_funds.php?op=6">補助六</a>&nbsp;
<a href="school_funds.php?op=7">補助七</a>&nbsp;
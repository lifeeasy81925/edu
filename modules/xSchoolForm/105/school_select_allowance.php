<?php
	...
	*/
	...
	//============================================================================================
	//補助項目計算
	$a1 = ($p1_1==1 || $p1_2==1 || $p1_3==1 || $p1_4==1 || $p2_1==1 || $p2_2==1 || $p3_1==1 || $p4_1==1 || $p5_1==1 || $p5_2==1);   //j10407新增 $p3_1==1
	...
	//設定：若符合補助項目五可申請，則補助項目二不符合(此項條件於104.12.24複審會議被提出，決議從106年度計畫起移出此限制，改由補助二或補助五當中至多選擇一項申請。)
	// if ($a5 == 1)
	// {
	// 	$a2 = 0;
...
<script language="JavaScript">
	...
	function toCheck() 
	{
		...
		if(document.getElementsByName("a5")[0] != undefined)
		{
			if(document.getElementsByName("a5")[0].checked == true)
				a5 = 1;
		}
		...
		if (check25 > 1) 
		{
			alert("補助二與補助五僅能擇一申請，不得同時申請補助二與補助五。");
			return false;
		}

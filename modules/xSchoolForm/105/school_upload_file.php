<?php
	...
	//echo "<p>根目錄：".$_SERVER['DOCUMENT_ROOT']."<p>";
	...
	$sql = " select sd.account, sd.schooltype, sd.cityname, sd.district, sd.schoolname, sd.area, sd.getmoney_85to91, sd.traffic_status ".
		   ...
		   //補五資料
		   "      , a5.s_total_money as a1_money, a5.s_p1_money as a5_p1_money, a5.s_p2_money as a5_p2_money, a5.inherit_year as a5_inherit_year  ".
	...
	<tr bgcolor="#CCFFCC">		
		<td>			
			<form onSubmit="return check()" action="file_up.php?sy_seq=<?=$sy_seq;?>&school_year=<?=$school_year;?>" method="post" enctype="multipart/form-data" target="_self">
				<p><p>
				<b>教育部<?=$school_year;?>年度推動教育優先區指標界定調查紀錄表 - 學校</b><p><p>
				<input type="hidden" name="max_file_size" value="102400000">
				<input type="hidden" name="column_name" value="final_1">
				<input type="file" name="myfile">
				<input type="submit" value="上傳「指標界定調查表」">
			<table><tr><td width="47%">
				指標界定調查表：
				<? 
					if ($final_1 == '')
						echo "<font color=red>未上傳</font> (上傳後請按F5更新狀態)";
					else 
						//echo '<font color=blue>已上傳</font>'.'&nbsp;&nbsp;&nbsp;&nbsp;'.'<a href="'.$file_path.$final_1.'" target="_new">下載已上傳檔案</a>';
					echo "<font color='blue'>已上傳</font></td><td><a href='".$file_path.$final_1."' target='_new'><img src='../../../images/btn_dl.png'/></a><p>";	
				?>
			</td>
			</tr>
			</table>
...
<? if($keep == 1){echo "-->";} ?>
	<tr bgcolor="#CCFFCC">
		<td>			
			<form onSubmit="return check()" action="file_up.php?sy_seq=<?=$sy_seq;?>&school_year=<?=$school_year;?>" method="post" enctype="multipart/form-data" target="_self">
				<p><p>
				<b>教育部<?=$school_year;?>年度推動教育優先區補助項目經費需求彙整表 - 學校</b><p><p>
				<input type="hidden" name="max_file_size" value="102400000">
				<input type="hidden" name="column_name" value="final_2">
				<input type="file" name="myfile">
				<input type="submit" value="上傳「經費需求彙整表」">
			<table><tr><td width="47%">
				經費需求彙整表：
				<? 
					if ($final_2 == '')
						...
						//echo '<font color=blue>已上傳</font>'.'&nbsp;&nbsp;&nbsp;&nbsp;'.'<a href="'.$file_path.$final_2.'" target="_new">下載已上傳檔案</a>';
					    echo "<font color='blue'>已上傳</font></td><td><a href='".$file_path.$final_2."' target='_new'><img src='../../../images/btn_dl.png'/></a><p>";
...
<table width="90%" border="1" cellspacing="0" cellpadding="0">
			...
			<table><tr><td width="47%">
				...
				<? 
					if ($point2 == '')
						...
						//，檔名：'.'<a href="'.$file_path.$point2.'" target="_new">'.$point2.'</a>';
	...
	<tr style="display:<?=(in_array('a1',$applied_ary))?'':'none';?>;">
		<td>
			...
			<form onSubmit="return check()" action="file_up.php?sy_seq=<?=$sy_seq;?>&school_year=<?=$school_year;?>" method="post" enctype="multipart/form-data" target="_self">
				...
				<input type="file" name="myfile">
				<input type="submit" value="上傳「親職教育講座實施計畫」">
			<table><tr><td width="47%">
				　親職教育講座實施計畫：
				<? 
					if ($a1_1 == '')
					    ...
					    echo "<font color='blue'>已上傳</font></td><td><a href='".$file_path.$a1_1."' target='_new'><img src='../../../images/btn_dl.png'/></a>";
				?>
			</td>
			</tr>
			</table>
			...
			<form onSubmit="return check()" action="file_up.php?sy_seq=<?=$sy_seq;?>&school_year=<?=$school_year;?>" method="post" enctype="multipart/form-data" target="_self">
				...
				<input type="file" name="myfile">
				<input type="submit" value="上傳「家庭訪視實施計畫」">
			<table><tr><td width="47%">
				　家庭訪視實施計畫：
				<? 
					if ($a1_2 == '')
					    ...
					    echo "<font color='blue'>已上傳</font></td><td><a href='".$file_path.$a1_2."' target='_new'><img src='../../../images/btn_dl.png'/></a>"; 
				?>
			</td>
			</tr>
			</table>
	...
	<tr style="display:<?=(in_array('a2',$applied_ary))?'':'none';?>;">
		<td>
			...
			<form onSubmit="return check()" action="file_up.php?sy_seq=<?=$sy_seq;?>&school_year=<?=$school_year;?>" method="post" enctype="multipart/form-data" target="_self">
				...
				<input type="file" name="myfile">
				<input type="submit" value="上傳「特色一實施計畫」">
			<table><tr><td width="47%">
				　特色一實施計畫：
				<? 
					if ($a2_1 == '')
					   ...
					   echo "<font color='blue'>已上傳</font></td><td><a href='".$file_path.$a2_1."' target='_new'><img src='../../../images/btn_dl.png'/></a>"; 
				?>
			</td>
			</tr>
			</table>
			...
			<form onSubmit="return check()" action="file_up.php?sy_seq=<?=$sy_seq;?>&school_year=<?=$school_year;?>" method="post" enctype="multipart/form-data" target="_self">
				...
				<input type="file" name="myfile">
				<input type="submit" value="上傳「特色二實施計畫」">
			<table><tr><td width="47%">
				　特色二實施計畫：
				<? 
					if ($a2_2 == '')
					    ...
					    echo "<font color='blue'>已上傳</font></td><td><a href='".$file_path.$a2_2."' target='_new'><img src='../../../images/btn_dl.png'/></a>"; 
				?>
			</td>
			</tr>
			</table>
	...
	<tr style="display:<?=(in_array('a3_1',$applied_ary) || in_array('a3_2',$applied_ary))?'':'none';?>;">
		<td>
			<b>● 補助項目三：修繕離島或偏遠地區教師宿舍</b>
			<p>
			<form onSubmit="return check()" action="file_up.php?sy_seq=<?=$sy_seq;?>&school_year=<?=$school_year;?>" method="post" enctype="multipart/form-data" target="_self">
				<input type="hidden" name="max_file_size" value="102400000">
				<input type="hidden" name="column_name" value="a3_1">
				<input type="file" name="myfile">
				<input type="submit" value="上傳「實施計畫」">
			<table><tr><td width="47%">
				　實施計畫：
				<? 
					if ($a3_1 == '')
					    ...
					    echo "<font color='blue'>已上傳</font></td><td><a href='".$file_path.$a3_1."' target='_new'><img src='../../../images/btn_dl.png'/></a>"; 
				?>
			</td>
			</tr>
			</table>
			...
			<form onSubmit="return check()" action="file_up2.php?sy_seq=<?=$sy_seq;?>&school_year=<?=$school_year;?>" method="post" enctype="multipart/form-data" target="_self">
				...
				<input type="file" name="myfile">
				<input type="submit" value="上傳「近三年住宿人員資料」">
			<table><tr><td width="47%">
				　近三年住宿人員資料：
				<? 
					if ($a3_2 == '')
	...
	<tr style="display:<?=(in_array('a4',$applied_ary))?'':'none';?>;">
		<td>
			...
			<table><tr><td width="47%">
				...
				<? 
					if ($a4_1 == '')
						...
						//echo '<font color=blue>已上傳</font>'.'&nbsp;&nbsp;&nbsp;&nbsp;'.'<a href="'.$file_path.$a4_1.'" target="_new">下載已上傳檔案</a>';
			...
			<form onSubmit="return check()" action="file_up.php?sy_seq=<?=$sy_seq;?>&school_year=<?=$school_year;?>" method="post" enctype="multipart/form-data" target="_self">
				...
				<input type="file" name="myfile">
				<input type="submit" value="上傳「領域小組會議紀錄」">
			<table><tr><td width="47%">
				　領域小組會議紀錄：
				<? 
					if ($a4_2 == '')
						...
						//echo '<font color=blue>已上傳</font>'.'&nbsp;&nbsp;&nbsp;&nbsp;'.'<a href="'.$file_path.$a4_2.'" target="_new">下載已上傳檔案</a>';
					    echo "<font color='blue'>已上傳</font></td><td><a href='".$file_path.$a4_2."' target='_new'><img src='../../../images/btn_dl.png'/></a>"; 
	...
	<? if($a5_inherit_year == '104'){echo "<!--";} ?>
	<tr style="display:<?=(in_array('a5',$applied_ary))?'':'none';?>;">
		<td>
			<b>● 補助項目五：發展原住民教育文化特色及充實設備器材</b>
			<?
			...
			<table><tr><td width="47%">
				...
				<? 
					if ($a5_1 == '')
					    ...
					    echo "<font color='blue'>已上傳</font></td><td><a href='".$file_path.$a5_1."' target='_new'><img src='../../../images/btn_dl.png'/></a>"; 
				?>
			</td>
			</tr>
			</table>
			...
			<table><tr><td width="47%">
				...
				<? 
					if ($a5_2 == '')
					    ...
					    echo "<font color='blue'>已上傳</font></td><td><a href='".$file_path.$a5_2."' target='_new'><img src='../../../images/btn_dl.png'/></a>"; 
				?>
			</td>
			</tr>
			</table>
	...
	<tr style="display:<?=(in_array('a6',$applied_ary))?'':'none';?>;">
		<td>
			...
			<table><tr><td width="47%">
				...
				<? 
					if ($a6_1 == '')
					    ...
					    echo "<font color='blue'>已上傳</font></td><td><a href='".$file_path.$a6_1."' target='_new'><img src='../../../images/btn_dl.png'/></a>"; 
				?>
			</td>
			</tr>
			</table>
			...
			<form onSubmit="return check()" action="file_up2.php?sy_seq=<?=$sy_seq;?>&school_year=<?=$school_year;?>" method="post" enctype="multipart/form-data" target="_self">
				...
				<input type="file" name="myfile">
				<input type="submit" value="上傳「各搭車路線學生名冊」">
			<table><tr><td width="47%">
				　各搭車路線學生名冊：
				<? 
					if ($a6_2 == '')
			...
			<form onSubmit="return check()" action="file_up.php?sy_seq=<?=$sy_seq;?>&school_year=<?=$school_year;?>" method="post" enctype="multipart/form-data" target="_self">
				...
				<input type="file" name="myfile">
				<input type="submit" value="上傳「學校現有交通車調查表」">
			<table><tr><td width="47%">
				　學校現有交通車調查表：
				<? 
					if ($a6_3 == '')
					    ...
					    echo "<font color='blue'>已上傳</font></td><td><a href='".$file_path.$a6_3."' target='_new'><img src='../../../images/btn_dl.png'/></a>"; 
				?>
			</td>
			</tr>
			</table>
	...
	<tr style="display:<?=(in_array('a7',$applied_ary))?'':'none';?>;">
		<td>
			<b>● 補助項目七：整修學校社區化活動場所</b>
			<p>
			<form onSubmit="return check()" action="file_up.php?sy_seq=<?=$sy_seq;?>&school_year=<?=$school_year;?>?sy_seq=<?=$sy_seq;?>&school_year=<?=$school_year;?>" method="post" enctype="multipart/form-data" target="_self">
				<input type="hidden" name="max_file_size" value="102400000">
			...
			<table><tr><td width="47%">
				...
				<? 
					if ($a7_1 == '')
					    ...
					    echo "<font color='blue'>已上傳</font></td><td><a href='".$file_path.$a7_1."' target='_new'><img src='../../../images/btn_dl.png'/></a>"; 
				?>
			</td>
			</tr>
			</table>
	...
	<tr>
		<td>
			<p>
			<p>
			● 說明1：若未出現可上傳的項目則表示不需上傳檔案。
			<p>
			<p>
			● 說明2：部分上傳項目需填寫完概算表之後才會出現。
		</td>
	</tr>
</table>
</div>

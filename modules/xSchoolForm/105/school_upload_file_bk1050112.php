	...
	<tr>
		<td>
			...
			<form onSubmit="return check()" action="file_up.php?sy_seq=<?=$sy_seq;?>&school_year=<?=$school_year;?>" method="post" enctype="multipart/form-data" target="_self">
				<b>教育部<?=$school_year;?>年度推動教育優先區指標界定調查紀錄表─學校</b><br />
				...
				<? 
					...
					echo "<font color='blue'>已上傳</font>&nbsp;&nbsp;&nbsp;&nbsp;<a href='".$file_path.$final_1."' target='_new'><img src='../../../images/btn_dl.png'/></a>";
...
<? if($keep == 1){echo "-->";} ?>
	<tr>
		<td>
			<div style="background-color:#CFC">
			<form onSubmit="return check()" action="file_up.php?sy_seq=<?=$sy_seq;?>&school_year=<?=$school_year;?>" method="post" enctype="multipart/form-data" target="_self">
				<b>教育部<?=$school_year;?>年度推動教育優先區補助項目經費需求彙整表─學校</b><br />
				<input type="hidden" name="max_file_size" value="102400000">
				...
				<? 
					if ($final_2 == '')
					    ...
					    echo "<font color='blue'>已上傳</font>&nbsp;&nbsp;&nbsp;&nbsp;<a href='".$file_path.$final_2."' target='_new'><img src='../../../images/btn_dl.png'/></a>";
			...
			<form onSubmit="return check()" action="file_up.php?sy_seq=<?=$sy_seq;?>&school_year=<?=$school_year;?>" method="post" enctype="multipart/form-data" target="_self">
				...
				<? 
					if ($a4_1 == '')
					    ...
					    echo "<font color='blue'>已上傳</font>&nbsp;&nbsp;&nbsp;&nbsp;<a href='".$file_path.$a4_1."' target='_new'><img src='../../../images/btn_dl.png'/></a>"; 
				?>
			</form>
			<form onSubmit="return check()" action="file_up.php?sy_seq=<?=$sy_seq;?>&school_year=<?=$school_year;?>" method="post" enctype="multipart/form-data" target="_self">
				<input type="hidden" name="max_file_size" value="102400000">

<?php
    ...
    // include "bootbox.php";  //1040521新增,引入bootbox  // 105.05.25隱藏
...
<img src="/edu/images/history.png" align="absmiddle" height="20px"> 歷史資料查詢區 / <b><?=$school_year;?>年度 填報申請狀態</b>
	...
	<tr>
		...
		<?
		 if($keep == 0)
		 {
			...
			{
				echo "指標界定調查表：<font color='blue'>已上傳</font></td><td><a href='".$file_path.$final_1."' target='_new'><img src='../../../images/btn_dl.png'/></a>";
			}
		 }
		?>
		</td>

<?php
	...
	$sql = " select sd.account, sd.schooltype, sd.cityname, sd.district, sd.schoolname, sd.area, sd.getmoney_85to91, sd.traffic_status ".
		   ...
		   //補二資料
		   "      , a2.s_total_money as a2_money, a2.s_p1_money as a2_p1_money, a2.s_p2_money as a2_p2_money ".
		   //補三資料
		   "      , a3.s_total_money as a3_money ".
		   //補四資料
		   "      , a4.s_total_money as a4_money ".
		   //補五資料
		   "      , a5.s_total_money as a5_money, a5.s_p1_money as a5_p1_money, a5.s_p2_money as a5_p2_money ".
		   //補六資料
...
<div style="background-color:#F96"><b>※請上傳以下<?=($z == 2)?'兩個':''; ?>檔案才算填報完成</b>：(須經校長核章)</div>
<? if($z < 1){echo "<!--";} ?>
...
<? 
	...
	{
		//echo '經費需求彙整表：<font color=blue>已上傳</font>'.'&nbsp;&nbsp;&nbsp;&nbsp;'.'<a href="'.$file_path.$final_1.'" target="_new">下載已上傳檔案</a>';
...
<? 
	...
	{
		//echo '經費需求彙整表：<font color=blue>已上傳</font>'.'&nbsp;&nbsp;&nbsp;&nbsp;'.'<a href="'.$file_path.$final_2.'" target="_new">下載已上傳檔案</a>';
		echo "經費需求彙整表：<font color='blue'>已上傳</font>&nbsp;&nbsp;&nbsp;&nbsp;<a href='".$file_path.$final_2."' target='_new'><img src='../../../images/btn_dl.png'/></a>";
	}
?>
</p>
</div>
<div style="display:<?=($page3_warning == '')?'none':''; //空白就不顯示?>;">
	...
	<div style="background-color:#CFC">
		<? 
			...
			{
				echo '目標學生名冊：<font color=blue>已上傳</font>';
			}
		?>
	</div>
	<p>

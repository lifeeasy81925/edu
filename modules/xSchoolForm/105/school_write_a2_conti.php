...
<table border="0">
	<tr>
		...
		<td><input type="text" size="20" name="p1_name" value="<?=$p1_name;?>" style="border:0px; " readonly>(特色名稱)
			，參加學生人數<input type="text" size="6" name="s_p1_student" value="<?=$s_p1_student;?>" style="border:0px; " onChange="js:target_per('p1',this);">人
			，其中含目標學生<input type="text" size="6" name="s_p1_target" value="<?=$s_p1_target;?>" style="border:0px; " onChange="js:target_per('p1',this);">人
	...
	<tr>
		<td colspan="2">
			...
			本年度為第<input type="text" size="2" name="p1_ContinueYear" value="<?=$p1_ContinueYear;?>" style="border:0px; text-align: right;" readonly>年辦理。
		</td>
	</tr>
	<tr>
...
<table border="0">
	<tr>
		...
		<td><input type="text" size="20" name="p2_name" value="<?=$p2_name;?>" style="border:0px; " readonly >(特色名稱)
			，參加學生人數<input type="text" size="6" name="s_p2_student" value="<?=$s_p2_student;?>" style="border:0px; " onChange="js:target_per('p2',this);">人
			，其中含目標學生<input type="text" size="6" name="s_p2_target" value="<?=$s_p2_target;?>" style="border:0px; " onChange="js:target_per('p2',this);">人
	...
	<tr>
		<td colspan="2">
			...
			本年度為第<input type="text" size="2" name="p2_ContinueYear" value="<?=$p2_ContinueYear;?>" style="border:0px; text-align: right;" readonly >年辦理。
		</td>
	</tr>
	<tr>
		<td nowrap="nowrap" colspan="2">
...
<?
	//顯示特色二 細項
	print_item($a2_table_name_item, 'p2_'.($school_year+1), $main_seq);
	
?>
</table>
<? //if ($s_total_money_ny1 == 0) echo "-->" ;?>
<? if(($class_total < $keyClasses) ||($s_total_money_ny1 == 0)) echo "-->"; ?>
...
<?
	//顯示特色二 細項
	print_item($a2_table_name_item, 'p2_'.($school_year+2), $main_seq);         
...
<INPUT TYPE="button" VALUE="修改經費內容" onclick="if(confirm('※重要提醒!!\n修改內容後，必須重新進入初審及複審作業，您確定要修改內容?')){location.href='school_write_a2_change.php'}">

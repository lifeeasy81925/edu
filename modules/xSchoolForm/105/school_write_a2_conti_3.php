...
<script language="JavaScript">
	...
	function count_all()
	{
		...
		//var s_total_money_ny2 = document.getElementsByName('s_total_money_ny2')[0]; //總金額，原本的
		...
		for(i = 1;i < 10;i++)
		{
			for(k = school_year;k <= school_year+2;k++)
			{
				...
				if(s_p_money != null)
				{
					...
					{
						s_total_money_ny2.value = parseInt(s_total_money_ny2.value) + parseInt(s_p_money.value); //所有特色的總和   //j-10407,原本的
						//s_total_money_ny2.value = 0; //j-10407
					}

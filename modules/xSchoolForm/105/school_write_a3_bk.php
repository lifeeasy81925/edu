...
　<label><input type="radio" name="rdo_last5year" value="Y" id="rdo_last5year_0" onclick="<?=$disable_radio;?>" <?=($apply_last5year == 'Y')?'checked':'';?> />是</label>(99、100、101、102、103年度曾接受本項補助之宿舍，不得再提出申請)<br />

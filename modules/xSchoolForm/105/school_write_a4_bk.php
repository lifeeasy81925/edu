...
　<label><input type="radio" name="rdo_last3year" value="Y" id="rdo_last3year_0" onclick="<?=$disable_radio;?>" <?=($apply_last3year == 'Y')?'checked':'';?> />是</label>(101、102、103年度已接受本項補助者，不得再提出申請)<br />

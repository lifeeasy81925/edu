<?php
	...
	while($row = mysql_fetch_array($result))
	{
		...
		//$aboriginal = $row['aboriginal']; //j10410
...
元 (本列自動計算)</font><br />
說明：原住民學生100人(含)以下最高補助12萬元，原住民學生超過100人最高補助25萬元，分校分班最高補助8萬元，且<font color="red">「須發展原住民的相關特色」</font>；<font color="red">鐘點費(含補充保費)，金額會自動計入額外2%金額</font>。
<p>
...
<?
	//顯示特色一 細項
	print_item($a5_table_name_item, 'p1_'.($school_year+2), $main_seq);             //j10407，修改為($school_year+2)，原106
...
<?
	//顯示特色二 細項
	print_item($a5_table_name_item, 'p2_'.($school_year+2), $main_seq);             //j10407，修改為($school_year+1)，原105
...
<script language="JavaScript">
	function toCheck() 
	{
		...
		//if(<?=$aboriginal;?> < 100 ){var maxMon = 120000; }else{var maxMon = 250000;}  //j10410
		//alert(maxMon);

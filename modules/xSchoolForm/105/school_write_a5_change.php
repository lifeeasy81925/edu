<?
	...
	$sql = " select sd.account, sd.schooltype, sd.cityname, sd.district, sd.schoolname, sd.area, sd.getmoney_85to91, sd.traffic_status ".
		   ...
		   "      , a5_item_ny.seq_no as a5_item_seq_no_ny ".		   
		   "      , a5_item_ny.main_seq as main_seq_ny ".
		   "      , a5_item_ny.city_money as city_money_ny ".
		   "      , a5_item_ny.city_delete as city_delete_ny ".		   
		   "      , a5_item_ny.edu_money as edu_money_ny ".
		   "      , a5_item_ny.edu_delete as edu_delete_ny ".		
		   ...
		   "                       left join alc_aboriginal_education_item as a5_item on sy.seq_no = a5_item.main_seq ".		   
		   
		   //j-10407,新增
		   "                       left join schooldata_year as sy_ny on sd.account = sy_ny.account and sy_ny.school_year = '".($school_year + 1)."' ". 
		   "                       left join alc_aboriginal_education_item as a5_item_ny on sy_ny.seq_no = a5_item_ny.main_seq ".				   
		   //--
...
//        $edu_desc = $row['edu_desc'];
        ...
        $seq_no_ny = $row['seq_no_ny'];    //schooldata_year的seq_no
		
        $main_seq_ny = $row['main_seq_ny'];
		$a5_item_seq_no_ny = $row['a5_item_seq_no_ny'];      //a5_item的seq_no
...
//		echo "<br>"."main_seq:".$main_seq."--main_seq_ny:".$main_seq_ny."--seq_no_ny:".$seq_no_ny."-----s_money:".$s_money."<br>";
           ...
           /*if($main_seq = $main_seq_ny) //j-10407，新增	,若$main_seq = $main_seq_ny，則更新，否則插入新資料   
					{*/
						$sql_update_item = " update $table_name_item set city_money = NULL ".										   
					            		   "                           , city_delete = NULL  ".	
	    				            	   "                           , edu_money = NULL  ".
						             	   "                           , edu_delete = NULL  ".															   
							   
						            	   " where seq_no = '$a5_item_seq_no_ny' and  main_seq = '$seq_no_ny' ; ";   //and main_seq = '$main_seq_ny'
	...
	$num_rows = mysql_num_rows($result);  
	         ...
	         { */
	        	  $insert_sql = "insert into alc_aboriginal_education (sy_seq, account, school_year) ".
...
//j-10407，新增，帶入104年初複審金額及意見
           ...
           "                      , city_total_money  = NULL ".
		   
           "                      , city_desc = NULL ".            // j-10407帶入105度初審意見
           "                      , city_desc_ny1 = NULL ".        //j-10407帶入106度初審意見
//           "                      , city_desc_ny2 = '$city_desc_ny2' ".
           "                      , city_desc_p2 = NULL ".      //帶入105度初審意見
           "                      , city_desc_ny1_p2 = NULL ".  //帶入105度初審意見
...
*/		   
         ...
         "                      , city_approved_id = NULL ".
           ...
           "                      , edu_desc = NULL ".               //帶入105度複審意見
           "                      , edu_desc_ny1 = NULL ".           //帶入106度複審意見
...
//--		   
	...
	if(mysql_query($sql))
	{
        ...
        echo "</script>";
		echo '<meta http-equiv=REFRESH CONTENT=0;url=school_write_a5_conti_3.php>';
	}
	else
	{
		echo '新增失敗!';
...
<!--
	...
	{
		echo '新增失敗!';
		echo '<meta http-equiv=REFRESH CONTENT=2;url=school_write_a5.php>';
		//echo (mysql_errno() != 0)?"5 : ".$sql."<br />".mysql_errno().mysql_error()."<br />----<br />":""; 
	}

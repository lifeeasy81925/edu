<?php
	...
	while($row = mysql_fetch_array($result))
	{
		...
		//$s_total_money_ny2 = ($row['s_total_money_ny2'] == '')?0:$row['s_total_money_ny2']; //NULL則填入0  ，原本的
		     //j-10407,直接給0
		/*
		...
		*/
		...
		$s_total_money_ny2 = 0; 
		$s_p1_money_ny2 = 0;
		$s_p1_current_cnt_ny2 = 0;
		$s_p1_current_money_ny2 = 0;
		$s_p1_capital_cnt_ny2 = 0;
		$s_p1_capital_money_ny2 = 0;
		$s_p2_money_ny2 = 0;
		$s_p2_current_cnt_ny2 = 0;
		$s_p2_current_money_ny2 = 0;
		$s_p2_capital_cnt_ny2 = 0;
		$s_p2_capital_money_ny2 = 0;
...
<p><b>補助項目五：發展原住民教育文化特色及充實設備器材</b>　<a href="allowance-02.htm" target="_blank">(補助項目說明)</a>
<p>
<font color=blue>※補助發展原住民教育文化特色及充實設備器材-申請補助經費：<?=$school_year;?>年度：<input type="text" size="6" name="s_total_money" value="<?=$s_total_money;?>" style="border:0px; text-align: right;" readonly >
元 (本列自動計算)</font><br />
<font color=blue>※補助發展原住民教育文化特色及充實設備器材-申請補助經費：<?=($school_year+1);?>年度：<input type="text" size="6" name="s_total_money_ny1" value="<?=$s_total_money_ny1;?>" style="border:0px; text-align: right;" readonly >
元 (本列自動計算)</font><br />
<? if ($s_total_money_ny2 == 0) echo "<!--" ;?>
<font color=blue>※發展原住民教育文化特色及充實設備器材-申請補助經費：<?=($school_year+2);?>年度：<input type="text" size="6" name="s_total_money_ny2" value="<?=$s_total_money_ny2;?>" style="border:0px; text-align: right;" readonly >
元 (本列自動計算)</font><br />
<? if ($s_total_money_ny2 == 0) echo "-->" ;?>
...
<?
	//顯示特色一 細項
	print_item($a5_table_name_item, 'p1_'.($school_year+1), $main_seq);
...
<?
	//顯示特色一 細項
	print_item($a5_table_name_item, 'p1_'.($school_year+2), $main_seq);
...
<?
	//顯示特色二 細項
	print_item($a5_table_name_item, 'p2_'.($school_year+1), $main_seq);
...
<?
	//顯示特色二 細項
	print_item($a5_table_name_item, 'p2_'.($school_year+2), $main_seq);         

...
<a href="/edu_dl/105/105_各搭車路線學生名冊.xls" target="_new">下載：各搭車路線學生名冊(空白)</a><br />
			...
			if(rdo.checked == true)
			{
				...
				switch(i)
				{
					...
					case 3:
						...
						else if (people.value >= 12 && people.value <= 21 && money.value > 2760000)     //j10407,修改
						{

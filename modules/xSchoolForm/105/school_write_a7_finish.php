...
<?php
	...
	$table_name_item = "alc_school_activity_item";
	...
	$year_85to91 = $_POST['year_85to91']; //85~91的哪一年獲得補助，填寫年分，可不填
	$money_85to91 = $_POST['money_85to91']; //補助多少錢，可不填
	...
	$sql = " update $table_name set s_total_money='$s_total_money' ".
		   "                      , p_num='$p_num' ".
		   "                      , year_85to91='$year_85to91' ".
		   "                      , money_85to91='$money_85to91' ".
	...
	{
		echo '新增失敗!';
		echo '<meta http-equiv=REFRESH CONTENT=2;url=school_write_a7.php>';

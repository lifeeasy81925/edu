<?php
	...
	while($row = mysql_fetch_array($result))
	{
		...
		$money_last5 = 0; //目前沒資料
		$money_last4 = ($row['a4'] == '')?0:$row['a4'];;                //j10407,資料上移，101年資料
		$money_last3 = ($row['a168'] == '')?0:$row['a168'];             //j10407,資料上移，102年資料
		$money_last2 = $a3_l2y_money;                                   //j10407，新增，前(103)年資料的資料表
		$money_last =  $a3_ly_money;                                    //104年資料
		...
		if($money_last > 0 || $money_last2 > 0 || $money_last3 > 0 || $money_last4 > 0 || $money_last5 > 0) 
		{
			...
			$strmsg_a3 .= ($money_last > 0)?($school_year - 1)." 年度 <font color='red'>".$money_last."</font> 元。":"";    //104
			$strmsg_a3 .= ($money_last2 > 0)?($school_year - 2)." 年度 <font color='red'>".$money_last2."</font> 元。":"";  //103
			$strmsg_a3 .= ($money_last3 > 0)?($school_year - 3)." 年度 <font color='red'>".$money_last3."</font> 元。":"";  //102
			$strmsg_a3 .= ($money_last4 > 0)?($school_year - 4)." 年度 <font color='red'>".$money_last4."</font> 元。":"";  //101
...
<p>
<font color="blue"><strong>學校基本資料-105</strong></font>
<p>
<table border="0">
	<tr>
		<td>
			...
			<table>
				<tr>
					<td width="200px" nowrap="nowrap" style="text-align:right;">
						<?=($school_year-3);?>學年度全校學生人數：
					</td>
					<td>
						<font color=blue><?=$last2student;?></font> 人<em><sup>(註2)</sup></em>
					</td>
				</tr>
				<tr>
					...
					<td>
						<input type="text" size="6" name="student" value="<?=$student;?>" />人<font color=blue>(<?=($school_year-2);?>年9月30日在籍學生數為準)</font>
					</td>
				</tr>
				<tr>
					<td nowrap="nowrap" style="text-align:right;">

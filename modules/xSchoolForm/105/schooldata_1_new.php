<?php
	...
	$sql = " select sd.account, sd.schooltype, sd.cityname, sd.district, sd.schoolname, sd.area ".
		   ...
		   "      , a3_l2y.edu_total_money as a3_l2y_money ".               //j10407,新增前(103)年複審金額			   
		   
		   //補四歷史資料
		   "      , sf101.a5 ". //101補助5 金額(101的補助5=現在的補助4)
		   "      , sd102.a169 ". //102補助4 金額
		   "      , a4_ly.edu_total_money as a4_ly_money ".      //104
		   "      , a4_l2y.edu_total_money as a4_l2y_money ".	 //103	                                                                 //j10407，新增，前年資料的資料表
...
<p>
<font color="blue"><strong>學校基本資料_105_new</strong></font>
<p>
<table border="0">
	<tr>
		<td>
							...
							for($i = 0;$i < count($traffic);$i++)
							{
								...
								switch($traffic[$i])
								{
									...
									case "3":
										...
										break;
									case "4":
										$str .= "學區內之社區距離學校5公里以上，且無公共交通工具可以達學校";     //$bus_stop == '1'
										break;
									case "5":
										$str .= "公共交通工具到學校所在地區每天少於4班次";                       //$bus_stop == '2'
										break;
									case "6":
...
<script language="JavaScript">
	...
	function toCheck() 
	{
		...
		<? if($isSurvey_1 == "N") { echo "/*"; }?> 
	    if ( document.form.high.value == "" ) 
		{
			errmsg += "請填寫「學校高度」！\n";
			document.form.high.focus();
			flag = 0;
		}
		<? if($isSurvey_1 == "N") { echo "*/"; }?> 
		if ( document.form.bonus.value == "" ) 
		{
			errmsg += "請選擇「學校有無加給」！\n";
			document.form.bonus.focus();
			flag = 0;
		}
		/*
		...
		if ( document.form.bonus.value == "有" ) 
		{
			if ( document.form.bonus_name.value == "" )
			{
			   errmsg += "請填寫「加給名稱」！\n";
			   document.form.bonus_name.focus();
			   flag = 0;
		    }
			if ( document.form.bonus_money.value == "" )
			{
			   errmsg += "請填寫「加給金額」！\n";
			   document.form.bonus_money.focus();
			   flag = 0;
		    }
		}		
		/*
		...
		*/
		<? if($isSurvey_1 == "N") { echo "/*"; }?>
		if ( document.form.cityhall.value == "" ) 
		{
			errmsg += "請填寫「學校距離縣市政府距離」！\n";
			document.form.cityhall.focus();
			flag = 0;
		}
		if ( document.form.localoffice.value == "" ) 
		{
			errmsg += "請填寫「學校距離所在地公所距離」！\n";
			document.form.localoffice.focus();
			flag = 0;
		}
		if ( document.form.cityhall.value > 200 ) 
		{
			errmsg += "「學校距離縣市政府距離」超過200公里！\n";
			document.form.cityhall.focus();
			flag = 0;
		}		
		if ( document.form.localoffice.value > 200 ) 
		{
			errmsg += "請填寫「學校距離所在地公所距離」超過200公里！\n";
			document.form.localoffice.focus();
			flag = 0;
		}
        <? if($isSurvey_1 == "N") { echo "*/"; }?>		

<?php
	...
	$sql = " select sd.account, sd.schooltype, sd.cityname, sd.district, sd.schoolname, sy.student ".
		   ...
		   "	  , sy_ly.teacher as teacher_ly ". //103年編制、調入、實缺、其他
		   ...
		   //去年資料的資料表
		   "                       left join schooldata_year as sy_ly on sd.account = sy_ly.account and sy_ly.school_year = '".($school_year - 2)."' ".  //10406修正，沿用103年資料
	...
	while($row = mysql_fetch_array($result))
	{
		...
		$teacher_last = ($row['teacher_ly'] == "")?"0":$row['teacher_ly']; //103年教師編制
		//若無資料則代入去年的 
...
<p><font color="blue"><strong>學校教師資料_105_sd2</strong></font>

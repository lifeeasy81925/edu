<?php
	...
	//教育部核定金額
	$sql =  "    SELECT a2.edu_total_money         ".
			"         , a2.edu_p1_current_money    ".
			"         , a2.edu_p1_capital_money    ".
			"         , a2.edu_p2_current_money    ".
			"         , a2.edu_p2_capital_money    ".
			"         , a2.p1_name                 ".
			"         , a2.p2_name                 ".
			"         , a2_e.*                     ".
			"      FROM $table_name        AS a2   ".
			" LEFT JOIN $table_name_effect AS a2_e ".
			"        ON a2.sy_seq = a2_e.sy_seq    ".
...
<?=$school_year;?>年度 執行成效與修正後計畫 / <b>補助項目二：補助學校發展教育特色 執行情形</b>
...
<form name="form" method="post" action="effect_school_02_finish.php" onSubmit="return toCheck();">
	...
	<a href="allowance-02.htm" target="_blank">● 補助項目說明</a><p>

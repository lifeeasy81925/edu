...
<?
	...
	while($row = mysql_fetch_array($result))
	{
		...
		$a4_money_ny2 = ($row['a4_money_ny2'] == '')?0:$row['a4_money_ny2'];//a2_city_money_ny2
...
<div id="print_content">
	...
	<table width="900px" align="center" border="1" cellpadding="5" cellspacing="0">
		<tr height="60px" align="center" bgcolor="honeydew" style="font-family:標楷體; font-size:20px;">
			...
			<td nowrap="nowrap" colspan="3"><?=$username.' '.$cityname.$district.$schoolname;?></td>
		</tr>
		...
		<tr height="40px">
			...
			<td rowspan="4" bgcolor="cornsilk"><?=$a4_city_desc;?></td>
		</tr>
		<tr height="40px">
			<td nowrap="nowrap" align="center">資本門</td>
	...
	<? if($total_money_ny <= 0) { echo "<!--"; } ?>
		<tr height="40px">
			...
			<td nowrap="nowrap" align="right" bgcolor="#DAEEFF"><b><?=number_format($total_money_ny);?></b></td>
			<td nowrap="nowrap" align="right" bgcolor="#FFE1A4"><b><?=number_format($city_total_money_ny);?></b></td>
			<td align="center" bgcolor="#FFE1A4">-</td>
		</tr>
	</table>
	<? if($total_money_ny <= 0) { echo "-->"; } ?>

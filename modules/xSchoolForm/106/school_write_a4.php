	...
	<form name="form" method="post" action="school_write_a4_finish.php" onSubmit="return toCheck();" onKeyDown="if(event.keyCode == 13) return false;">
		...
		<script language="JavaScript">
			...
			function toCheck()
			{
				...
				else if(<?=$student;?> <= <?=$keyStudent;?> && document.form.s_total_money.value > 120000)  // 全校學生未大於 100 人，每年最高補助 12 萬元
				{
					errmsg += '全校學生數未超過100人之學校，每校每年最高補助 12 萬元。\n';
					flag = 0;
				}
				else if(document.form.s_total_money.value > 250000)
				{
					errmsg += '本項補助每校每年最高補助 25 萬元。\n';
					flag = 0;					
				}						

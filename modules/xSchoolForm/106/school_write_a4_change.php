<?
	...
	$sql = 	"    SELECT sd.account                                                                                                                   ".
			...
			"         , a4_ny.inherit_year            AS a4_ny_inherit_year                                                                          ".
			"         , a4_item_ny.seq_no             AS a4_item_seq_no_ny                                                                           ".
			"         , a4_item_ny.main_seq           AS main_seq_ny                                                                                 ".
			"         , a4_item_ny.city_money         AS city_money_ny                                                                               ".
			"         , a4_item_ny.city_delete        AS city_delete_ny                                                                              ".
			"         , a4_item_ny.edu_money          AS edu_money_ny                                                                                ".
			"         , a4_item_ny.edu_delete         AS edu_delete_ny                                                                               ".
			...
			" LEFT JOIN alc_aboriginal_education_item AS a4_item    ON sy.seq_no    = a4_item.main_seq                                               ".
			" LEFT JOIN schooldata_year               AS sy_ny      ON sd.account   = sy_ny.account and sy_ny.school_year = '".($school_year + 1)."' ".  // include去年，+1年就是今年
			" LEFT JOIN alc_aboriginal_education      AS a4_ny      ON sy_ny.seq_no = a4_ny.sy_seq                                                   ".
			" LEFT JOIN alc_aboriginal_education_item AS a4_item_ny ON sy_ny.seq_no = a4_item_ny.main_seq                                            ".
	...
	while($row = mysql_fetch_array($result))
	{
		...
		$a4_item_seq_no_ny = $row['a4_item_seq_no_ny'];  // a4_item 的 seq_no
		...
		$a4_ny_inherit_year = $row['a4_ny_inherit_year'];
		...
		$sql_update_item = 	" UPDATE $table_name_item                   ".
							...
							"      , edu_money   = NULL                 ".
							"      , edu_delete  = NULL                 ".
							"  WHERE seq_no      = '$a4_item_seq_no_ny' ".
							"    AND main_seq    = '$seq_no_ny';        ";

		mysql_query($sql_update_item );
	}

	$insert_sql =	" INSERT INTO alc_aboriginal_education      ".
					"             ( sy_seq                      ".
					"             , account                     ".
					"             , school_year )               ".
					"      VALUES ( '$seq_no_ny'                ".
	...
	$this_inherit_year = substr($a4_ny_inherit_year, 0, 3);  // 這個變數是要取計畫繼承的年度就好，不要取到change
	...
	{
		echo '新增成功!';
		echo '<meta http-equiv=REFRESH CONTENT=0;url=school_write_a4_conti_3.php>';
	}
	else
	{
		echo '新增失敗!';

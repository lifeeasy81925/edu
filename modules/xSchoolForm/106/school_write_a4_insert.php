<?
	...
	$sql = " select sd.account, sd.schooltype, sd.cityname, sd.district, sd.schoolname, sd.area, sd.getmoney_85to91, sd.traffic_status ".
		   ...
		   // 補五資料
		   "      , a4.p1_name, a4.p2_name ".
		   "      , a4.s_p1_student, a4.s_p2_student ".
		   "      , a4.s_p1_target, a4.s_p2_target ".
		   "      , a4.s_total_money ".
		   "      , a4.s_p1_money, a4.s_p2_money ".
		   ...
		   "      , a4.p1_IsContinue, a4.p2_IsContinue, a4.p_num ".
		   "      , a4.p1_ContinueYear, a4.p2_ContinueYear ".

		   "      , a4.s_total_money_ny1 ".
		   "      , a4.s_p1_money_ny1, a4.s_p2_money_ny1 ".
		   ...
		   "      , a4.s_total_money_ny2 ".
		   "      , a4.s_p1_money_ny2, a4.s_p2_money_ny2 ".
			...
			for($i = 1; $i <= 2; $i++)  // 特色1或2
			{
				for($j = $school_year+1; $j <= $school_year+2; $j++)  // 延續1~2年
				{
					if ($k == "p".$i."_".$j)
					{
						...
						"                             values ( '$seq_no_ny' ".  // 將main_seq換成新的
						"                                    , '$section' ".
						"                                    , '$subject' ".
						"                                    , '$category' ".
						"                                    , '$item' ".
	...
	if(mysql_query($sql))
	{
		...
		echo "<script>";
		echo "</script>";
		echo '<meta http-equiv=REFRESH CONTENT=0;url=school_write_a4_conti.php>';
	}
	else
	{
		echo '新增失敗!';

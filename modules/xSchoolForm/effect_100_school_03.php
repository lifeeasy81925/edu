...
(其他：<input type="text" size="5" name="fn_a3_1" value="<? echo ($fn_a3_1);?>" style="border:0px; text-align: right;" readonly >元，設備：<input type="text" size="5" name="fn_a3_2" value="<? echo ($fn_a3_2);?>" style="border:0px; text-align: right;" readonly >元)。</font>
<br /><br />
<font color=blue><strong>※執行金額：</strong>
<input size="6" name="ef_1" type="text" id="ef_1" value="<? echo $ef_1;?>" style="border:0px; text-align: right;" readonly >元。(其他：<input type="text" size="5" name="ef_2" value="<? echo $ef_2;?>" style="border:0px; text-align: right;" readonly onChange="change1()">元，設備：<input type="text" size="5" name="ef_3" value="<? echo $ef_3;?>" style="border:0px; text-align: right;" readonly onChange="change2()">元)。</font>(執行進度依據，由下方資料自動加總)<br />
<br />
<strong>※特色一：</strong><br />
項目名稱：<input type="text" size="16" name="ef_4" value="<? echo $ef_4;?>">
，經費已使用(其他<input type="text" size="5" name="ef_5" value="<? echo $ef_5;?>" onChange="change3()">
元，設備<input type="text" size="5" name="ef_6" value="<? echo $ef_6;?>" onChange="change5()">
元)。<br />
...
，經費已使用(其他<input type="text" size="5" name="ef_10" value="<? echo $ef_10;?>" onChange="change4()">元，設備<input type="text" size="5" name="ef_11" value="<? echo $ef_11;?>" onChange="change6()">
元)。<br />

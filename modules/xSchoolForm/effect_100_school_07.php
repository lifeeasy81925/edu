...
<p>
<font color=blue>核定經費：<input type="text" size="6" name="fn_a7" value="<? echo ($fn_a7);?>" style="border:0px; text-align: right;" readonly >元 (租車費：<input type="text" size="4" name="fn_a7_1" value="<? echo ($fn_a7_1);?>" style="border:0px; text-align: right;" readonly >元，交通費：<input type="text" size="4" name="fn_a7_2" value="<? echo ($fn_a7_2);?>" style="border:0px; text-align: right;" readonly >元，交通車：<input type="text" size="4" name="fn_a7_3" value="<? echo ($fn_a7_3);?>" style="border:0px; text-align: right;" readonly >元)。</font>
<br /><br />

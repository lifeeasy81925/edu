...
補助綜合球場 (修建：<input type="text" size="4" name="fn_a8_1_1c" value="<? echo ($fn_a8_1_1c);?>" style="border:0px; text-align: right;" readonly >式，<input type="text" size="6" name="fn_a8_1_1" value="<? echo ($fn_a8_1_1);?>" style="border:0px; text-align: right;" readonly >元，設備：<input type="text" size="4" name="fn_a8_1_2c" value="<? echo ($fn_a8_1_2c);?>" style="border:0px; text-align: right;" readonly >式，<input type="text" size="6" name="fn_a8_1_2" value="<? echo ($fn_a8_1_2);?>" style="border:0px; text-align: right;" readonly >元)。</font>
<br /><br />
...
整修綜合球場 (修建：<input type="text" size="4" name="ef_2" value="<? echo ($ef_2);?>" >式，<input type="text" size="6" name="ef_3" value="<? echo ($ef_3);?>" onChange="change1()">元，設備：<input type="text" size="4" name="ef_4" value="<? echo ($ef_4);?>" >式，<input type="text" size="6" name="ef_5" value="<? echo ($ef_5);?>" onChange="change2()">元)。
<p>

...
<br /><? if ($file_3 == ''){echo "檔案狀態：<font color=red>未上傳</font> (上傳後請按F5更新狀態)";} else {echo '檔案狀態：<font color=blue>已上傳</font>，檔名：'.'<a href="/edu_upload/100/'.$username.'/'.$file_3.'" target="_new">'.$file_3.'</a>';}?>
  </form>
<!---
<br />
...
<br /><? if ($file_1 == ''){echo "檔案狀態：<font color=red>未上傳</font> (上傳後請按F5更新狀態)";} else {echo '檔案狀態：<font color=blue>已上傳</font>，檔名：'.'<a href="/edu_upload/100/'.$username.'/'.$file_1.'" target="_new">'.$file_1.'</a>';}?>
  </form>
<br />
...
<br /><? if ($file_2 == ''){echo "檔案狀態：<font color=red>未上傳</font> (上傳後請按F5更新狀態)";} else {echo '檔案狀態：<font color=blue>已上傳</font>，檔名：'.'<a href="/edu_upload/100/'.$username.'/'.$file_2.'" target="_new">'.$file_2.'</a>';}?>
</form>
--->
</div>
<p>

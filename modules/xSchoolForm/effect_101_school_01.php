...
<form name="form" method="post" action="effect_101_school_01_finish.php" onSubmit="return toCheck();">
<p>
...
<p>
<font color=blue>※核定經費：<input type="text" size="6" name="fn_a1" value=<? echo ($fn_a1);?> style="border:0px; text-align: right;" readonly >元 (親職教育：<input type="text" size="6" name="fn_a1_1" value=<? echo ($fn_a1_1);?> style="border:0px; text-align: right;" readonly >元，家庭輔導：<input type="text" size="6" name="fn_a1_2" value=<? echo ($fn_a1_2);?> style="border:0px; text-align: right;" readonly >元)。</font><br /><br />

...
<form name="form" method="post" action="effect_101_school_02_finish.php" onSubmit="return toCheck();">
<p>
...
<font color=blue><strong>※執行金額：</strong></font>
<input size="6" name="ef_1" type="text" id="ef_1" readonly value="<? if($ef_1 > 0){echo $ef_1;}else{echo 0;}?>" style="border:0px; text-align: right;" /><font color=blue>元。</font>(執行進度依據，由下方資料自動加總)<br /><br />
<strong>※課後學習輔導：</strong><br />
　輔導學生數<input type="text" size="4" name="ef_2" value="<? echo ($ef_2);?>">人，已辦理班次<input type="text" size="4" name="ef_3" value="<? echo ($ef_3);?>">班，已使用經費<input type="text" size="6" name="ef_4" onChange="change1()" value="<? if($ef_4 > 0){echo $ef_4;}else{echo 0;}?>" />元。<br /><br />
<strong>※寒暑假學習輔導：</strong><br />
　輔導學生數<input type="text" size="4" name="ef_5" value="<? echo ($ef_5);?>">人，已辦理班次<input type="text" size="4" name="ef_6" value="<? echo ($ef_6);?>">班，已使用經費<input type="text" size="6" name="ef_7" onChange="change2()" value="<? if($ef_7 > 0){echo $ef_7;}else{echo 0;}?>" />元。<br /><br />
<strong>※住校生夜間學習輔導：</strong><br />
　輔導學生數<input type="text" size="4" name="ef_8" value="<? echo ($ef_8);?>">人，已辦理班次<input type="text" size="4" name="ef_9" value="<? echo ($ef_9);?>">班，已使用經費<input type="text" size="6" name="ef_10" onChange="change3()" value="<? if($ef_10 > 0){echo $ef_10;}else{echo 0;}?>" />元。 
<p>

...
<form name="form" method="post" action="effect_101_school_06_finish.php" onSubmit="return toCheck();">
<p>
...
(經常門：<input type="text" size="2" name="fn_a6_1c1" value='<? echo ($fn_a6_1c1);?>' style="border:0px; text-align: right;" readonly >式<input type="text" size="5" name="fn_a6_1" value='<? echo ($fn_a6_1);?>' style="border:0px; text-align: right;" readonly >元，資本門：<input type="text" size="2" name="fn_a6_2c1" value='<? echo ($fn_a6_2c1);?>' style="border:0px; text-align: right;" readonly >項<input type="text" size="5" name="fn_a6_2" value='<? echo ($fn_a6_2);?>' style="border:0px; text-align: right;" readonly >元)。</font>
<br /><br />
...
經費已使用(經常門：<input type="text" size="6" name="ef_2" value="<? echo ($ef_2);?>"  onChange="change1()">元，資本門：<input type="text" size="6" name="ef_3" value="<? echo ($ef_3);?>"  onChange="change2()">元)。<br />

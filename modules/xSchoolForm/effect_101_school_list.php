...
<?
//學校名稱 
$sql_school = "select  *  from 101school_basedata where account like '$username'";
...
<p><font color="blue"><strong>教育部推動教育優先區計畫101年度 貴校審核通過補助項目執行及成果列表</strong></font>
<? if($fn_total < 1) {echo "<!---";} ?>
<table width="100%" border="1" cellspacing="0" cellpadding="0">
  <tr>
    ...
    <td height="40" align="center" bgcolor="#99CCCC"><font color=red>檔案上傳</font><br />修正後計<br />畫、經費<br />與執行成<br />果<font color="red">(必填)</font></td>
  </tr>
<? if($fn_total < 1) {echo "--->";} ?>
  <? if($fn_a1 < 1) {echo "<!---";}?>
  <tr>
    ...
    <td align="center"><input type="button" value="進入" onclick="location='effect_101_school_01.php'" /></td>
    <td align="center"><INPUT TYPE="button" VALUE="進入" onClick="location='effect_101_school_up_01.php'"></td>
  </tr>
  <? if($fn_a1 < 1) {echo "--->";}?>
  <? if($fn_a2 < 1) {echo "<!---";}?>
  <tr>
    ...
    <td align="center"><input type="button" value="進入" onclick="location='effect_101_school_02.php'" /></td>
    <td align="center"><INPUT TYPE="button" VALUE="進入" onClick="location='effect_101_school_up_02.php'"></td>
  </tr>
  <? if($fn_a2 < 1) {echo "--->";}?>
  <? if($fn_a3 < 1) {echo "<!---";}?>
  <tr>
    ...
    <td align="center"><input type="button" value="進入" onclick="location='effect_101_school_03.php'" /></td>
    <td align="center"><INPUT TYPE="button" VALUE="進入" onClick="location='effect_101_school_up_03.php'"></td>
  </tr>
  <? if($fn_a3 < 1) {echo "--->";}?>
  <? if($fn_a4 < 1) {echo "<!---";}?>
  <tr>
    ...
    <td align="center"><input type="button" value="進入" onclick="location='effect_101_school_04.php'" /></td>
    <td align="center"><INPUT TYPE="button" VALUE="進入" onClick="location='effect_101_school_up_04.php'"></td>
  </tr>
  <? if($fn_a4 < 1) {echo "--->";}?>
  <? if($fn_a5 < 1) {echo "<!---";}?>
  <tr>
    ...
    <td align="center"><input type="button" value="進入" onclick="location='effect_101_school_05.php'" /></td>
    <td align="center"><INPUT TYPE="button" VALUE="進入" onClick="location='effect_101_school_up_05.php'"></td>
  </tr>
  <? if($fn_a5 < 1) {echo "--->";}?>
  <? if($fn_a6 < 1) {echo "<!---";}?>
  <tr>
    ...
    <td align="center"><input type="button" value="進入" onclick="location='effect_101_school_06.php'" /></td>
    <td align="center"><INPUT TYPE="button" VALUE="進入" onClick="location='effect_101_school_up_06.php'"></td>
  </tr>
  <? if($fn_a6 < 1) {echo "--->";}?>
  <? if($fn_a7 < 1) {echo "<!---";}?>
  <tr>
    ...
    <td align="center"><input type="button" value="進入" onclick="location='effect_101_school_07.php'" /></td>
    <td align="center"><INPUT TYPE="button" VALUE="進入" onClick="location='effect_101_school_up_07.php'"></td>
  </tr>
  <? if($fn_a7 < 1) {echo "--->";}?>
  <? if($fn_a8 < 1) {echo "<!---";}?>
  <tr>
    ...
    <td align="center"><input type="button" value="進入" onclick="location='effect_101_school_08.php'" /></td>
    <td align="center"><INPUT TYPE="button" VALUE="進入" onClick="location='effect_101_school_up_08.php'"></td>
  </tr>
  <? if($fn_a8 < 1) {echo "--->";}?>
<? if($fn_total < 1) {echo "<!---";} ?>
  <tr>

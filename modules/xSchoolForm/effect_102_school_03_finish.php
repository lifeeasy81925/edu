...
<?php
	...
	if($num_rows == 0) //沒資料
	{
		...
		$sql = "insert 102school_effect (account, type, city, district, name, last, a3_1, a3_2, a3_3, a3_4, a3_5, a3_6, a3_7, a3_8 " . 
		                                 ", a3_9, a3_10, a3_11, a3_12, a3_13, a3_14, a3_15)" . 
	...
	{
		$sql = "update 102school_effect set  last = '$last', a3_1 = '$ef_1', a3_2 = '$ef_2', a3_3 = '$ef_3', a3_4 = '$ef_4', a3_5 = '$ef_5', a3_6 = '$ef_6', a3_7 = '$ef_7', a3_8 = '$ef_8', a3_9 = '$ef_9', a3_10 = '$ef_10', a3_11 = '$ef_11', a3_12 = '$ef_12', a3_13 = '$ef_13', a3_14 = '$ef_14', a3_15 = '$ef_15' where account = '$username'";
	}
	...
	if(mysql_query($sql)){
		...
		echo '新增失敗!';
		echo '<meta http-equiv=REFRESH CONTENT=2;url=effect_102_school_03.php>';
	}

...
<?php
	...
	if($num_rows == 0) //沒資料
	{
		...
		$sql = "insert 102school_effect (account, type, city, district, name, last, a4_1, a4_2, a4_3, a4_4, a4_5, a4_6, a4_7, a4_8 " . 
		                                 ", a4_9, a4_10, a4_11, a4_12, a4_13, a4_14, a4_15)" . 
	...
	{
		$sql = "update 102school_effect set  last = '$last', a4_1 = '$ef_1', a4_2 = '$ef_2', a4_3 = '$ef_3', a4_4 = '$ef_4', a4_5 = '$ef_5', a4_6 = '$ef_6', a4_7 = '$ef_7', a4_8 = '$ef_8', a4_9 = '$ef_9', a4_10 = '$ef_10', a4_11 = '$ef_11', a4_12 = '$ef_12', a4_13 = '$ef_13', a4_14 = '$ef_14', a4_15 = '$ef_15' where account = '$username'";
	}
	...
	if(mysql_query($sql)){
		...
		echo '新增失敗!';
		echo '<meta http-equiv=REFRESH CONTENT=2;url=effect_102_school_04.php>';
	}

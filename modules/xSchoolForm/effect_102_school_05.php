...
<? 
	//教育部核定金額
	$sql = "select a192, a193, a194 from 102allowance5 where account like '$username'";
...
<p>
<font color=blue>核定經費：<input type="text" size="5" name="fn_a5" value='<? echo ($fn_a5);?>' style="border:0px; text-align: right;" readonly >元。<br />
(經常門：
...
<script language="JavaScript">
  function toCheck() {
	if ( parseInt(document.form.ef_1.value) > parseInt(document.form.fn_a5.value) ) {

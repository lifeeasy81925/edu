...
<?php
	...
	if($num_rows == 0) //沒資料
	{
		...
		$sql = "insert 102school_effect (account, type, city, district, name, last, a5_1, a5_2, a5_3, a5_4, a5_5, a5_6, a5_7, a5_8 " . 
	...
	{
		$sql = "update 102school_effect set  last = '$last', a5_1 = '$ef_1', a5_2 = '$ef_2', a5_3 = '$ef_3', a5_4 = '$ef_4', a5_5 = '$ef_5', a5_6 = '$ef_6', a5_7 = '$ef_7', a5_8 = '$ef_8', a5_9 = '$ef_9', a5_10 = '$ef_10', a5_11 = '$ef_11', a5_12 = '$ef_12', a5_13 = '$ef_13', a5_14 = '$ef_14', a5_15 = '$ef_15' where account = '$username'";
	}
	...
	if(mysql_query($sql)){
		...
		echo '新增失敗!';
		echo '<meta http-equiv=REFRESH CONTENT=2;url=effect_102_school_05.php>';
	}

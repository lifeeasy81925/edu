...
<strong>項目：四、充實學校基本教學設備  </strong><a href="/edu/modules/xSchoolForm/download/allowance-05.htm" target="_blank">(補助項目說明)</a>

<div>
<?
//讀取上傳檔案資料
$sql = "select effect_a4_1, effect_a4_2, effect_a4_3, effect_a4_4 from 102school_upload_name where account like '$username'";

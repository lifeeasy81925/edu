...
<strong>項目：六、補助交通不便地區學校交通車  </strong><a href="/edu/modules/xSchoolForm/download/allowance-07.htm" target="_blank">(補助項目說明)</a>

<div>
<?
//讀取上傳檔案資料
$sql = "select effect_a6_1, effect_a6_2, effect_a6_3, effect_a6_4 from 102school_upload_name where account like '$username'";

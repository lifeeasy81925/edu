...
switch ($table)
{
	...
	case "p_5":
		if($class == '1' ){
			$sql = "update 100element_upload_name set point5 = '$filename' where account = '$username' ";
		}
		else{
			$sql = "update 100junior_upload_name set point5 = '$filename' where account = '$username' ";
		}
		mysql_query($sql);
		break;
	case "p_6":
...
//成效評估		
	case "e_1_1":
		$sql = "update 100school_upload_name set effect_a1_1 = '$filename' where account = '$username' ";
		mysql_query($sql);
		break;
	case "e_1_2":
		$sql = "update 100school_upload_name set effect_a1_2 = '$filename' where account = '$username' ";
		mysql_query($sql);
		break;
	case "e_1_3":
		$sql = "update 100school_upload_name set effect_a1_3 = '$filename' where account = '$username' ";
		mysql_query($sql);
		break;
	case "e_1_4":
		$sql = "update 100school_upload_name set effect_a1_4 = '$filename' where account = '$username' ";
		mysql_query($sql);
		break;
	case "e_2_1":
		$sql = "update 100school_upload_name set effect_a2_1 = '$filename' where account = '$username' ";
		mysql_query($sql);
		break;
	case "e_2_2":
		$sql = "update 100school_upload_name set effect_a2_2 = '$filename' where account = '$username' ";
		mysql_query($sql);
		break;
	case "e_2_3":
		$sql = "update 100school_upload_name set effect_a2_3 = '$filename' where account = '$username' ";
		mysql_query($sql);
		break;
	case "e_2_4":
		$sql = "update 100school_upload_name set effect_a2_4 = '$filename' where account = '$username' ";
		mysql_query($sql);
		break;
	case "e_3_1":
		$sql = "update 100school_upload_name set effect_a3_1 = '$filename' where account = '$username' ";
		mysql_query($sql);
		break;
	case "e_3_2":
		$sql = "update 100school_upload_name set effect_a3_2 = '$filename' where account = '$username' ";
		mysql_query($sql);
		break;
	case "e_3_3":
		$sql = "update 100school_upload_name set effect_a3_3 = '$filename' where account = '$username' ";
		mysql_query($sql);
		break;
	case "e_3_4":
		$sql = "update 100school_upload_name set effect_a3_4 = '$filename' where account = '$username' ";
		mysql_query($sql);
		break;
	case "e_4_1":
		$sql = "update 100school_upload_name set effect_a4_1 = '$filename' where account = '$username' ";
		mysql_query($sql);
		break;
	case "e_4_2":
		$sql = "update 100school_upload_name set effect_a4_2 = '$filename' where account = '$username' ";
		mysql_query($sql);
		break;
	case "e_4_3":
		$sql = "update 100school_upload_name set effect_a4_3 = '$filename' where account = '$username' ";
		mysql_query($sql);
		break;
	case "e_4_4":
		$sql = "update 100school_upload_name set effect_a4_4 = '$filename' where account = '$username' ";
		mysql_query($sql);
		break;
	case "e_5_1":
		$sql = "update 100school_upload_name set effect_a5_1 = '$filename' where account = '$username' ";
		mysql_query($sql);
		break;
	case "e_5_2":
		$sql = "update 100school_upload_name set effect_a5_2 = '$filename' where account = '$username' ";
		mysql_query($sql);
		break;
	case "e_5_3":
		$sql = "update 100school_upload_name set effect_a5_3 = '$filename' where account = '$username' ";
		mysql_query($sql);
		break;
	case "e_5_4":
		$sql = "update 100school_upload_name set effect_a5_4 = '$filename' where account = '$username' ";
		mysql_query($sql);
		break;
	case "e_6_1":
		$sql = "update 100school_upload_name set effect_a6_1 = '$filename' where account = '$username' ";
		mysql_query($sql);
		break;
	case "e_6_2":
		$sql = "update 100school_upload_name set effect_a6_2 = '$filename' where account = '$username' ";
		mysql_query($sql);
		break;
	case "e_6_3":
		$sql = "update 100school_upload_name set effect_a6_3 = '$filename' where account = '$username' ";
		mysql_query($sql);
		break;
	case "e_6_4":
		$sql = "update 100school_upload_name set effect_a6_4 = '$filename' where account = '$username' ";
		mysql_query($sql);
		break;
	case "e_7_1":
		$sql = "update 100school_upload_name set effect_a7_1 = '$filename' where account = '$username' ";
		mysql_query($sql);
		break;
	case "e_7_2":
		$sql = "update 100school_upload_name set effect_a7_2 = '$filename' where account = '$username' ";
		mysql_query($sql);
		break;
	case "e_7_3":
		$sql = "update 100school_upload_name set effect_a7_3 = '$filename' where account = '$username' ";
		mysql_query($sql);
		break;
	case "e_7_4":
		$sql = "update 100school_upload_name set effect_a7_4 = '$filename' where account = '$username' ";
		mysql_query($sql);
		break;
	case "e_8_1":
		$sql = "update 100school_upload_name set effect_a8_1 = '$filename' where account = '$username' ";
		mysql_query($sql);
		break;
	case "e_8_2":
		$sql = "update 100school_upload_name set effect_a8_2 = '$filename' where account = '$username' ";
		mysql_query($sql);
		break;
	case "e_8_3":
		$sql = "update 100school_upload_name set effect_a8_3 = '$filename' where account = '$username' ";
		mysql_query($sql);
		break;
	case "e_8_4":
		$sql = "update 100school_upload_name set effect_a8_4 = '$filename' where account = '$username' ";
		mysql_query($sql);
		break;
	default:
		$point = "0000";

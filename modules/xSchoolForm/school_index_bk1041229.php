...
※填報申請3步驟：<br />
     ...
     <img src="/edu/images/dot_01.gif" align="absmiddle" /><a href="105/school_upload_file.php" target="_self">3.上傳檔案專區</a>（上傳填報與申請相關計畫、經費及附件）<br /><br />
<? if($keep == 1){echo "-->";} ?>
<? if($keep == 0){echo "<!--";} ?>
※填報申請2步驟：<br />
...
<img src="/edu/images/dot_01.gif" align="absmiddle" /><a href="105/school_upload_file.php" target="_self">2.上傳檔案專區</a>（上傳填報與申請相關計畫、經費及附件）<br /><br />
<? if($keep == 0){echo "-->";} ?>

<img src="/edu/images/dot_02.gif" align="absmiddle" /><a href="105/school_view_status.php" target="_self">檢視填報與申請狀態</a><br /><br />
<!--
...
<img src="/edu/images/dot_02.gif" align="absmiddle" /><a href="105/print_edu_examined.php" target="_new">105年度 檢視教育部複審結果</a><br /><br />
...
<p>
<div align="center" style="background-color:#FC9">成效評估區<b>(修正後計畫上傳區)</b></div>

<? if($z == 2){echo "<!--";} ?>
<img src="/edu/images/dot_01.gif" align="absmiddle" /><a href="105/effect_school_list.php" target="_self">105年度 執行進度與成果填報</a><font color="#FF0000"> (填報時間：已開始，
...
<img src="/edu/images/dot_01.gif" align="absmiddle" /><a href="104/questionnaire.php" target="_self"><b>104年度 教育部教育優先區計畫評估研究專案調查問卷</b></a><br />
